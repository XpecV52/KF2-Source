...
Begin Object Class=KFSeqEvent_WaveStart Name=KFSeqEvent_WaveStart_1
   ...
   MaxWidth=256
   OutputLinks(0)=(Links=((LinkedOp=KFSeqCond_IsWeeklyEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.KFSeqCond_IsWeeklyEvent_0')),DrawY=-5308,OverrideDelta=13)
   OutputLinks(1)=(Links=((LinkedOp=KFSeqCond_IsWeeklyEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.KFSeqCond_IsWeeklyEvent_0')),DrawY=-5288,OverrideDelta=33)
   VariableLinks(0)=(DrawX=-9793,OverrideDelta=20)
   VariableLinks(1)=(DrawX=-9732,OverrideDelta=90)
   VariableLinks(2)=(DrawX=-9651,OverrideDelta=143)
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-9840
   ObjPosY=-5376
...
Begin Object Class=KFSeqEvent_WaveEnd Name=KFSeqEvent_WaveEnd_0
   MaxTriggerCount=0
   MaxWidth=248
   OutputLinks(0)=(Links=((LinkedOp=KFSeqCond_IsWeeklyEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.KFSeqCond_IsWeeklyEvent_2')),DrawY=-4812,OverrideDelta=13)
   OutputLinks(1)=(DrawY=-4792,OverrideDelta=33)
   VariableLinks(0)=(DrawX=-9813,OverrideDelta=16)
   VariableLinks(1)=(DrawX=-9752,OverrideDelta=86)
   VariableLinks(2)=(DrawX=-9671,OverrideDelta=139)
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-9856
   ObjPosY=-4880
...
Begin Object Class=KFSeqEvent_WaveEnd Name=KFSeqEvent_WaveEnd_1
   ...
   OutputLinks(1)=(Links=((LinkedOp=SeqAct_ChangeCollision'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_ChangeCollision_14')),DrawY=-4208,OverrideDelta=33)
...
Begin Object Class=SeqAct_AkPostEvent Name=SeqAct_AkPostEvent_0
   bReplicateToClients=True
   Event=AkEvent'WW_ENV_MonsterBall.Play_ENV_MonsterBall_Metal_Door_Opening'
   InputLinks(0)=(DrawY=-4358,OverrideDelta=11)
   OutputLinks(0)=(DrawY=-4358,OverrideDelta=11)
   VariableLinks(0)=(LinkedVariables=(SeqVar_Object'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqVar_Object_147'),DrawX=-1552,OverrideDelta=26)
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1600
   ObjPosY=-4392
...
Begin Object Class=KFSeqEvent_WaveEnd Name=KFSeqEvent_WaveEnd_2
   ...
   OutputLinks(1)=(Links=((LinkedOp=SeqAct_Interp'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_Interp_3',InputLinkIdx=1),(LinkedOp=SeqAct_AkPostEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_AkPostEvent_0')),DrawY=-4408,OverrideDelta=33)
...
Begin Object Class=KFSeqCond_IsWeeklyEvent Name=KFSeqCond_IsWeeklyEvent_0
   WeeklyIndex=12
   InputLinks(0)=(DrawY=-5298,OverrideDelta=23)
   OutputLinks(0)=(DrawY=-5308,OverrideDelta=13)
   OutputLinks(1)=(Links=((LinkedOp=SeqAct_AkPostEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_AkPostEvent_33'),(LinkedOp=SeqAct_Delay'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_Delay_16')),DrawY=-5288,OverrideDelta=33)
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-9600
   ObjPosY=-5344
...
Begin Object Class=KFSeqCond_IsWeeklyEvent Name=KFSeqCond_IsWeeklyEvent_2
   WeeklyIndex=12
   InputLinks(0)=(DrawY=-4810,OverrideDelta=23)
   OutputLinks(0)=(DrawY=-4820,OverrideDelta=13)
   OutputLinks(1)=(Links=((LinkedOp=SeqAct_AkPostEvent'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence.SeqAct_AkPostEvent_16')),DrawY=-4800,OverrideDelta=33)
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-MONSTERBALL.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-9592
   ObjPosY=-4856
