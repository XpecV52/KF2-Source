...
Begin Object Class=SeqEvent_LevelLoaded Name=SeqEvent_LevelLoaded_8
   MaxWidth=136
   OutputLinks(0)=(Links=((LinkedOp=SeqAct_Interp'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.SeqAct_Interp_1')),DrawY=1837,OverrideDelta=14)
   OutputLinks(1)=(DrawY=1858,OverrideDelta=35)
   OutputLinks(2)=(DrawY=1879,OverrideDelta=56)
   ObjInstanceVersion=3
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
...
Begin Object Class=SeqAct_Interp Name=SeqAct_Interp_1
   bLooping=True
   InputLinks(0)=(DrawY=1838,OverrideDelta=15)
   InputLinks(1)=(DrawY=1860,OverrideDelta=37)
   InputLinks(2)=(DrawY=1882,OverrideDelta=59)
   InputLinks(3)=(DrawY=1904,OverrideDelta=81)
   InputLinks(4)=(DrawY=1926,OverrideDelta=103)
   OutputLinks(0)=(DrawY=1854,OverrideDelta=31)
   OutputLinks(1)=(DrawY=1910,OverrideDelta=87)
   VariableLinks(0)=(LinkedVariables=(InterpData'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_2'),DrawX=-1138,OverrideDelta=23)
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkedVariables=(SeqVar_Object'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.SeqVar_Object_31'),LinkDesc="Dongle_1",MinVars=0,DrawX=-1076,OverrideDelta=70)
   ObjInstanceVersion=2
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1176
   ObjPosY=1800
...
Begin Object Class=InterpData Name=InterpData_2
   Begin Object Class=InterpGroup Name=InterpGroup_2
      Begin Object Class=InterpTrackMove Name=InterpTrackMove_4
         PosTrack=(Points=((InterpMode=CIM_CurveAutoClamped),(InterpMode=CIM_CurveAutoClamped),(InVal=2.984742,OutVal=(X=0.000000,Y=0.000000,Z=-220.000000),InterpMode=CIM_CurveAutoClamped),(InVal=6.000614,InterpMode=CIM_CurveAutoClamped),(InVal=6.000614,InterpMode=CIM_CurveAutoClamped)))
         EulerTrack=(Points=((InterpMode=CIM_CurveAutoClamped),(InterpMode=CIM_CurveAutoClamped),(InVal=2.984742,InterpMode=CIM_CurveAutoClamped),(InVal=6.000614,InterpMode=CIM_CurveAutoClamped),(InVal=6.000614,InterpMode=CIM_CurveAutoClamped)))
         LookupTrack=(Points=(,,(Time=2.984742),(Time=6.000614),(Time=6.000614)))
         MoveFrame=IMF_RelativeToInitial
         Name="InterpTrackMove_4"
         ObjectArchetype=InterpTrackMove'Engine.Default__InterpTrackMove'
      End Object
      InterpTracks(0)=InterpTrackMove'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_2.InterpGroup_2.InterpTrackMove_4'
      GroupName="Dongle_1"
   ...
   Begin Object Class=InterpCurveEdSetup Name=InterpCurveEdSetup_0
      ...
      ObjectArchetype=InterpCurveEdSetup'Engine.Default__InterpCurveEdSetup'
   End Object
   InterpLength=6.000614
   InterpGroups(0)=InterpGroup'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_2.InterpGroup_2'
   CurveEdSetup=InterpCurveEdSetup'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_2.InterpCurveEdSetup_0'
   SelectedFilter=InterpFilter'Engine.Default__InterpData:FilterAll'
   EdSectionEnd=6.000614
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1176
   ObjPosY=2000
...
Begin Object Class=SeqVar_Object Name=SeqVar_Object_8
   ObjValue=InterpActor'KF-InfernalRealm.TheWorld:PersistentLevel.InterpActor_59'
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1076
   ObjPosY=1957
...
Begin Object Class=SeqEvent_LevelLoaded Name=SeqEvent_LevelLoaded_9
   MaxWidth=136
   OutputLinks(0)=(Links=((LinkedOp=SeqAct_Interp'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.SeqAct_Interp_3')),DrawY=2157,OverrideDelta=14)
...
Begin Object Class=SeqAct_Interp Name=SeqAct_Interp_3
   bLooping=True
   InputLinks(0)=(DrawY=2134,OverrideDelta=15)
   InputLinks(1)=(DrawY=2156,OverrideDelta=37)
   InputLinks(2)=(DrawY=2178,OverrideDelta=59)
   InputLinks(3)=(DrawY=2200,OverrideDelta=81)
   InputLinks(4)=(DrawY=2222,OverrideDelta=103)
   OutputLinks(0)=(DrawY=2150,OverrideDelta=31)
   OutputLinks(1)=(DrawY=2206,OverrideDelta=87)
   VariableLinks(0)=(LinkedVariables=(InterpData'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_3'),DrawX=-1138,OverrideDelta=23)
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkedVariables=(SeqVar_Object'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.SeqVar_Object_32'),LinkDesc="Dongle_2",MinVars=0,DrawX=-1076,OverrideDelta=70)
   ObjInstanceVersion=2
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1176
   ObjPosY=2096
...
Begin Object Class=InterpData Name=InterpData_3
   Begin Object Class=InterpGroup Name=InterpGroup_3
      Begin Object Class=InterpTrackMove Name=InterpTrackMove_6
         PosTrack=(Points=((InterpMode=CIM_CurveAutoClamped),(InterpMode=CIM_CurveAutoClamped),(InVal=2.994638,OutVal=(X=0.000000,Y=0.000000,Z=224.000000),InterpMode=CIM_CurveAutoClamped),(InVal=6.003900,InterpMode=CIM_CurveAutoClamped)))
         EulerTrack=(Points=((InterpMode=CIM_CurveAutoClamped),(InterpMode=CIM_CurveAutoClamped),(InVal=2.994638,InterpMode=CIM_CurveAutoClamped),(InVal=6.003900,InterpMode=CIM_CurveAutoClamped)))
         LookupTrack=(Points=(,,(Time=2.994638),(Time=6.003900)))
         MoveFrame=IMF_RelativeToInitial
         Name="InterpTrackMove_6"
         ObjectArchetype=InterpTrackMove'Engine.Default__InterpTrackMove'
      End Object
      InterpTracks(0)=InterpTrackMove'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_3.InterpGroup_3.InterpTrackMove_6'
      GroupName="Dongle_2"
   ...
   Begin Object Class=InterpCurveEdSetup Name=InterpCurveEdSetup_1
      ...
      ObjectArchetype=InterpCurveEdSetup'Engine.Default__InterpCurveEdSetup'
   End Object
   InterpLength=6.003900
   InterpGroups(0)=InterpGroup'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_3.InterpGroup_3'
   CurveEdSetup=InterpCurveEdSetup'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence.InterpData_3.InterpCurveEdSetup_1'
   SelectedFilter=InterpFilter'Engine.Default__InterpData:FilterAll'
   EdSectionEnd=6.003900
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1176
   ObjPosY=2328
...
Begin Object Class=SeqVar_Object Name=SeqVar_Object_32
   ObjValue=InterpActor'KF-InfernalRealm.TheWorld:PersistentLevel.InterpActor_57'
   ObjInstanceVersion=1
   ParentSequence=Sequence'KF-InfernalRealm.TheWorld:PersistentLevel.Main_Sequence'
   ObjPosX=-1076
   ObjPosY=2253
