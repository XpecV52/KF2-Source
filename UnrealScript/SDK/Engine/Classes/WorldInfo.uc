...
`if(`__TW_LIGHTING_MODIFICATIONS_) // Light Animation
	...
	FlickerCurve={(
		Points={(
			(InVal=0.0,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.1,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.15,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.3,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.5,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.55,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.6,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.65,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.8,OutVal=1.0,InterpMode=CIM_Constant)
			)})}

	PulseCurve={(
		Points={(
			(InVal=0.0,OutVal=0.0,InterpMode=CIM_CurveAuto),
			(InVal=0.25,OutVal=1.0,InterpMode=CIM_CurveAuto),
			(InVal=0.50,OutVal=0.0,InterpMode=CIM_CurveAuto),
			(InVal=0.75,OutVal=1.0,InterpMode=CIM_CurveAuto),
			(InVal=1.0,OutVal=0.0,InterpMode=CIM_CurveAuto)
			)})}

	StrobeCurve={(
		Points={(
			(InVal=0.0,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.25,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.50,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.75,OutVal=0.0,InterpMode=CIM_Constant)
			)})}

	ChaoticFlickerCurve={(
		Points={(
			(InVal=0.0,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.8,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.812,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.824,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.832,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.84,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.86,OutVal=0.0,InterpMode=CIM_Constant)
			)})}

	InverseChaoticFlickerCurve={(
		Points={(
			(InVal=0.0,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.8,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.812,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.824,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.832,OutVal=1.0,InterpMode=CIM_Constant),
			(InVal=0.84,OutVal=0.0,InterpMode=CIM_Constant),
			(InVal=0.86,OutVal=1.0,InterpMode=CIM_Constant)
			)})}
`endif
`if(`__TW_)
