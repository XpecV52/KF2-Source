...
cpptext
{
	/** Private class definition for headers */
	FString BuildUrlParameters();
	void BuildUrlMap(const FString);
//	UBOOL UploadFinalPayload(const TArray<BYTE>& UncompressedBuffer);

protected:
/** FTickableObject interface */
	/**
	 * Ticks any outstanding async tasks that need processing. Implemented in native due to netcode.
	 *
