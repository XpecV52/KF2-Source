...
simulated function PlayMeleeAnimation(name AnimName, out float out_Rate, float BlendTime)
{
	...
	`SafeDialogManager.PlayMeleeAttackDialog( KFPawn(Instigator), IsHeavyAttack(CurrentFireMode) );
}
...
defaultproperties
{
	...
	ParryStrength=4
	BlockDamageType.Add(class'KFDT_Bludgeon')
	BlockDamageType.Add(class'KFDT_Slashing')
