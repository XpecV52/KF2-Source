...
function Init(KFGameplayEventsWriter Writer)
{
	...
	`Log("KFGameStatsUploader: Uploading using class:"@Name, bLogAnalytics, 'Analytics');
	`Log("KFGameStatsUploader: Aggregating using class:"@AggregatorClassName, bLogAnalytics, 'Analytics');
	...
	if (AggregatorClassName != "")
	{
		...
		`Log("File to upload:"@FileToUpload);
