...
defaultproperties
{
    ...
    TargetPerkRankRange(3)=(X=25,Y=25) // HOE

    SpawnRateModificationRange(0)=(X=1.25,Y=0.75) // Normal
    SpawnRateModificationRange(1)=(X=1.25,Y=0.75) // Hard
    SpawnRateModificationRange(2)=(X=1.25,Y=0.75) // Suicidal
    SpawnRateModificationRange(3)=(X=1.25,Y=0.75) // HOE

    AIMovementSpeedModificationRange(0)=(X=0.75,Y=1.25) // Normal
    AIMovementSpeedModificationRange(1)=(X=0.75,Y=1.25) // Hard
    AIMovementSpeedModificationRange(2)=(X=0.75,Y=1.25) // Suicidal
    AIMovementSpeedModificationRange(3)=(X=0.75,Y=1.25) // HOE
