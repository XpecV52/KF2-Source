...
exec function GamepadSprintRelease()
{
	...
	else if ( bRun == 0 && `TimeSince(LastGamepadSprintPressTime) < GamepadButtonHoldTime )
	{
		ToggleCrouch();
	}
...
defaultproperties
{
	...
	AutoTargetCooldown=0.50

	// 0m:20d, 15m:10d
	AutoTargetAngleCurve=(Points=((InVal=0.f,OutVal=0.9397f),(InVal=1500.0f, OutVal=0.9848f),(InVal=6000.0f, OutVal=1.f)))
	// 0m:5d, 10m:2d
	AutoTargetWeakspotCurve=(Points=((InVal=0.f,OutVal=0.9962f),(InVal=1000.0f, OutVal=0.9994),(InVal=2000.0f, OutVal=1.f)))
