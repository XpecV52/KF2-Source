...
simulated function Tick( FLOAT DeltaTime )
{
    ...
    if( bCanTeleportCloser && PendingDoor == none && Role == ROLE_Authority && MyKFPawn != none && MyKFGameInfo.MyKFGRI != None && MyKFPawn.Health > 0
    	&& `TimeSince(LastTeleportCheckTime) > TeleportCheckInterval && !MyKFPawn.IsDoingSpecialMove() && FrustrationThreshold > 0 && MyKFGameInfo.MyKFGRI.AIRemaining > FrustrationThreshold )
    {
