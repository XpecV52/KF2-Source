...
DefaultProperties
{
    ...
    DialogEvents[`COMM_GetToTrader]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_GetToTrader_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_FollowMe]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_FollowMe_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_InsultZeds]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_InsultZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_RequestDosh]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_RequestMoney_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_RequestDoshResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_RequestMoney_GiveMoney',TraderTimeAudioCue=none)
	DialogEvents[`COMM_RequestHeal]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_RequestHeal_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_RequestHealResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_RequestHeal_HealPlayer',TraderTimeAudioCue=none)
	DialogEvents[`COMM_RequestHelp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_RequestHelp_Base',TraderTimeAudioCue=none)
	DialogEvents[`COMM_ConfirmGeneric]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_Confirm_Generic',TraderTimeAudioCue=none)
	DialogEvents[`COMM_DenyGeneric]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_Deny_Generic',TraderTimeAudioCue=none)
	DialogEvents[`COMM_ThankYou]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_MAN_Thanks',TraderTimeAudioCue=none)


	DialogEvents[`ACT_WeldDoor]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_Weld_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_Weld_HelpWeld',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorUnderAttack]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_WeldAttack_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorUnderAttackResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_WeldAttack_Help',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorAboutToBreak]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_WeldAttack_Breaking',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorAboutToBreakResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_WeldAttack_Help',TraderTimeAudioCue=none)
	DialogEvents[`ACT_WeldDoorFinish]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_WeldFinish_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`ACT_UnweldDoorFinish]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_UnWeldFinish_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SpotDoorAttacked]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_SeeDoorAttack_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SpotDoorBreak]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_SeeDoorBreak_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_HealSomeone]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_Heal_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`ACT_HealMiss]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_HealMiss_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_HealMissResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_HealMiss_Stopped',TraderTimeAudioCue=none)
	DialogEvents[`ACT_HealSelf]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_HealSelf_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_DoshAtSomeone]=(DefaultAudioCue=AkEvent'WW_VOX_CHR_Masterson.Play_Masterson_ACT_DoshAtPlayer_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_DoshAtSomeoneRespSome]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_DoshAtPlayer_GotSome',TraderTimeAudioCue=none)
	DialogEvents[`ACT_DoshAtSomeoneRespLots]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_DoshAtPlayer_GotLots',TraderTimeAudioCue=none)
	DialogEvents[`ACT_DoshAtGround]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_DoshGround_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_DoshTrain]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_DoshTrain_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_Reload]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_Reloading_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`ACT_DropWeap]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_DropWeap_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SpotAmmo]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SpotAmmo_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SpotArmor]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SpotArmor_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SpotWeap]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SpotWeap_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_AmmoLow]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_LowAmmo_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_AmmoLowResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_LowAmmo_Advice',TraderTimeAudioCue=none)
	...
	DialogEvents[`ACT_SelectFaveWeap1]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave1_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap2]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave2_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap3]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave3_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap4]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave4_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap5]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave5_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap6]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave6_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap7]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave7_Base',TraderTimeAudioCue=none)
	DialogEvents[`ACT_SelectFaveWeap8]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_ACT_SelectFave8_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Generic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KillZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Female]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KillFZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Boss]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KillBoss_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_BossResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KillBoss_Celebrate',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Massacre]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Massacre_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_AsLastPlayer]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedLastP_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_KnockedDown]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedDown_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Slashing]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_SlashDam_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Blunt]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_BluntDam_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Ballistic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Ballistic_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Explosive]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Explosive_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Fire]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Fire_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`KILL_Freeze]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Freeze_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Electro]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Electrocute_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Toxic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Poison_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave1]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav1_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave2]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav2_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave3]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav3_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave4]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav4_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave5]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav5_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave6]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav6_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave7]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav7_Base',TraderTimeAudioCue=none)
	DialogEvents[`KILL_Fave8]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_KZedFav8_Base',TraderTimeAudioCue=none)


	DialogEvents[`DAMZ_Stun]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_StunZed_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`DAMZ_Knockdown]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_Knockdown_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMZ_Fire]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_BurnZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMZ_Freeze]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_FreezeZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMZ_Electro]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_ElectrocuteZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMZ_Toxic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_PoisonZed_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMZ_Generic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_KZED_DamageZed_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`DAMP_SpotTeamDeathM]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_TeamDeathM_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_SpotTeamDeathMResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_TeamDeathM_Upset',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_SpotTeamDeathF]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_TeamDeathF_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_SpotTeamDeathFResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_TeamDeathF_Upset',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_SpotTeamDeathLast]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_LastMan_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_Grunt]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_DamageGrunt_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`DAMP_Fire]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_FireDamage_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_Sonic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_SoundDamage_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_Ballistic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_BulletDamage_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_Toxic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_PoisonDamage_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`DAMP_NearDeath]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_NearDeath_Base',TraderTimeAudioCue=none)
	DialogEvents[`DAMP_Dying]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_PLAD_Dying_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SPOTZ_Generic]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Threat_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_BossFemale]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_BossFemale_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_BossGeneric]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Boss_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Siren]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Siren_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Scrake]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Scrake_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Fleshpound]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Fleshpound_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Horde]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Horde_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_GenericResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_Threat_Acknowledge',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_FemaleResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_ZedFemale_Acknowledge',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_BigZedResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_BigZed_Acknowledge',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Cloaked]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_SeeCloaked_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SPOTZ_Behind]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_BehindYou_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Wall]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_OnWalls_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_Ceiling]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_OnCeiling_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_EmergeVent]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_OutOfVent_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_EmergeCeiling]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_OutofCeiling_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_EmergeFloor]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_OutOfFloor_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_JustCloaked]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_WentCloaked_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_JustUncloaked]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_UnCloaked_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SPOTZ_GrabbedMe]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_GrabbedMe_Base',TraderTimeAudioCue=none)
	DialogEvents[`SPOTZ_PulledMeIn]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SPOT_PulledMeIn_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SITU_HealthCheck]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_HealthCheck_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_HealthCheckRespLow]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_HealthCheck_Low',TraderTimeAudioCue=none)
	DialogEvents[`SITU_HealthCheckRespHigh]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_HealthCheck_High',TraderTimeAudioCue=none)
	DialogEvents[`SITU_AmmoCheck]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_AmmoCheck_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_AmmoCheckRespLow]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_AmmoCheck_Low',TraderTimeAudioCue=none)
	DialogEvents[`SITU_AmmoCheckRespHigh]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_AmmoCheck_High',TraderTimeAudioCue=none)
	DialogEvents[`SITU_General]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_GeneralIdle_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_AllAlive]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_IdleAllAlive_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_AllAliveResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_IdleAllAlive_Response',TraderTimeAudioCue=none)
	DialogEvents[`SITU_HalfAlive]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_IdleHalfDead_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SITU_MostAlive]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_IdleFewDead_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`SITU_TalkSelf]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_LastAlive_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_WaveStartGeneral]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_WaveStart_Base',TraderTimeAudioCue=none)
	DialogEvents[`SITU_WaveStartGoodLast]=()
	DialogEvents[`SITU_WaveStartGoodSeveral]=()
	DialogEvents[`SITU_WaveStartBoss]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_SITU_WaveStartBoss_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`OBJ_Win]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_WinObjective_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_WinResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_WinObj_Comment',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_Lose]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_LoseObj_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_LoseResp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_LoseObj_Comment',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_Decline]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_DeclineObjective_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_Accept]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_AcceptObjective_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_DefendAStart]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_StartDefendArea_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_DefendAAlmostSecured]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_AreaMostlySecured_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_DefendAGetIn]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PlayersNotInArea_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_DefendTStart]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_StartDefendTarget_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_DefendTAlmostSecured]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_TargetAlmostSecured_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`OBJ_DefendTDestroyed]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_TargetDestroyed_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_HackStart]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_StartHacking_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_HackAlmostSecured]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_HackAlmostSecured_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_HackNeedHelp]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_HackNeedHelp_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`OBJ_RepairAlmostDone]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_RepairAlmostComplete_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`OBJ_RepairFinish]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_RepairFinished_Base',TraderTimeAudioCue=none)
	...
	DialogEvents[`OBJ_EscortPackAcquire]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PackageAcquired_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_EscortPackDamaged]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PackageDamaged_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_EscortPackDestroyed]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PackageDestroyed_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_EscortPackDead]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PackageDead_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_EscortPlayerDied]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PlayerDiedPackage_Base',TraderTimeAudioCue=none)
	DialogEvents[`OBJ_EscortPackSecured]=(DefaultAudioCue=AkEvent'ww_vox_chr_Masterson.Play_Masterson_OBJE_PackageSecured_Base',TraderTimeAudioCue=none)
