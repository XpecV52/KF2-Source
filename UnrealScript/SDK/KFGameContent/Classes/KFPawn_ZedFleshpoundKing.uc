...
DefaultProperties
{
	...
	Health=2500 //1500
	Mass=200.f
    ShieldHealthMaxDefaults[0]=600
    ShieldHealthMaxDefaults[1]=800
    ShieldHealthMaxDefaults[2]=2000
    ShieldHealthMaxDefaults[3]=2500
    ...
    IncapSettings(AF_Bleed)=    (Vulnerability=(0.06))
