...
DefaultProperties
{
	...
	// Within KFPawn
  	Begin Object Name=Afflictions_0
		...
		StackingAffl(SAF_Poison)=(Threshhold=1.0,Duration=2.0,Cooldown=5.0,DissipationRate=1.00)
		StackingAffl(SAF_Microwave)=(Threshhold=1.0,Duration=2.0,Cooldown=5.0,DissipationRate=1.00)
