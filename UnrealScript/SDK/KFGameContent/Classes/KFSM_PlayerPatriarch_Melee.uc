...
defaultproperties
{
	...
	Attacks.Add((Type=PZA_Left,  Stance=EAS_FullBody, Anims=(Player_Spin_Atk)))
	Attacks.Add((Type=PZA_Right,  Stance=EAS_FullBody, Anims=(Player_Spin_Atk)))
	Attacks.Add((Type=PZA_Cloaked,  Stance=EAS_FullBody, Anims=(Player_Shoulder_Light)))
	Attacks.Add((Type=PZA_SprintCloaked,  Stance=EAS_FullBody, Anims=(Player_Shoulder_Heavy)))
}