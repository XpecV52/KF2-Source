...
defaultproperties
{
	...
	Attacks.Add((Type=PZA_Sprinting, Stance=EAS_FullBody, Anims=(Player_Lunge_Heavy)))
	...
	// Rage attacks
	Attacks.Add((Type=PZA_SpecialDefault, Stance=EAS_FullBody, Anims=(Player_Rage_Heavy)))
