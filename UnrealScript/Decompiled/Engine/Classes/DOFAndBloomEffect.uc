...
enum EDOFType<DOFType_SimpleDOF.DisplayName=SimpleDOF|DOFType_ReferenceDOF.DisplayName=ReferenceDOF|DOFType_BokehDOF.DisplayName=BokehDOF|DOFType_VariableWidthDOF.DisplayName=VariableWidthDOF>
{
    DOFType_SimpleDOF,
    DOFType_ReferenceDOF,
    DOFType_BokehDOF,
    DOFType_VariableWidthDOF,
    DOFType_MAX
};
