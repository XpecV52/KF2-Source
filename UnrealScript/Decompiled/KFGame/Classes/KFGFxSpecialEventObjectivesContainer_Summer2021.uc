/*******************************************************************************
 * KFGFxSpecialEventObjectivesContainer_Summer2021 generated by Eliot.UELib using UE Explorer.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class KFGFxSpecialEventObjectivesContainer_Summer2021 extends KFGFxSpecialEventObjectivesContainer within GFxMoviePlayer;
...
defaultproperties
{
    ...
    SpecialEventObjectiveInfoList(0)=(TitleString="Kicked!",DescriptionString="Stomp on 50 Zeds",TierEventRewardName="")
    SpecialEventObjectiveInfoList(1)=(TitleString="Weekly Lunar",DescriptionString="Complete the Weekly on Moonbase",TierEventRewardName="")
    SpecialEventObjectiveInfoList(2)=(TitleString="Shocking Moonlight",DescriptionString="Use the laser trap to kill 20 Zeds on Moonbase",TierEventRewardName="")
    SpecialEventObjectiveInfoList(3)=(TitleString="Weightlessness Skills",DescriptionString="Kill 300 Zeds while jumping in the air on Moonbase",TierEventRewardName="")
    SpecialEventObjectiveInfoList(4)=(TitleString="Infinite Void",DescriptionString="Complete wave 15 on Endless Hard or higher difficulty on Moonbase",TierEventRewardName="")
