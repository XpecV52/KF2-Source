...
function InitializeGameOptions()
{
    ...
    if(I >= 0)
    {
        if((((bIsSoloGame && !Class'KFGameInfo'.static.IsGameModeSoloPlayAllowed(I)) || !Class'GameEngine'.static.IsGameFullyInstalled() && I == 4) || !Class'GameEngine'.static.IsGameFullyInstalled() && I == 1) || !Class'GameEngine'.static.IsGameFullyInstalled() && I == 3)
        {
