...
defaultproperties
{
    ...
    PerkSkills(7)=(Name="LimbShots",Increment=0,Rank=0,StartingValue=10.1,MaxValue=10.1,ModifierValue=0,IconPath="UI_PerkTalent_TEX.Gunslinger.UI_Talents_Gunslinger_LimbShots",bActive=false)
