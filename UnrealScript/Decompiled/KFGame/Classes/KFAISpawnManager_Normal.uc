...
defaultproperties
{
    ...
    SoloWaveSpawnRateModifier[0]=(RateModifier=(1.55,1.6,1.65,1.7,1.75,1.8,1.85))
    SoloWaveSpawnRateModifier[1]=(RateModifier=(1.55,1.6,1.65,1.7,1.75,1.8,1.8))
    SoloWaveSpawnRateModifier[2]=(RateModifier=(1.55,1.6,1.65,1.7,1.75,1.8,1.8))
    SoloWaveSpawnRateModifier[3]=(RateModifier=(1.55,1.6,1.65,1.7,1.75,1.8,1.8))
    EarlyWaveIndex=4
}