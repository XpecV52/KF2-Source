/*******************************************************************************
 * KFEmoteList generated by Eliot.UELib using UE Explorer.
...
// Export UKFEmoteList::execGetUnlockedEmote(FFrame&, void* const)
native static final function name GetUnlockedEmote(int ItemId);

// Export UKFEmoteList::execGetEmoteIndex(FFrame&, void* const)
native static final function byte GetEmoteIndex(int ItemId);

// Export UKFEmoteList::execGetEmoteFromIndex(FFrame&, void* const)
native static final function name GetEmoteFromIndex(byte EmoteIndex);

// Export UKFEmoteList::execIsEmoteEquipped(FFrame&, void* const)
native static final function bool IsEmoteEquipped(int ItemId);

// Export UKFEmoteList::execGetEquippedEmoteId(FFrame&, void* const)
native static final function int GetEquippedEmoteId();

// Export UKFEmoteList::execSaveEquippedEmote(FFrame&, void* const)
native static final function SaveEquippedEmote(int ItemId);

// Export UKFEmoteList::execRefreshCachedEmoteId(FFrame&, void* const)
native static final function RefreshCachedEmoteId();

// Export UKFEmoteList::execGetEmoteArray(FFrame&, void* const)
native static final function array<Emote> GetEmoteArray();
...
defaultproperties
{
    ...
    Emotes(6)=(Id=0,ItemName="MatingRitual",AnimName=Emote_07_MatingRitual,IconPath="EMOTE_TEX.Emote_MatingRitual_512")
