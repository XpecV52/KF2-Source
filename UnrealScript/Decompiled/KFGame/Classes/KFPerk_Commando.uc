...
defaultproperties
{
    ...
    PerkSkills(2)=(Name="Backup",Increment=0,Rank=0,StartingValue=2.1,MaxValue=2.1,ModifierValue=0,IconPath="UI_PerkTalent_TEX.commando.UI_Talents_Commando_Backup",bActive=false)
