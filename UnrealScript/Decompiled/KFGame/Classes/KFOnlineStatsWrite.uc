...
private final event AddToHitsTaken()
{
    SeasonalEventStats_OnHitTaken();
}

private final event AddToHitsGiven(class<DamageType> DT)
{
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if(IsClotSurvivalistKill(MonsterClass))
                    {
...
private final event AddToHeadshotKills(class<KFPawn_Monster> MonsterClass, byte Difficulty, class<DamageType> DT)
{
...
private final event AddToWeaponPurchased(class<KFWeaponDefinition> WeaponDef, int Price)
{
...
private final event AddSmallRadiusKill(byte Difficulty, class<KFPerk> PerkClass)
{
    ...
    {
        if(PerkClass == Class'KFPerk_Survivalist'.static.GetPerkClass())
        {
            AddXP(Class'KFPerk_Survivalist', Class'KFPerk_Survivalist'.static.GetSmallRadiusKillXP(Difficulty));
            if(((MyKFPC != none) && MyKFPC.MatchStats != none) && Class'KFPerk_Survivalist' != none)
            {
                MyKFPC.MatchStats.RecordSecondaryXPGain(Class'KFPerk_Survivalist', Class'KFPerk_Survivalist'.static.GetSmallRadiusKillXP(Difficulty));
            }
...
private final function AddClotSurvivalistKill(byte Difficulty)
{
    AddXP(Class'KFPerk_Survivalist', Class'KFPerk_Survivalist'.static.GetClotKillXP(Difficulty));
    if(((MyKFPC != none) && MyKFPC.MatchStats != none) && Class'KFPerk_Survivalist' != none)
    {
        MyKFPC.MatchStats.RecordSecondaryXPGain(Class'KFPerk_Survivalist', Class'KFPerk_Survivalist'.static.GetClotKillXP(Difficulty));
    }
...
private native final function CacheSpecialEventState(int Value, int Year, int Month);
...
// Export UKFOnlineStatsWrite::execSeasonalEventStats_OnGameEnd(FFrame&, void* const)
native final simulated event SeasonalEventStats_OnGameEnd(class<GameInfo> GameClass);
...
defaultproperties
{
    ...
    DailyEvents(7)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Stunner,KFDT_Ballistic_HRG_Stunner,KFDT_Ballistic_HRG_Stunner_Alt,KFDT_Explosive_HRG_Stunner,KFDT_Bludgeon_HRG_Stunner),CompletionAmount=10000)
    DailyEvents(8)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_SMG_Kriss,KFDT_Ballistic_Kriss,KFDT_Bludgeon_Kriss),CompletionAmount=10000)
    DailyEvents(9)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_SMG_HK_UMP,KFDT_Ballistic_HK_UMP,KFDT_Bludgeon_HK_UMP),CompletionAmount=10000)
    DailyEvents(10)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_BarrierRifle,KFDT_Ballistic_HRG_BarrierRifle,KFDT_Bludgeon_HRG_BarrierRifle),CompletionAmount=10000)
    DailyEvents(11)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_AR15,KFDT_Ballistic_AR15,KFDT_Bludgeon_AR15),CompletionAmount=5000)
    DailyEvents(12)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_Bullpup,KFDT_Ballistic_Bullpup,KFDT_Bludgeon_Bullpup),CompletionAmount=7000)
    DailyEvents(13)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_AK12,KFDT_Ballistic_AK12,KFDT_Bludgeon_AK12),CompletionAmount=10000)
    DailyEvents(14)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_SCAR,KFDT_Ballistic_SCAR,KFDT_Bludgeon_SCAR),CompletionAmount=10000)
    DailyEvents(15)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_MKB42,KFDT_Ballistic_MKB42,KFDT_Bludgeon_MKB42),CompletionAmount=10000)
    DailyEvents(16)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_LMG_Stoner63A,KFDT_Ballistic_Stoner63A,KFDT_Bludgeon_Stoner63A),CompletionAmount=10000)
    DailyEvents(17)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_MB500,KFDT_Ballistic_MB500,KFDT_Bludgeon_MB500),CompletionAmount=5000)
    DailyEvents(18)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_DoubleBarrel,KFDT_Ballistic_DBShotgun,KFDT_Bludgeon_DBShotgun),CompletionAmount=7000)
    DailyEvents(19)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Revolver_Buckshot,KFDT_Ballistic_HRGBuckshot,KFDT_Bludgeon_HRGBuckshot),CompletionAmount=10000)
    DailyEvents(20)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_HZ12,KFDT_Ballistic_HZ12,KFDT_Bludgeon_HZ12),CompletionAmount=10000)
    DailyEvents(21)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_M4,KFDT_Ballistic_M4Shotgun,KFDT_Bludgeon_M4Shotgun),CompletionAmount=10000)
    DailyEvents(22)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_AA12,KFDT_Ballistic_AA12Shotgun,KFDT_Bludgeon_AA12Shotgun),CompletionAmount=10000)
    DailyEvents(23)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_ElephantGun,KFDT_Ballistic_ElephantGun,KFDT_Bludgeon_ElephantGun),CompletionAmount=10000)
    DailyEvents(24)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_BlastBrawlers,KFDT_Ballistic_BlastBrawlersShotgun,KFDT_Bludgeon_BlastBrawlers,KFDT_Bludgeon_BlastBrawlersHeavy,KFDT_Bludgeon_BlastBrawlersBash),CompletionAmount=10000)
    DailyEvents(25)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_Medic,KFDT_Ballistic_Pistol_Medic,KFDT_Bludgeon_Pistol_Medic),CompletionAmount=5000)
    DailyEvents(26)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_SMG_Medic,KFDT_Ballistic_SMG_Medic,KFDT_Bludgeon_SMG_Medic),CompletionAmount=7000)
    DailyEvents(27)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_Medic,KFDT_Ballistic_Shotgun_Medic,KFDT_Bludgeon_Shotgun_Medic),CompletionAmount=9000)
    DailyEvents(28)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Healthrower,KFDT_Toxic_HRGHealthrower,KFDT_Bludgeon_HRGHealthrower),CompletionAmount=9000)
    DailyEvents(29)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_Hemogoblin,KFDT_Ballistic_Hemogoblin,KFDT_Bludgeon_Hemogoblin),CompletionAmount=9000)
    DailyEvents(30)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_Medic,KFDT_Ballistic_Assault_Medic,KFDT_Bludgeon_Assault_Medic),CompletionAmount=9000)
    DailyEvents(31)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_HRGIncision,KFDT_Ballistic_HRGIncisionHurt,KFDT_Ballistic_HRGIncisionHeal,KFDT_Bludgeon_HRGIncision),CompletionAmount=5000)
    DailyEvents(32)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Vampire,KFDT_Bleeding_HRG_Vampire_BloodSuck,KFDT_Ballistic_HRG_Vampire_BloodBallImpact,KFDT_Ballistic_HRG_Vampire_BloodBallHeavyImpact,KFDT_Toxic_HRG_Vampire_BloodBall,KFDT_Piercing_HRG_Vampire_CrystalSpike,KFDT_Bludgeon_HRG_Vampire),CompletionAmount=9000)
    DailyEvents(33)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_MedicRifleGrenadeLauncher,KFDT_Ballistic_MedicRifleGrenadeLauncher,KFDT_Bludgeon_MedicRifleGrenadeLauncher,KFDT_Toxic_MedicGrenadeLauncher,KFDT_Ballistic_MedicRifleGrenadeLauncherImpact),CompletionAmount=10000)
    DailyEvents(34)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_GrenadeLauncher_HX25,KFDT_ExplosiveSubmunition_HX25,KFDT_Ballistic_HX25Impact,KFDT_Ballistic_HX25SubmunitionImpact,KFDT_Bludgeon_HX25),CompletionAmount=5000)
    DailyEvents(35)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Thrown_C4,KFDT_Explosive_C4,KFDT_Bludgeon_C4),CompletionAmount=2500)
    DailyEvents(36)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_GrenadeLauncher_M79,KFDT_Ballistic_M79Impact,KFDT_Explosive_M79,KFDT_Bludgeon_M79),CompletionAmount=7000)
    DailyEvents(37)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Boomy,KFDT_Ballistic_HRG_Boomy,KFDT_Explosive_HRG_Boomy,KFDT_Bludgeon_HRG_Boomy),CompletionAmount=7000)
    DailyEvents(38)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Crossboom,KFDT_Piercing_HRG_Crossboom,KFDT_Explosive_HRG_Crossboom,KFDT_Explosive_HRG_CrossboomAlt,KFDT_Bludgeon_HRG_Crossboom),CompletionAmount=7000)
    DailyEvents(39)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_HRG_Kaboomstick,KFDT_Ballistic_HRG_Kaboomstick,KFDT_Explosive_HRG_Kaboomstick,KFDT_Bludgeon_HRG_Kaboomstick),CompletionAmount=9000)
    DailyEvents(40)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_RocketLauncher_RPG7,KFDT_Ballistic_RPG7Impact,KFDT_Explosive_RPG7,KFDT_Explosive_RPG7BackBlast,KFDT_Bludgeon_RPG7),CompletionAmount=7500)
    DailyEvents(41)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_M16M203,KFDT_Ballistic_M16M203,KFDT_Bludgeon_M16M203,KFDT_Ballistic_M203Impact,KFDT_Explosive_M16M203),CompletionAmount=9000)
    DailyEvents(42)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_RocketLauncher_SealSqueal,KFDT_Bludgeon_SealSqueal,KFDT_Explosive_SealSqueal,KFDT_Ballistic_SealSquealImpact),CompletionAmount=7500)
    DailyEvents(43)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_RocketLauncher_Seeker6,KFDT_Explosive_Seeker6,KFDT_Bludgeon_Seeker6,KFDT_Ballistic_Seeker6Impact),CompletionAmount=7500)
    DailyEvents(44)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_GrenadeLauncher_M32,KFDT_Bludgeon_M32,KFDT_Explosive_M32,KFDT_Ballistic_M32Impact),CompletionAmount=10000)
    DailyEvents(45)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Flame_CaulkBurn,KFDT_Bludgeon_CaulkBurn,KFDT_Fire_CaulkBurn,KFDT_Fire_Ground_CaulkNBurn),CompletionAmount=5000)
    DailyEvents(46)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_Flare,KFDT_Bludgeon_FlareGun,KFDT_Fire_FlareGun,KFDT_Fire_FlareGun_Dual,KFDT_Fire_FlareGunDoT),CompletionAmount=7000)
    DailyEvents(47)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_DragonsBreath,KFDT_Ballistic_DragonsBreath,KFDT_Bludgeon_DragonsBreath,KFDT_Fire_DragonsBreathDoT,KFDT_Fire_Ground_DragonsBreath),CompletionAmount=7000)
    DailyEvents(48)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_SMG_Mac10,KFDT_Bludgeon_Mac10,KFDT_Fire_Mac10,KFDT_Fire_Mac10DoT),CompletionAmount=9000)
    DailyEvents(49)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Flame_Flamethrower,KFDT_Bludgeon_Flamethrower,KFDT_Fire_FlameThrower,KFDT_Fire_Ground_FlameThrower),CompletionAmount=9000)
    DailyEvents(50)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_HRGIncendiaryRifle,KFDT_Bludgeon_HRGIncendiaryRifle,KFDT_Ballistic_HRGIncendiaryRifle,KFDT_Explosive_HRGIncendiaryRifle,KFDT_Ballistic_HRGIncendiaryRifleGrenadeImpact,KFDT_Fire_HRGIncendiaryRifleBulletDoT,KFDT_Fire_HRGIncendiaryRifleGrenadeDoT,KFDT_Fire_Ground_HRGIncendiaryRifle),CompletionAmount=9000)
    DailyEvents(51)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_HRGScorcher,KFDT_Bludgeon_HRGScorcher,KFDT_Ballistic_HRGScorcherLightingImpact,KFDT_Fire_HRGScorcherDoT,KFDT_Ballistic_HRGScorcherBrokenImpact,KFDT_Fire_Ground_HRGScorcher),CompletionAmount=9000)
    DailyEvents(52)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Beam_Microwave,KFDT_Bludgeon_MicrowaveGun,KFDT_Fire_Ground_MicrowaveGun,KFDT_Microwave,KFDT_Microwave_Beam,KFDT_Microwave_Blast),CompletionAmount=10000)
    DailyEvents(53)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HuskCannon,KFDT_Bludgeon_HuskCannon,KFDT_Explosive_HuskCannon,KFDT_HuskCannonDot,KFDT_Explosive_HuskCannonImpact),CompletionAmount=10000)
    DailyEvents(54)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Dragonbreath,KFDT_Ballistic_HRG_Dragonbreath,KFDT_Bludgeon_HRG_Dragonbreath,KFDT_Fire_HRG_DragonsBreathDoT,KFDT_Fire_HRG_DragonsBreathDoT,KFDT_Fire_Ground_HRG_DragonBreath),CompletionAmount=10000)
    DailyEvents(55)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_Microwave,KFDT_Ballistic_MicrowaveRifle,KFDT_Fire_MicrowaveRifleDoT,KFDT_Bludgeon_MicrowaveRifle),CompletionAmount=10000)
    DailyEvents(56)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Blunt_Crovel,KFDT_Bludgeon_Crovel,KFDT_Bludgeon_CrovelBash,KFDT_Slashing_Crovel),CompletionAmount=5000)
    DailyEvents(57)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Shotgun_Nailgun,KFDT_Ballistic_NailShotgun,KFDT_Bludgeon_NailShotgun),CompletionAmount=7000)
    DailyEvents(58)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Edged_Katana,KFDT_Slashing_Katana,KFDT_Piercing_KatanaStab,KFDT_Slashing_KatanaHeavy),CompletionAmount=7000)
    DailyEvents(59)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Edged_FireAxe,KFDT_Bludgeon_FireAxeBash,KFDT_Slashing_FireAxe,KFDT_Slashing_FireAxeHeavy),CompletionAmount=7000)
    DailyEvents(60)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Blunt_Pulverizer,KFDT_Bludgeon_Pulverizer,KFDT_Bludgeon_PulverizerBash,KFDT_Bludgeon_PulverizerHeavy,KFDT_Explosive_Pulverizer),CompletionAmount=10000)
    DailyEvents(61)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Blunt_MedicBat,KFDT_Bludgeon_MedicBatBash,KFDT_Bludgeon_MedicBatHeavy,KFDT_Bludgeon_MedicBatLight,KFDT_Toxic_MedicBatGas,KFDT_Toxic_MedicBatDoT),CompletionAmount=10000)
    DailyEvents(62)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Eviscerator,KFDT_Slashing_Eviscerator,KFDT_Slashing_EvisceratorProj),CompletionAmount=10000)
    DailyEvents(63)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Blunt_MaceAndShield,KFDT_Bludgeon_MaceAndShield,KFDT_Bludgeon_MaceAndShield_Bash,KFDT_Bludgeon_MaceAndShield_MaceHeavy,KFDT_Bludgeon_MaceAndShield_ShieldHeavy,KFDT_Bludgeon_MaceAndShield_ShieldLight),CompletionAmount=10000)
    DailyEvents(64)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Blunt_PowerGloves,KFDT_Bludgeon_PowerGloves,KFDT_Bludgeon_PowerGlovesBash,KFDT_Bludgeon_PowerGlovesHeavy),CompletionAmount=10000)
    DailyEvents(65)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_HRGTeslauncher,KFDT_Ballistic_HRGTeslauncher,KFDT_Fire_HRGTeslauncherDoT,KFDT_Ballistic_HRGTeslauncherGrenadeImpact,KFDT_Bludgeon_HRGTeslauncher,KFDT_EMP_TeslauncherEMPGrenade),CompletionAmount=10000)
    DailyEvents(66)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Edged_AbominationAxe,KFDT_Slashing_AbominationAxe,KFDT_Piercing_AbominationAxeStab,KFDT_Slashing_AbominationAxeHeavy),CompletionAmount=10000)
    DailyEvents(67)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Revolver_Rem1858,KFDT_Bludgeon_Rem1858,KFDT_Ballistic_Rem1858,KFDT_Ballistic_Rem1858_Dual),CompletionAmount=5000)
    DailyEvents(68)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_Colt1911,KFDT_Bludgeon_Colt1911,KFDT_Ballistic_Colt1911),CompletionAmount=7000)
    DailyEvents(69)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_HRGWinterbite,KFDT_Bludgeon_HRGWinterbite,KFDT_Freeze_HRGWinterbiteImpact,KFDT_Explosive_HRGWinterbite),CompletionAmount=7000)
    DailyEvents(70)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_Deagle,KFDT_Bludgeon_Deagle,KFDT_Ballistic_Deagle),CompletionAmount=10000)
    DailyEvents(71)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Revolver_SW500,KFDT_Bludgeon_SW500,KFDT_Ballistic_SW500,KFDT_Ballistic_SW500_Dual),CompletionAmount=10000)
    DailyEvents(72)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Pistol_AF2011,KFDT_Bludgeon_AF2011,KFDT_Ballistic_AF2011),CompletionAmount=10000)
    DailyEvents(73)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Energy,KFDT_Ballistic_HRG_Energy_Primary,KFDT_Ballistic_HRG_Energy_Secondary,KFDT_Bludgeon_HRG_Energy),CompletionAmount=10000)
    DailyEvents(74)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_Winchester1894,KFDT_Bludgeon_Winchester,KFDT_Ballistic_Winchester),CompletionAmount=5000)
    DailyEvents(75)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Bow_Crossbow,KFDT_Bludgeon_Crossbow,KFDT_Piercing_Crossbow),CompletionAmount=7000)
    DailyEvents(76)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_M14EBR,KFDT_Bludgeon_M14EBR,KFDT_Ballistic_M14EBR),CompletionAmount=9000)
    DailyEvents(77)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_SonicGun,KFDT_Bludgeon_HRG_SonicGun,KFDT_Ballistic_HRG_SonicGun_SonicBlastUncharged,KFDT_Ballistic_HRG_SonicGun_SonicBlastHalfCharged,KFDT_Ballistic_HRG_SonicGun_SonicBlastFullyCharged),CompletionAmount=7000)
    DailyEvents(78)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_CranialPopper,KFDT_Bludgeon_HRG_CranialPopper,KFDT_Piercing_HRG_CranialPopper,KFDT_Blast_HRG_CranialPopper),CompletionAmount=7000)
    DailyEvents(79)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_RailGun,KFDT_Bludgeon_RailGun,KFDT_Ballistic_RailGun),CompletionAmount=5000)
    DailyEvents(80)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_CenterfireMB464,KFDT_Bludgeon_CenterfireMB464,KFDT_Ballistic_CenterfireMB464),CompletionAmount=7000)
    DailyEvents(81)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Rifle_M99,KFDT_Bludgeon_M99,KFDT_Ballistic_M99),CompletionAmount=5000)
    DailyEvents(82)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_FNFal,KFDT_Ballistic_FNFal,KFDT_Bludgeon_FNFal),CompletionAmount=10000)
    DailyEvents(83)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_Locust,KFDT_Bludgeon_HRG_Locust,KFDT_Toxic_HRG_Locust,KFDT_Ballistic_HRG_Locust),CompletionAmount=7000)
    DailyEvents(84)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_Ice_FreezeThrower,KFDT_Bludgeon_Freezethrower,KFDT_Freeze_FreezeThrower,KFDT_Freeze_FreezeThrower_IceShards,KFDT_Freeze_Ground_FreezeThrower),CompletionAmount=7000)
    DailyEvents(85)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_HRG_EMP_ArcGenerator,KFDT_Bludgeon_ArcGenerator,KFDT_EMP_ArcGenerator_Beam,KFDT_EMP_ArcGeneratorSphereImpact,KFDT_EMP_ArcGenerator_DefaultFiremodeZapDamage,KFDT_EMP_ArcGenerator_AltFiremodeZapDamage),CompletionAmount=9000)
    DailyEvents(86)=(ObjectiveType=eDailyObjectiveType.DOT_WeaponDamage,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFWeap_AssaultRifle_LazerCutter,KFDT_Ballistic_LazerCutter,KFDT_LazerCutter_Beam,KFDT_Bludgeon_LazerCutter),CompletionAmount=10000)
    DailyEvents(87)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedClot_Alpha),CompletionAmount=20)
    DailyEvents(88)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedClot_AlphaKing),CompletionAmount=5)
    DailyEvents(89)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedClot_Cyst),CompletionAmount=30)
    DailyEvents(90)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedClot_Slasher),CompletionAmount=25)
    DailyEvents(91)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedCrawler),CompletionAmount=30)
    DailyEvents(92)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedCrawlerKing),CompletionAmount=5)
    DailyEvents(93)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedStalker),CompletionAmount=10)
    DailyEvents(94)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedBloat),CompletionAmount=5)
    DailyEvents(95)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedSiren),CompletionAmount=5)
    DailyEvents(96)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedHusk),CompletionAmount=3)
    DailyEvents(97)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedGorefast),CompletionAmount=20)
    DailyEvents(98)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedGorefastDualBlade),CompletionAmount=8)
    DailyEvents(99)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedScrake),CompletionAmount=1)
    DailyEvents(100)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedFleshpound),CompletionAmount=1)
    DailyEvents(101)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedFleshpoundMini),CompletionAmount=2)
    DailyEvents(102)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedDAR_EMP),CompletionAmount=5)
    DailyEvents(103)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedDAR_Laser),CompletionAmount=5)
    DailyEvents(104)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillZeds,ObjectiveClasses=(KFPawn_ZedDAR_Rocket),CompletionAmount=5)
    DailyEvents(105)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_KillBoss,ObjectiveClasses=none,CompletionAmount=1)
    DailyEvents(106)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Berserker),CompletionAmount=1500)
    DailyEvents(107)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Commando),CompletionAmount=1500)
    DailyEvents(108)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Demolitionist),CompletionAmount=1500)
    DailyEvents(109)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_FieldMedic),CompletionAmount=1500)
    DailyEvents(110)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Firebug),CompletionAmount=1500)
    DailyEvents(111)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Gunslinger),CompletionAmount=1500)
    DailyEvents(112)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Sharpshooter),CompletionAmount=1500)
    DailyEvents(113)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Support),CompletionAmount=1500)
    DailyEvents(114)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_Survivalist),CompletionAmount=1500)
    DailyEvents(115)=(ObjectiveType=eDailyObjectiveType.DOT_PerkXP,SecondaryType=eDailyObjectiveSecondaryType.DOST_PlayPerk,ObjectiveClasses=(KFPerk_SWAT),CompletionAmount=1500)
    DailyEvents(116)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BURNINGPARIS),CompletionAmount=1)
    DailyEvents(117)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BURNINGPARIS),CompletionAmount=2)
    DailyEvents(118)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BURNINGPARIS),CompletionAmount=3)
    DailyEvents(119)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-OUTPOST),CompletionAmount=1)
    DailyEvents(120)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-OUTPOST),CompletionAmount=2)
    DailyEvents(121)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-OUTPOST),CompletionAmount=3)
    DailyEvents(122)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BIOTICSLAB),CompletionAmount=1)
    DailyEvents(123)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BIOTICSLAB),CompletionAmount=2)
    DailyEvents(124)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BIOTICSLAB),CompletionAmount=3)
    DailyEvents(125)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-VOLTERMANOR),CompletionAmount=1)
    DailyEvents(126)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-VOLTERMANOR),CompletionAmount=2)
    DailyEvents(127)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-VOLTERMANOR),CompletionAmount=3)
    DailyEvents(128)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-EVACUATIONPOINT),CompletionAmount=1)
    DailyEvents(129)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-EVACUATIONPOINT),CompletionAmount=2)
    DailyEvents(130)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-EVACUATIONPOINT),CompletionAmount=3)
    DailyEvents(131)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CATACOMBS),CompletionAmount=1)
    DailyEvents(132)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CATACOMBS),CompletionAmount=2)
    DailyEvents(133)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CATACOMBS),CompletionAmount=3)
    DailyEvents(134)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BLACKFOREST),CompletionAmount=1)
    DailyEvents(135)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BLACKFOREST),CompletionAmount=2)
    DailyEvents(136)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BLACKFOREST),CompletionAmount=3)
    DailyEvents(137)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-FARMHOUSE),CompletionAmount=1)
    DailyEvents(138)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-FARMHOUSE),CompletionAmount=2)
    DailyEvents(139)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-FARMHOUSE),CompletionAmount=3)
    DailyEvents(140)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PRISON),CompletionAmount=1)
    DailyEvents(141)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PRISON),CompletionAmount=2)
    DailyEvents(142)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PRISON),CompletionAmount=3)
    DailyEvents(143)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CONTAINMENTSTATION),CompletionAmount=1)
    DailyEvents(144)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CONTAINMENTSTATION),CompletionAmount=2)
    DailyEvents(145)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CONTAINMENTSTATION),CompletionAmount=3)
    DailyEvents(146)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HOSTILEGROUNDS),CompletionAmount=1)
    DailyEvents(147)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HOSTILEGROUNDS),CompletionAmount=2)
    DailyEvents(148)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HOSTILEGROUNDS),CompletionAmount=3)
    DailyEvents(149)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-INFERNALREALM),CompletionAmount=1)
    DailyEvents(150)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-INFERNALREALM),CompletionAmount=2)
    DailyEvents(151)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-INFERNALREALM),CompletionAmount=3)
    DailyEvents(152)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ZEDLANDING),CompletionAmount=1)
    DailyEvents(153)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ZEDLANDING),CompletionAmount=2)
    DailyEvents(154)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ZEDLANDING),CompletionAmount=3)
    DailyEvents(155)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TheDescent),CompletionAmount=1)
    DailyEvents(156)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TheDescent),CompletionAmount=2)
    DailyEvents(157)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TheDescent),CompletionAmount=3)
    DailyEvents(158)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NUKED),CompletionAmount=1)
    DailyEvents(159)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NUKED),CompletionAmount=2)
    DailyEvents(160)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NUKED),CompletionAmount=3)
    DailyEvents(161)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TRAGICKINGDOM),CompletionAmount=1)
    DailyEvents(162)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TRAGICKINGDOM),CompletionAmount=2)
    DailyEvents(163)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-TRAGICKINGDOM),CompletionAmount=3)
    DailyEvents(164)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Nightmare),CompletionAmount=1)
    DailyEvents(165)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Nightmare),CompletionAmount=2)
    DailyEvents(166)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Nightmare),CompletionAmount=3)
    DailyEvents(167)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-KrampusLair),CompletionAmount=1)
    DailyEvents(168)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-KrampusLair),CompletionAmount=2)
    DailyEvents(169)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-KrampusLair),CompletionAmount=3)
    DailyEvents(170)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PowerCore_Holdout),CompletionAmount=1)
    DailyEvents(171)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PowerCore_Holdout),CompletionAmount=2)
    DailyEvents(172)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-PowerCore_Holdout),CompletionAmount=3)
    DailyEvents(173)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-AIRSHIP),CompletionAmount=1)
    DailyEvents(174)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-AIRSHIP),CompletionAmount=2)
    DailyEvents(175)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-AIRSHIP),CompletionAmount=3)
    DailyEvents(176)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-LOCKDOWN),CompletionAmount=1)
    DailyEvents(177)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-LOCKDOWN),CompletionAmount=2)
    DailyEvents(178)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-LOCKDOWN),CompletionAmount=3)
    DailyEvents(179)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MONSTERBALL),CompletionAmount=1)
    DailyEvents(180)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MONSTERBALL),CompletionAmount=2)
    DailyEvents(181)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MONSTERBALL),CompletionAmount=3)
    DailyEvents(182)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SHOPPINGSPREE),CompletionAmount=1)
    DailyEvents(183)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SHOPPINGSPREE),CompletionAmount=2)
    DailyEvents(184)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SHOPPINGSPREE),CompletionAmount=3)
    DailyEvents(185)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANTASWORKSHOP),CompletionAmount=1)
    DailyEvents(186)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANTASWORKSHOP),CompletionAmount=2)
    DailyEvents(187)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANTASWORKSHOP),CompletionAmount=3)
    DailyEvents(188)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SPILLWAY),CompletionAmount=1)
    DailyEvents(189)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SPILLWAY),CompletionAmount=2)
    DailyEvents(190)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SPILLWAY),CompletionAmount=3)
    DailyEvents(191)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SteamFortress),CompletionAmount=1)
    DailyEvents(192)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SteamFortress),CompletionAmount=2)
    DailyEvents(193)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SteamFortress),CompletionAmount=3)
    DailyEvents(194)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ASHWOODASYLUM),CompletionAmount=1)
    DailyEvents(195)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ASHWOODASYLUM),CompletionAmount=2)
    DailyEvents(196)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ASHWOODASYLUM),CompletionAmount=3)
    DailyEvents(197)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANITARIUM),CompletionAmount=1)
    DailyEvents(198)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANITARIUM),CompletionAmount=2)
    DailyEvents(199)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-SANITARIUM),CompletionAmount=3)
    DailyEvents(200)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Biolapse),CompletionAmount=1)
    DailyEvents(201)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Biolapse),CompletionAmount=2)
    DailyEvents(202)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-Biolapse),CompletionAmount=3)
    DailyEvents(203)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DESOLATION),CompletionAmount=1)
    DailyEvents(204)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DESOLATION),CompletionAmount=2)
    DailyEvents(205)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DESOLATION),CompletionAmount=3)
    DailyEvents(206)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HELLMARKSTATION),CompletionAmount=1)
    DailyEvents(207)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HELLMARKSTATION),CompletionAmount=2)
    DailyEvents(208)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-HELLMARKSTATION),CompletionAmount=3)
    DailyEvents(209)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ELYSIUM),CompletionAmount=1)
    DailyEvents(210)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ELYSIUM),CompletionAmount=2)
    DailyEvents(211)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-ELYSIUM),CompletionAmount=3)
    DailyEvents(212)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DYSTOPIA2029),CompletionAmount=1)
    DailyEvents(213)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DYSTOPIA2029),CompletionAmount=2)
    DailyEvents(214)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-DYSTOPIA2029),CompletionAmount=3)
    DailyEvents(215)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MOONBASE),CompletionAmount=1)
    DailyEvents(216)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MOONBASE),CompletionAmount=2)
    DailyEvents(217)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-MOONBASE),CompletionAmount=3)
    DailyEvents(218)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NETHERHOLD),CompletionAmount=1)
    DailyEvents(219)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NETHERHOLD),CompletionAmount=2)
    DailyEvents(220)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-NETHERHOLD),CompletionAmount=3)
    DailyEvents(221)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CARILLONHAMLET),CompletionAmount=1)
    DailyEvents(222)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CARILLONHAMLET),CompletionAmount=2)
    DailyEvents(223)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-CARILLONHAMLET),CompletionAmount=3)
    DailyEvents(224)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-RIG),CompletionAmount=1)
    DailyEvents(225)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-RIG),CompletionAmount=2)
    DailyEvents(226)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-RIG),CompletionAmount=3)
    DailyEvents(227)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BARMWICHTOWN),CompletionAmount=1)
    DailyEvents(228)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BARMWICHTOWN),CompletionAmount=2)
    DailyEvents(229)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_MapCompletion,ObjectiveClasses=(KF-BARMWICHTOWN),CompletionAmount=3)
    DailyEvents(230)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(chr_briar_archetype),CompletionAmount=1)
    DailyEvents(231)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_MrFoster_archetype),CompletionAmount=1)
    DailyEvents(232)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_Coleman_archetype),CompletionAmount=1)
    DailyEvents(233)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_Alberts_archetype),CompletionAmount=1)
    DailyEvents(234)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_Masterson_archetype),CompletionAmount=1)
    DailyEvents(235)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_Tanaka_Archetype),CompletionAmount=1)
    DailyEvents(236)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_Ana_Archetype),CompletionAmount=1)
    DailyEvents(237)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(chr_rockabilly_archetype),CompletionAmount=1)
    DailyEvents(238)=(ObjectiveType=eDailyObjectiveType.DOT_Maps,SecondaryType=eDailyObjectiveSecondaryType.DOST_CharacterCompletion,ObjectiveClasses=(CHR_DAR_archetype),CompletionAmount=1)
