...
defaultproperties
{
    HumanRankZedHealthScaleCurve=(Points=/* Array type was not detected. */,InVal=0,OutVal=0.85,ArriveTangent=0,LeaveTangent=0,InterpMode=EInterpCurveMode.CIM_Linear)
    HumanRankZedDamageScaleCurve=(Points=/* Array type was not detected. */,InVal=0,OutVal=0.7,ArriveTangent=0,LeaveTangent=0,InterpMode=EInterpCurveMode.CIM_Linear)
