/*******************************************************************************
 * KFTraderVoiceGroup_Hans generated by Eliot.UELib using UE Explorer.
...
defaultproperties
{
    ...
    DialogEvents[4]=(EventID=4,AudioCue=AkEvent'WW_VOX_NPC_Hans_Trader.Play_Hans_SHOP_PlayerArrives',Chance=0.3)
    ...
    DialogEvents[10]=(EventID=10,AudioCue=AkEvent'WW_VOX_NPC_Hans_Trader.Play_Hans_SHOP_LongRun',Priority=1,Cooldown=10)
    ...
    DialogEvents[15]=(EventID=15,AudioCue=AkEvent'WW_VOX_NPC_Hans_Trader.Play_Hans_SHOP_Heal',Priority=1,Cooldown=10,Chance=0.25)
    DialogEvents[16]=(EventID=16,AudioCue=AkEvent'WW_VOX_NPC_Hans_Trader.Play_Hans_SHOP_TeamHeal',Priority=1,Cooldown=10,Chance=0.25)
