/*******************************************************************************
 * KFWeap_RocketLauncher_Seeker6 generated by Eliot.UELib using UE Explorer.
...
simulated function KFProjectile SpawnProjectile(class<KFProjectile> KFProjClass, Vector RealStartLoc, Vector AimDir)
{
    ...
    if((bUsingSights && CurrentFireMode == 1) && LockedTargets.Length > 0)
    {
        if(LockedTargets.Length > 0)
        {
            SeekerProj = KFProj_Rocket_Seeker6(super(KFWeapon).SpawnProjectile(KFProjClass, RealStartLoc, AimDir));
            if(SeekerProj != none)
            {
...
defaultproperties
{
    ...
    object end
    // Reference: AkComponent'Default__KFWeap_RocketLauncher_Seeker6.IronsightsComponent0'
