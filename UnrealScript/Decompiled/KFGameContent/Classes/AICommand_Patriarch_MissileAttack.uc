/*******************************************************************************
 * AICommand_Patriarch_MissileAttack generated by Eliot.UELib using UE Explorer.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class AICommand_Patriarch_MissileAttack extends AICommand_SpecialMove within KFAIController_ZedPatriarch;
...
function Pushed()
{
    ...
    Outer.AIActionStatus = "Starting Missile Attack AICommand";
    if(Outer.Focus != none)
    {
...
function Popped()
{
    Outer.AIActionStatus = "Finished Missile Attack AICommand";
    super.Popped();
}
