...
defaultproperties
{
    ...
    Hard=(HealthMod=0.9,SprintChance=1,DamagedSprintChance=1,DamageMod=0.7,SoloDamageMod=0.52,EvadeOnDamageSettings=(Chance=0.1,DamagedHealthPctToTrigger=0.01,ForcedEvadeChance=(FL=0.6,FR=0.6)),RallySettings=(bCanRally=false))
