...
defaultproperties
{
    ...
    Suicidal=(HealthMod=0.85,HeadHealthMod=0.85,SprintChance=1,DamagedSprintChance=1,DamageMod=1.15,SoloDamageMod=0.4,EvadeOnDamageSettings=(Chance=0.1,DamagedHealthPctToTrigger=0.01,ForcedEvadeChance=(FL=0.6,FR=0.6)),BlockSettings=(Chance=0.3,Duration=1,MaxBlocks=5,Cooldown=7,DamagedHealthPctToTrigger=0.1,MeleeDamageModifier=0.7,DamageModifier=0.7,AfflictionModifier=0.2,SoloChanceMultiplier=1),RallySettings=(bCanRally=false))
    HellOnEarth=(HealthMod=0.91,SprintChance=1,DamagedSprintChance=1,DamageMod=1.18,SoloDamageMod=0.51,EvadeOnDamageSettings=(Chance=0.1,DamagedHealthPctToTrigger=0.01,ForcedEvadeChance=(FL=0.6,FR=0.6)),BlockSettings=(Chance=0.3,Duration=1,MaxBlocks=6,Cooldown=6.5,DamagedHealthPctToTrigger=0.1,MeleeDamageModifier=0.7,DamageModifier=0.7,AfflictionModifier=0.2,SoloChanceMultiplier=1),RallySettings=(bCanRally=false))
