/*******************************************************************************
 * KFTraderVoiceGroup_Objective generated by Eliot.UELib using UE Explorer.
...
defaultproperties
{
    DialogEvents[0]=(AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_COM_20ZedDead',Priority=1,Chance=0.3)
    DialogEvents[1]=(EventID=1,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_COM_80ZedDead',Priority=1,Chance=0.3)
    DialogEvents[2]=(EventID=2,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_COM_LastZedDead',Priority=1)
    DialogEvents[4]=(EventID=4,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_SHOP_PlayerArrives',Chance=0.3)
    ...
    DialogEvents[7]=(EventID=7,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_SHOP_30Seconds',Chance=0.4)
    ...
    DialogEvents[10]=(EventID=10,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_SHOP_LongRun',Priority=1,Cooldown=10)
    ...
    DialogEvents[15]=(EventID=15,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_SHOP_Heal',Priority=1,Cooldown=10,Chance=0.25)
    DialogEvents[16]=(EventID=16,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_SHOP_TeamHeal',Priority=1,Cooldown=10,Chance=0.25)
    ...
    DialogEvents[28]=(EventID=28,AudioCue=AkEvent'WW_VOX_OBJ_Trader.Play_VOX_OBJ_Trader_POST_50Better',Priority=1,Chance=0.5)
