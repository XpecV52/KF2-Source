...
{
   bCanBeActivated=True
   ReactivationTime=20.000000
   ObjectiveIndex=-1
   EventIndex=-1
   InitialColor=(R=0.000000,G=0.000000,B=0.000000,A=1.000000)
   ActivatedColor=(R=0.000000,G=0.000000,B=0.000000,A=1.000000)
   ReactivationMaterialChangeDelay=0.700000
   ...
   SupportedEvents(0)=Class'KFGame.KFSeqEvent_PowerUpActivated'
   Name="Default__KFTrigger_PowerUp"
