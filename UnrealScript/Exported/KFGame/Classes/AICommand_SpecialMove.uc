...
state Command_SpecialMove extends DEBUGSTATE
{
	...
	function byte GetSpecialMoveFlags( ESpecialMove InSpecialMove )
	{
		...
		{
			return MyKFPawn.SpecialMoves[InSpecialMove].PackFlags();
		}
		return 255;
	}
...
defaultproperties
{
   ...
   TimeOutDelaySeconds=10.000000
   FailureSleepTimeSeconds=0.500000
   FailSafeReadyTime=5.000000
   MaxExecuteSMAttemptsBeforeAbort=5
   bAllowedToAttack=False
   bIgnoreStepAside=True
   Name="Default__AICommand_SpecialMove"
