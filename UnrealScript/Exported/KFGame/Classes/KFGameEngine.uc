...
{
	LogInternal("Read products for store items of type"@MediaType);
...
{
	LogInternal("Additional info for products read complete for type"@MediaType);
...
{
	LogInternal("Inventory items read for"@MediaType);
