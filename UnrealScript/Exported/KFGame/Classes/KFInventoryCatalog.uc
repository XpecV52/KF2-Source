...
defaultproperties
{
   ...
   ItemKeyArray(29)=(ContainerId=4790,KeyId=4303,ItemSeriesName="psncrate_ws4",ContainerType=IDT_Crate)
   ItemKeyArray(30)=(ContainerId=4499,KeyId=4501,ItemSeriesName="horzine10",ContainerType=IDT_Crate)
   ItemKeyArray(31)=(ContainerId=4500,KeyId=4502,ItemSeriesName="horzine11",ContainerType=IDT_Crate)
   ItemKeyArray(32)=(ContainerId=4541,KeyId=4540,ItemSeriesName="emote1",ContainerType=IDT_Crate)
   ItemKeyArray(33)=(ContainerId=4514,KeyId=4513,ItemSeriesName="tacticalhorzineII",ContainerType=IDT_USB)
   ItemKeyArray(34)=(ContainerId=4604,KeyId=4603,ItemSeriesName="horzine12",ContainerType=IDT_Crate)
   ItemKeyArray(35)=(ContainerId=4593,KeyId=4594,ItemSeriesName="deepstrike",ContainerType=IDT_USB)
   ItemKeyArray(36)=(ContainerId=4776,KeyId=4775,ItemSeriesName="horzine13",ContainerType=IDT_Crate)
   ItemKeyArray(37)=(ContainerId=4786,KeyId=4785,ItemSeriesName="highvoltage",ContainerType=IDT_USB)
   ItemKeyArray(38)=(ContainerId=4802,KeyId=4801,ItemSeriesName="Flare",ContainerType=IDT_USB)
   ItemKeyArray(39)=(ContainerId=5010,KeyId=5011,ItemSeriesName="horzine14",ContainerType=IDT_Crate)
   ItemKeyArray(40)=(ContainerId=4993,KeyId=4994,ItemSeriesName="junkyard",ContainerType=IDT_USB)
   ItemKeyArray(41)=(ContainerId=4979,KeyId=4980,ItemSeriesName="vietnam",ContainerType=IDT_USB)
