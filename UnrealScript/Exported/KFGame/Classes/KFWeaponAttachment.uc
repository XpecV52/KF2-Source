...
simulated function SpawnTracer(vector EffectLocation, vector HitLocation)
{
    ...
    if( ((!(self.WorldInfo.TimeDilation < 1.f) && TracerInfos[Instigator.FiringMode].bDoTracerDuringNormalTime)
        || ((self.WorldInfo.TimeDilation < 1.f) && TracerInfos[Instigator.FiringMode].bDoTracerDuringZedTime))
