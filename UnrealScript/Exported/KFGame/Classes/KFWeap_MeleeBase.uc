...
defaultproperties
{
   ...
   FiringStatesArray(3)=()
   FiringStatesArray(4)=()
   FiringStatesArray(5)="MeleeHeavyAttacking"
   ...
   InstantHitDamage(5)=50.000000
   InstantHitMomentum(4)=0.000000
   InstantHitMomentum(5)=1.000000
   InstantHitDamageTypes(0)=Class'KFGame.KFDT_Slashing'
   InstantHitDamageTypes(1)=()
   InstantHitDamageTypes(2)=None
   InstantHitDamageTypes(3)=None
   InstantHitDamageTypes(4)=None
   InstantHitDamageTypes(5)=Class'KFGame.KFDT_Slashing'
   bMeleeWeapon=True
   ...
   Name="Default__KFWeap_MeleeBase"
