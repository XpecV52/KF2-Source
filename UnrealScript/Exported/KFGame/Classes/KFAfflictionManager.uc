...
defaultproperties
{
   ...
   AfflictionClasses(7)=Class'KFGame.KFAffliction_Knockdown'
   AfflictionClasses(8)=Class'KFGame.KFAffliction_Freeze'
   AfflictionClasses(9)=Class'KFGame.KFAffliction_Microwave'
