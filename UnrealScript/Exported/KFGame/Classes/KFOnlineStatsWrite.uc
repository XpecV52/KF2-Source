...
defaultproperties
{
   ...
   DailyEvents(9)=(ObjectiveClasses=("KFWeap_AssaultRifle_AR15","KFDT_Ballistic_AR15","KFDT_Bludgeon_AR15"),CompletionAmount=5000)
   DailyEvents(10)=(ObjectiveClasses=("KFWeap_AssaultRifle_Bullpup","KFDT_Ballistic_Bullpup","KFDT_Bludgeon_Bullpup"),CompletionAmount=7000)
   DailyEvents(11)=(ObjectiveClasses=("KFWeap_AssaultRifle_AK12","KFDT_Ballistic_AK12","KFDT_Bludgeon_AK12"),CompletionAmount=10000)
   DailyEvents(12)=(ObjectiveClasses=("KFWeap_AssaultRifle_SCAR","KFDT_Ballistic_SCAR","KFDT_Bludgeon_SCAR"),CompletionAmount=10000)
   DailyEvents(13)=(ObjectiveClasses=("KFWeap_AssaultRifle_MKB42","KFDT_Ballistic_MKB42","KFDT_Bludgeon_MKB42"),CompletionAmount=10000)
   DailyEvents(14)=(ObjectiveClasses=("KFWeap_LMG_Stoner63A","KFDT_Ballistic_Stoner63A","KFDT_Bludgeon_Stoner63A"),CompletionAmount=10000)
   DailyEvents(15)=(ObjectiveClasses=("KFWeap_Shotgun_MB500","KFDT_Ballistic_MB500","KFDT_Bludgeon_MB500"),CompletionAmount=5000)
   DailyEvents(16)=(ObjectiveClasses=("KFWeap_Shotgun_DoubleBarrel","KFDT_Ballistic_DBShotgun","KFDT_Bludgeon_DBShotgun"),CompletionAmount=7000)
   DailyEvents(17)=(ObjectiveClasses=("KFWeap_HRG_Revolver_Buckshot","KFDT_Ballistic_HRGBuckshot","KFDT_Bludgeon_HRGBuckshot"),CompletionAmount=10000)
   DailyEvents(18)=(ObjectiveClasses=("KFWeap_Shotgun_HZ12","KFDT_Ballistic_HZ12","KFDT_Bludgeon_HZ12"),CompletionAmount=10000)
   DailyEvents(19)=(ObjectiveClasses=("KFWeap_Shotgun_M4","KFDT_Ballistic_M4Shotgun","KFDT_Bludgeon_M4Shotgun"),CompletionAmount=10000)
   DailyEvents(20)=(ObjectiveClasses=("KFWeap_Shotgun_AA12","KFDT_Ballistic_AA12Shotgun","KFDT_Bludgeon_AA12Shotgun"),CompletionAmount=10000)
   DailyEvents(21)=(ObjectiveClasses=("KFWeap_Shotgun_ElephantGun","KFDT_Ballistic_ElephantGun","KFDT_Bludgeon_ElephantGun"),CompletionAmount=10000)
   DailyEvents(22)=(ObjectiveClasses=("KFWeap_Pistol_Medic","KFDT_Ballistic_Pistol_Medic","KFDT_Bludgeon_Pistol_Medic"),CompletionAmount=5000)
   DailyEvents(23)=(ObjectiveClasses=("KFWeap_SMG_Medic","KFDT_Ballistic_SMG_Medic","KFDT_Bludgeon_SMG_Medic"),CompletionAmount=7000)
   DailyEvents(24)=(ObjectiveClasses=("KFWeap_Shotgun_Medic","KFDT_Ballistic_Shotgun_Medic","KFDT_Bludgeon_Shotgun_Medic"),CompletionAmount=9000)
   DailyEvents(25)=(ObjectiveClasses=("KFWeap_HRG_Healthrower","KFDT_Toxic_HRGHealthrower","KFDT_Bludgeon_HRGHealthrower"),CompletionAmount=9000)
   DailyEvents(26)=(ObjectiveClasses=("KFWeap_Rifle_Hemogoblin","KFDT_Ballistic_Hemogoblin","KFDT_Bludgeon_Hemogoblin"),CompletionAmount=9000)
   DailyEvents(27)=(ObjectiveClasses=("KFWeap_AssaultRifle_Medic","KFDT_Ballistic_Assault_Medic","KFDT_Bludgeon_Assault_Medic"),CompletionAmount=9000)
   DailyEvents(28)=(ObjectiveClasses=("KFWeap_Rifle_HRGIncision","KFDT_Ballistic_HRGIncisionHurt","KFDT_Ballistic_HRGIncisionHeal","KFDT_Bludgeon_HRGIncision"),CompletionAmount=5000)
   DailyEvents(29)=(ObjectiveClasses=("KFWeap_HRG_Vampire","KFDT_Bleeding_HRG_Vampire_BloodSuck","KFDT_Ballistic_HRG_Vampire_BloodBallImpact","KFDT_Ballistic_HRG_Vampire_BloodBallHeavyImpact","KFDT_Toxic_HRG_Vampire_BloodBall","KFDT_Piercing_HRG_Vampire_CrystalSpike","KFDT_Bludgeon_HRG_Vampire"),CompletionAmount=9000)
   DailyEvents(30)=(ObjectiveClasses=("KFWeap_AssaultRifle_MedicRifleGrenadeLauncher","KFDT_Ballistic_MedicRifleGrenadeLauncher","KFDT_Bludgeon_MedicRifleGrenadeLauncher","KFDT_Toxic_MedicGrenadeLauncher","KFDT_Ballistic_MedicRifleGrenadeLauncherImpact"),CompletionAmount=10000)
   DailyEvents(31)=(ObjectiveClasses=("KFWeap_GrenadeLauncher_HX25","KFDT_ExplosiveSubmunition_HX25","KFDT_Ballistic_HX25Impact","KFDT_Ballistic_HX25SubmunitionImpact","KFDT_Bludgeon_HX25"),CompletionAmount=5000)
   DailyEvents(32)=(ObjectiveClasses=("KFWeap_Thrown_C4","KFDT_Explosive_C4","KFDT_Bludgeon_C4"),CompletionAmount=2500)
   DailyEvents(33)=(ObjectiveClasses=("KFWeap_GrenadeLauncher_M79","KFDT_Ballistic_M79Impact","KFDT_Explosive_M79","KFDT_Bludgeon_M79"),CompletionAmount=7000)
   DailyEvents(34)=(ObjectiveClasses=("KFWeap_Shotgun_HRG_Kaboomstick","KFDT_Ballistic_HRG_Kaboomstick","KFDT_Explosive_HRG_Kaboomstick","KFDT_Bludgeon_HRG_Kaboomstick"),CompletionAmount=9000)
   DailyEvents(35)=(ObjectiveClasses=("KFWeap_RocketLauncher_RPG7","KFDT_Ballistic_RPG7Impact","KFDT_Explosive_RPG7","KFDT_Explosive_RPG7BackBlast","KFDT_Bludgeon_RPG7"),CompletionAmount=7500)
   DailyEvents(36)=(ObjectiveClasses=("KFWeap_AssaultRifle_M16M203","KFDT_Ballistic_M16M203","KFDT_Bludgeon_M16M203","KFDT_Ballistic_M203Impact","KFDT_Explosive_M16M203"),CompletionAmount=9000)
   DailyEvents(37)=(ObjectiveClasses=("KFWeap_RocketLauncher_SealSqueal","KFDT_Bludgeon_SealSqueal","KFDT_Explosive_SealSqueal","KFDT_Ballistic_SealSquealImpact"),CompletionAmount=7500)
   DailyEvents(38)=(ObjectiveClasses=("KFWeap_RocketLauncher_Seeker6","KFDT_Explosive_Seeker6","KFDT_Bludgeon_Seeker6","KFDT_Ballistic_Seeker6Impact"),CompletionAmount=7500)
   DailyEvents(39)=(ObjectiveClasses=("KFWeap_GrenadeLauncher_M32","KFDT_Bludgeon_M32","KFDT_Explosive_M32","KFDT_Ballistic_M32Impact"),CompletionAmount=10000)
   DailyEvents(40)=(ObjectiveClasses=("KFWeap_Flame_CaulkBurn","KFDT_Bludgeon_CaulkBurn","KFDT_Fire_CaulkBurn","KFDT_Fire_Ground_CaulkNBurn"),CompletionAmount=5000)
   DailyEvents(41)=(ObjectiveClasses=("KFWeap_Pistol_Flare","KFDT_Bludgeon_FlareGun","KFDT_Fire_FlareGun","KFDT_Fire_FlareGun_Dual","KFDT_Fire_FlareGunDoT"),CompletionAmount=7000)
   DailyEvents(42)=(ObjectiveClasses=("KFWeap_Shotgun_DragonsBreath","KFDT_Ballistic_DragonsBreath","KFDT_Bludgeon_DragonsBreath","KFDT_Fire_DragonsBreathDoT"),CompletionAmount=7000)
   DailyEvents(43)=(ObjectiveClasses=("KFWeap_SMG_Mac10","KFDT_Bludgeon_Mac10","KFDT_Fire_Mac10","KFDT_Fire_Mac10DoT"),CompletionAmount=9000)
   DailyEvents(44)=(ObjectiveClasses=("KFWeap_Flame_Flamethrower","KFDT_Bludgeon_Flamethrower","KFDT_Fire_FlameThrower","KFDT_Fire_Ground_FlameThrower"),CompletionAmount=9000)
   DailyEvents(45)=(ObjectiveClasses=("KFWeap_AssaultRifle_HRGIncendiaryRifle","KFDT_Bludgeon_HRGIncendiaryRifle","KFDT_Ballistic_HRGIncendiaryRifle","KFDT_Explosive_HRGIncendiaryRifle","KFDT_Ballistic_HRGIncendiaryRifleGrenadeImpact","KFDT_Fire_HRGIncendiaryRifleBulletDoT","KFDT_Fire_HRGIncendiaryRifleGrenadeDoT","KFDT_Fire_Ground_HRGIncendiaryRifle"),CompletionAmount=9000)
   DailyEvents(46)=(ObjectiveClasses=("KFWeap_Pistol_HRGScorcher","KFDT_Bludgeon_HRGScorcher","KFDT_Ballistic_HRGScorcherLightingImpact","KFDT_Fire_HRGScorcherDoT","KFDT_Ballistic_HRGScorcherBrokenImpact","KFDT_Fire_Ground_HRGScorcher"),CompletionAmount=9000)
   DailyEvents(47)=(ObjectiveClasses=("KFWeap_Beam_Microwave","KFDT_Bludgeon_MicrowaveGun","KFDT_Fire_Ground_MicrowaveGun","KFDT_Microwave","KFDT_Microwave_Beam","KFDT_Microwave_Blast"),CompletionAmount=10000)
   DailyEvents(48)=(ObjectiveClasses=("KFWeap_HuskCannon","KFDT_Bludgeon_HuskCannon","KFDT_Explosive_HuskCannon","KFDT_HuskCannonDot","KFDT_Explosive_HuskCannonImpact"),CompletionAmount=10000)
   DailyEvents(49)=(ObjectiveClasses=("KFWeap_AssaultRifle_Microwave","KFDT_Ballistic_MicrowaveRifle","KFDT_Fire_MicrowaveRifleDoT","KFDT_Bludgeon_MicrowaveRifle"),CompletionAmount=10000)
   DailyEvents(50)=(ObjectiveClasses=("KFWeap_Blunt_Crovel","KFDT_Bludgeon_Crovel","KFDT_Bludgeon_CrovelBash","KFDT_Slashing_Crovel"),CompletionAmount=5000)
   DailyEvents(51)=(ObjectiveClasses=("KFWeap_Shotgun_Nailgun","KFDT_Ballistic_NailShotgun","KFDT_Bludgeon_NailShotgun"),CompletionAmount=7000)
   DailyEvents(52)=(ObjectiveClasses=("KFWeap_Edged_Katana","KFDT_Slashing_Katana","KFDT_Piercing_KatanaStab","KFDT_Slashing_KatanaHeavy"),CompletionAmount=7000)
   DailyEvents(53)=(ObjectiveClasses=("KFWeap_Edged_FireAxe","KFDT_Bludgeon_FireAxeBash","KFDT_Slashing_FireAxe","KFDT_Slashing_FireAxeHeavy"),CompletionAmount=7000)
   DailyEvents(54)=(ObjectiveClasses=("KFWeap_Blunt_Pulverizer","KFDT_Bludgeon_Pulverizer","KFDT_Bludgeon_PulverizerBash","KFDT_Bludgeon_PulverizerHeavy","KFDT_Explosive_Pulverizer"),CompletionAmount=10000)
   DailyEvents(55)=(ObjectiveClasses=("KFWeap_Blunt_MedicBat","KFDT_Bludgeon_MedicBatBash","KFDT_Bludgeon_MedicBatHeavy","KFDT_Bludgeon_MedicBatLight","KFDT_Toxic_MedicBatGas","KFDT_Toxic_MedicBatDoT"),CompletionAmount=10000)
   DailyEvents(56)=(ObjectiveClasses=("KFWeap_Eviscerator","KFDT_Slashing_Eviscerator","KFDT_Slashing_EvisceratorProj"),CompletionAmount=10000)
   DailyEvents(57)=(ObjectiveClasses=("KFWeap_Blunt_MaceAndShield","KFDT_Bludgeon_MaceAndShield","KFDT_Bludgeon_MaceAndShield_Bash","KFDT_Bludgeon_MaceAndShield_MaceHeavy","KFDT_Bludgeon_MaceAndShield_ShieldHeavy","KFDT_Bludgeon_MaceAndShield_ShieldLight"),CompletionAmount=10000)
   DailyEvents(58)=(ObjectiveClasses=("KFWeap_Blunt_PowerGloves","KFDT_Bludgeon_PowerGloves","KFDT_Bludgeon_PowerGlovesBash","KFDT_Bludgeon_PowerGlovesHeavy"),CompletionAmount=10000)
   DailyEvents(59)=(ObjectiveClasses=("KFWeap_AssaultRifle_HRGTeslauncher","KFDT_Ballistic_HRGTeslauncher","KFDT_Fire_HRGTeslauncherDoT","KFDT_Ballistic_HRGTeslauncherGrenadeImpact","KFDT_Bludgeon_HRGTeslauncher","KFDT_EMP_TeslauncherEMPGrenade"),CompletionAmount=10000)
   DailyEvents(60)=(ObjectiveClasses=("KFWeap_Edged_AbominationAxe","KFDT_Slashing_AbominationAxe","KFDT_Piercing_AbominationAxeStab","KFDT_Slashing_AbominationAxeHeavy"),CompletionAmount=10000)
   DailyEvents(61)=(ObjectiveClasses=("KFWeap_Revolver_Rem1858","KFDT_Bludgeon_Rem1858","KFDT_Ballistic_Rem1858","KFDT_Ballistic_Rem1858_Dual"),CompletionAmount=5000)
   DailyEvents(62)=(ObjectiveClasses=("KFWeap_Pistol_Colt1911","KFDT_Bludgeon_Colt1911","KFDT_Ballistic_Colt1911"),CompletionAmount=7000)
   DailyEvents(63)=(ObjectiveClasses=("KFWeap_Pistol_HRGWinterbite","KFDT_Bludgeon_HRGWinterbite","KFDT_Freeze_HRGWinterbiteImpact","KFDT_Explosive_HRGWinterbite"),CompletionAmount=7000)
   DailyEvents(64)=(ObjectiveClasses=("KFWeap_Pistol_Deagle","KFDT_Bludgeon_Deagle","KFDT_Ballistic_Deagle"),CompletionAmount=10000)
   DailyEvents(65)=(ObjectiveClasses=("KFWeap_Revolver_SW500","KFDT_Bludgeon_SW500","KFDT_Ballistic_SW500","KFDT_Ballistic_SW500_Dual"),CompletionAmount=10000)
   DailyEvents(66)=(ObjectiveClasses=("KFWeap_Pistol_AF2011","KFDT_Bludgeon_AF2011","KFDT_Ballistic_AF2011"),CompletionAmount=10000)
   DailyEvents(67)=(ObjectiveClasses=("KFWeap_Rifle_Winchester1894","KFDT_Bludgeon_Winchester","KFDT_Ballistic_Winchester"),CompletionAmount=5000)
   DailyEvents(68)=(ObjectiveClasses=("KFWeap_Bow_Crossbow","KFDT_Bludgeon_Crossbow","KFDT_Piercing_Crossbow"),CompletionAmount=7000)
   DailyEvents(69)=(ObjectiveClasses=("KFWeap_Rifle_M14EBR","KFDT_Bludgeon_M14EBR","KFDT_Ballistic_M14EBR"),CompletionAmount=9000)
   DailyEvents(70)=(ObjectiveClasses=("KFWeap_HRG_SonicGun","KFDT_Bludgeon_HRG_SonicGun","KFDT_Ballistic_HRG_SonicGun_SonicBlastUncharged","KFDT_Ballistic_HRG_SonicGun_SonicBlastHalfCharged","KFDT_Ballistic_HRG_SonicGun_SonicBlastFullyCharged"),CompletionAmount=7000)
   DailyEvents(71)=(ObjectiveClasses=("KFWeap_Rifle_RailGun","KFDT_Bludgeon_RailGun","KFDT_Ballistic_RailGun"),CompletionAmount=5000)
   DailyEvents(72)=(ObjectiveClasses=("KFWeap_Rifle_CenterfireMB464","KFDT_Bludgeon_CenterfireMB464","KFDT_Ballistic_CenterfireMB464"),CompletionAmount=7000)
   DailyEvents(73)=(ObjectiveClasses=("KFWeap_Rifle_M99","KFDT_Bludgeon_M99","KFDT_Ballistic_M99"),CompletionAmount=5000)
   DailyEvents(74)=(ObjectiveClasses=("KFWeap_AssaultRifle_FNFal","KFDT_Ballistic_FNFal","KFDT_Bludgeon_FNFal"),CompletionAmount=10000)
   DailyEvents(75)=(ObjectiveClasses=("KFWeap_Ice_FreezeThrower","KFDT_Bludgeon_Freezethrower","KFDT_Freeze_FreezeThrower","KFDT_Freeze_FreezeThrower_IceShards","KFDT_Freeze_Ground_FreezeThrower"),CompletionAmount=7000)
   DailyEvents(76)=(ObjectiveClasses=("KFWeap_HRG_EMP_ArcGenerator","KFDT_Bludgeon_ArcGenerator","KFDT_EMP_ArcGenerator_Beam","KFDT_EMP_ArcGeneratorSphereImpact","KFDT_EMP_ArcGenerator_DefaultFiremodeZapDamage","KFDT_EMP_ArcGenerator_AltFiremodeZapDamage"),CompletionAmount=9000)
   DailyEvents(77)=(ObjectiveClasses=("KFWeap_AssaultRifle_LazerCutter","KFDT_Ballistic_LazerCutter","KFDT_LazerCutter_Beam","KFDT_Bludgeon_LazerCutter"),CompletionAmount=10000)
   DailyEvents(78)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Alpha"),CompletionAmount=20)
   DailyEvents(79)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_AlphaKing"),CompletionAmount=5)
   DailyEvents(80)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Cyst"),CompletionAmount=30)
   DailyEvents(81)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Slasher"),CompletionAmount=25)
   DailyEvents(82)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedCrawler"),CompletionAmount=30)
   DailyEvents(83)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedCrawlerKing"),CompletionAmount=5)
   DailyEvents(84)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedStalker"),CompletionAmount=10)
   DailyEvents(85)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedBloat"),CompletionAmount=5)
   DailyEvents(86)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedSiren"),CompletionAmount=5)
   DailyEvents(87)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedHusk"),CompletionAmount=3)
   DailyEvents(88)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedGorefast"),CompletionAmount=20)
   DailyEvents(89)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedGorefastDualBlade"),CompletionAmount=8)
   DailyEvents(90)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedScrake"),CompletionAmount=1)
   DailyEvents(91)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedFleshpound"),CompletionAmount=1)
   DailyEvents(92)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedFleshpoundMini"),CompletionAmount=2)
   DailyEvents(93)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_EMP"),CompletionAmount=5)
   DailyEvents(94)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_Laser"),CompletionAmount=5)
   DailyEvents(95)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_Rocket"),CompletionAmount=5)
   DailyEvents(96)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillBoss,CompletionAmount=1)
   DailyEvents(97)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Berserker"),CompletionAmount=1500)
   DailyEvents(98)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Commando"),CompletionAmount=1500)
   DailyEvents(99)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Demolitionist"),CompletionAmount=1500)
   DailyEvents(100)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_FieldMedic"),CompletionAmount=1500)
   DailyEvents(101)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Firebug"),CompletionAmount=1500)
   DailyEvents(102)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Gunslinger"),CompletionAmount=1500)
   DailyEvents(103)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Sharpshooter"),CompletionAmount=1500)
   DailyEvents(104)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Support"),CompletionAmount=1500)
   DailyEvents(105)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Survivalist"),CompletionAmount=1500)
   DailyEvents(106)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_SWAT"),CompletionAmount=1500)
   DailyEvents(107)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=1)
   DailyEvents(108)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=2)
   DailyEvents(109)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=3)
   DailyEvents(110)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=1)
   DailyEvents(111)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=2)
   DailyEvents(112)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=3)
   DailyEvents(113)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=1)
   DailyEvents(114)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=2)
   DailyEvents(115)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=3)
   DailyEvents(116)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=1)
   DailyEvents(117)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=2)
   DailyEvents(118)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=3)
   DailyEvents(119)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=1)
   DailyEvents(120)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=2)
   DailyEvents(121)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=3)
   DailyEvents(122)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=1)
   DailyEvents(123)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=2)
   DailyEvents(124)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=3)
   DailyEvents(125)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=1)
   DailyEvents(126)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=2)
   DailyEvents(127)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=3)
   DailyEvents(128)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=1)
   DailyEvents(129)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=2)
   DailyEvents(130)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=3)
   DailyEvents(131)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=1)
   DailyEvents(132)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=2)
   DailyEvents(133)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=3)
   DailyEvents(134)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=1)
   DailyEvents(135)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=2)
   DailyEvents(136)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=3)
   DailyEvents(137)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=1)
   DailyEvents(138)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=2)
   DailyEvents(139)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=3)
   DailyEvents(140)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=1)
   DailyEvents(141)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=2)
   DailyEvents(142)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=3)
   DailyEvents(143)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=1)
   DailyEvents(144)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=2)
   DailyEvents(145)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=3)
   DailyEvents(146)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-THEDESCENT"),CompletionAmount=1)
   DailyEvents(147)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-THEDESCENT"),CompletionAmount=2)
   DailyEvents(148)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-THEDESCENT"),CompletionAmount=3)
   DailyEvents(149)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=1)
   DailyEvents(150)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=2)
   DailyEvents(151)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=3)
   DailyEvents(152)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=1)
   DailyEvents(153)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=2)
   DailyEvents(154)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=3)
   DailyEvents(155)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NIGHTMARE"),CompletionAmount=1)
   DailyEvents(156)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NIGHTMARE"),CompletionAmount=2)
   DailyEvents(157)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NIGHTMARE"),CompletionAmount=3)
   DailyEvents(158)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KRAMPUSLAIR"),CompletionAmount=1)
   DailyEvents(159)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KRAMPUSLAIR"),CompletionAmount=2)
   DailyEvents(160)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KRAMPUSLAIR"),CompletionAmount=3)
   DailyEvents(161)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-POWERCORE_HOLDOUT"),CompletionAmount=1)
   DailyEvents(162)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-POWERCORE_HOLDOUT"),CompletionAmount=2)
   DailyEvents(163)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-POWERCORE_HOLDOUT"),CompletionAmount=3)
   DailyEvents(164)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=1)
   DailyEvents(165)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=2)
   DailyEvents(166)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=3)
   DailyEvents(167)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=1)
   DailyEvents(168)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=2)
   DailyEvents(169)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=3)
   DailyEvents(170)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=1)
   DailyEvents(171)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=2)
   DailyEvents(172)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=3)
   DailyEvents(173)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=1)
   DailyEvents(174)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=2)
   DailyEvents(175)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=3)
   DailyEvents(176)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=1)
   DailyEvents(177)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=2)
   DailyEvents(178)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=3)
   DailyEvents(179)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=1)
   DailyEvents(180)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=2)
   DailyEvents(181)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=3)
   DailyEvents(182)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-STEAMFORTRESS"),CompletionAmount=1)
   DailyEvents(183)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-STEAMFORTRESS"),CompletionAmount=2)
   DailyEvents(184)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-STEAMFORTRESS"),CompletionAmount=3)
   DailyEvents(185)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=1)
   DailyEvents(186)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=2)
   DailyEvents(187)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=3)
   DailyEvents(188)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=1)
   DailyEvents(189)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=2)
   DailyEvents(190)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=3)
   DailyEvents(191)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOLAPSE"),CompletionAmount=1)
   DailyEvents(192)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOLAPSE"),CompletionAmount=2)
   DailyEvents(193)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOLAPSE"),CompletionAmount=3)
   DailyEvents(194)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=1)
   DailyEvents(195)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=2)
   DailyEvents(196)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=3)
   DailyEvents(197)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=1)
   DailyEvents(198)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=2)
   DailyEvents(199)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=3)
   DailyEvents(200)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=1)
   DailyEvents(201)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=2)
   DailyEvents(202)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=3)
   DailyEvents(203)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=1)
   DailyEvents(204)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=2)
   DailyEvents(205)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=3)
   DailyEvents(206)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("chr_briar_archetype"),CompletionAmount=1)
   DailyEvents(207)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_MrFoster_archetype"),CompletionAmount=1)
   DailyEvents(208)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Coleman_archetype"),CompletionAmount=1)
   DailyEvents(209)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Alberts_archetype"),CompletionAmount=1)
   DailyEvents(210)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Masterson_archetype"),CompletionAmount=1)
   DailyEvents(211)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Tanaka_Archetype"),CompletionAmount=1)
   DailyEvents(212)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Ana_Archetype"),CompletionAmount=1)
   DailyEvents(213)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("chr_rockabilly_archetype"),CompletionAmount=1)
   DailyEvents(214)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_DAR_archetype"),CompletionAmount=1)
