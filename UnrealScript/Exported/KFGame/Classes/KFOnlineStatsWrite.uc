...
defaultproperties
{
   ...
   DailyEvents(47)=(ObjectiveClasses=("KFWeap_Shotgun_DragonsBreath","KFDT_Ballistic_DragonsBreath","KFDT_Bludgeon_DragonsBreath","KFDT_Fire_DragonsBreathDoT"),CompletionAmount=7000)
   ...
   DailyEvents(54)=(ObjectiveClasses=("KFWeap_AssaultRifle_Microwave","KFDT_Ballistic_MicrowaveRifle","KFDT_Fire_MicrowaveRifleDoT","KFDT_Bludgeon_MicrowaveRifle"),CompletionAmount=10000)
   DailyEvents(55)=(ObjectiveClasses=("KFWeap_Blunt_Crovel","KFDT_Bludgeon_Crovel","KFDT_Bludgeon_CrovelBash","KFDT_Slashing_Crovel"),CompletionAmount=5000)
   DailyEvents(56)=(ObjectiveClasses=("KFWeap_Shotgun_Nailgun","KFDT_Ballistic_NailShotgun","KFDT_Bludgeon_NailShotgun"),CompletionAmount=7000)
   DailyEvents(57)=(ObjectiveClasses=("KFWeap_Edged_Katana","KFDT_Slashing_Katana","KFDT_Piercing_KatanaStab","KFDT_Slashing_KatanaHeavy"),CompletionAmount=7000)
   DailyEvents(58)=(ObjectiveClasses=("KFWeap_Edged_FireAxe","KFDT_Bludgeon_FireAxeBash","KFDT_Slashing_FireAxe","KFDT_Slashing_FireAxeHeavy"),CompletionAmount=7000)
   DailyEvents(59)=(ObjectiveClasses=("KFWeap_Blunt_Pulverizer","KFDT_Bludgeon_Pulverizer","KFDT_Bludgeon_PulverizerBash","KFDT_Bludgeon_PulverizerHeavy","KFDT_Explosive_Pulverizer"),CompletionAmount=10000)
   DailyEvents(60)=(ObjectiveClasses=("KFWeap_Blunt_MedicBat","KFDT_Bludgeon_MedicBatBash","KFDT_Bludgeon_MedicBatHeavy","KFDT_Bludgeon_MedicBatLight","KFDT_Toxic_MedicBatGas","KFDT_Toxic_MedicBatDoT"),CompletionAmount=10000)
   DailyEvents(61)=(ObjectiveClasses=("KFWeap_Eviscerator","KFDT_Slashing_Eviscerator","KFDT_Slashing_EvisceratorProj"),CompletionAmount=10000)
   DailyEvents(62)=(ObjectiveClasses=("KFWeap_Blunt_MaceAndShield","KFDT_Bludgeon_MaceAndShield","KFDT_Bludgeon_MaceAndShield_Bash","KFDT_Bludgeon_MaceAndShield_MaceHeavy","KFDT_Bludgeon_MaceAndShield_ShieldHeavy","KFDT_Bludgeon_MaceAndShield_ShieldLight"),CompletionAmount=10000)
   DailyEvents(63)=(ObjectiveClasses=("KFWeap_Blunt_PowerGloves","KFDT_Bludgeon_PowerGloves","KFDT_Bludgeon_PowerGlovesBash","KFDT_Bludgeon_PowerGlovesHeavy"),CompletionAmount=10000)
   DailyEvents(64)=(ObjectiveClasses=("KFWeap_AssaultRifle_HRGTeslauncher","KFDT_Ballistic_HRGTeslauncher","KFDT_Fire_HRGTeslauncherDoT","KFDT_Ballistic_HRGTeslauncherGrenadeImpact","KFDT_Bludgeon_HRGTeslauncher","KFDT_EMP_TeslauncherEMPGrenade"),CompletionAmount=10000)
   DailyEvents(65)=(ObjectiveClasses=("KFWeap_Edged_AbominationAxe","KFDT_Slashing_AbominationAxe","KFDT_Piercing_AbominationAxeStab","KFDT_Slashing_AbominationAxeHeavy"),CompletionAmount=10000)
   DailyEvents(66)=(ObjectiveClasses=("KFWeap_Revolver_Rem1858","KFDT_Bludgeon_Rem1858","KFDT_Ballistic_Rem1858","KFDT_Ballistic_Rem1858_Dual"),CompletionAmount=5000)
   DailyEvents(67)=(ObjectiveClasses=("KFWeap_Pistol_Colt1911","KFDT_Bludgeon_Colt1911","KFDT_Ballistic_Colt1911"),CompletionAmount=7000)
   DailyEvents(68)=(ObjectiveClasses=("KFWeap_Pistol_HRGWinterbite","KFDT_Bludgeon_HRGWinterbite","KFDT_Freeze_HRGWinterbiteImpact","KFDT_Explosive_HRGWinterbite"),CompletionAmount=7000)
   DailyEvents(69)=(ObjectiveClasses=("KFWeap_Pistol_Deagle","KFDT_Bludgeon_Deagle","KFDT_Ballistic_Deagle"),CompletionAmount=10000)
   DailyEvents(70)=(ObjectiveClasses=("KFWeap_Revolver_SW500","KFDT_Bludgeon_SW500","KFDT_Ballistic_SW500","KFDT_Ballistic_SW500_Dual"),CompletionAmount=10000)
   DailyEvents(71)=(ObjectiveClasses=("KFWeap_Pistol_AF2011","KFDT_Bludgeon_AF2011","KFDT_Ballistic_AF2011"),CompletionAmount=10000)
   DailyEvents(72)=(ObjectiveClasses=("KFWeap_HRG_Energy","KFDT_Ballistic_HRG_Energy_Primary","KFDT_Ballistic_HRG_Energy_Secondary","KFDT_Bludgeon_HRG_Energy"),CompletionAmount=10000)
   DailyEvents(73)=(ObjectiveClasses=("KFWeap_Rifle_Winchester1894","KFDT_Bludgeon_Winchester","KFDT_Ballistic_Winchester"),CompletionAmount=5000)
   DailyEvents(74)=(ObjectiveClasses=("KFWeap_Bow_Crossbow","KFDT_Bludgeon_Crossbow","KFDT_Piercing_Crossbow"),CompletionAmount=7000)
   DailyEvents(75)=(ObjectiveClasses=("KFWeap_Rifle_M14EBR","KFDT_Bludgeon_M14EBR","KFDT_Ballistic_M14EBR"),CompletionAmount=9000)
   DailyEvents(76)=(ObjectiveClasses=("KFWeap_HRG_SonicGun","KFDT_Bludgeon_HRG_SonicGun","KFDT_Ballistic_HRG_SonicGun_SonicBlastUncharged","KFDT_Ballistic_HRG_SonicGun_SonicBlastHalfCharged","KFDT_Ballistic_HRG_SonicGun_SonicBlastFullyCharged"),CompletionAmount=7000)
   DailyEvents(77)=(ObjectiveClasses=("KFWeap_HRG_CranialPopper","KFDT_Bludgeon_HRG_CranialPopper","KFDT_Piercing_HRG_CranialPopper","KFDT_Blast_HRG_CranialPopper"),CompletionAmount=7000)
   DailyEvents(78)=(ObjectiveClasses=("KFWeap_Rifle_RailGun","KFDT_Bludgeon_RailGun","KFDT_Ballistic_RailGun"),CompletionAmount=5000)
   DailyEvents(79)=(ObjectiveClasses=("KFWeap_Rifle_CenterfireMB464","KFDT_Bludgeon_CenterfireMB464","KFDT_Ballistic_CenterfireMB464"),CompletionAmount=7000)
   DailyEvents(80)=(ObjectiveClasses=("KFWeap_Rifle_M99","KFDT_Bludgeon_M99","KFDT_Ballistic_M99"),CompletionAmount=5000)
   DailyEvents(81)=(ObjectiveClasses=("KFWeap_AssaultRifle_FNFal","KFDT_Ballistic_FNFal","KFDT_Bludgeon_FNFal"),CompletionAmount=10000)
   DailyEvents(82)=(ObjectiveClasses=("KFWeap_Ice_FreezeThrower","KFDT_Bludgeon_Freezethrower","KFDT_Freeze_FreezeThrower","KFDT_Freeze_FreezeThrower_IceShards","KFDT_Freeze_Ground_FreezeThrower"),CompletionAmount=7000)
   DailyEvents(83)=(ObjectiveClasses=("KFWeap_HRG_EMP_ArcGenerator","KFDT_Bludgeon_ArcGenerator","KFDT_EMP_ArcGenerator_Beam","KFDT_EMP_ArcGeneratorSphereImpact","KFDT_EMP_ArcGenerator_DefaultFiremodeZapDamage","KFDT_EMP_ArcGenerator_AltFiremodeZapDamage"),CompletionAmount=9000)
   DailyEvents(84)=(ObjectiveClasses=("KFWeap_AssaultRifle_LazerCutter","KFDT_Ballistic_LazerCutter","KFDT_LazerCutter_Beam","KFDT_Bludgeon_LazerCutter"),CompletionAmount=10000)
   DailyEvents(85)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Alpha"),CompletionAmount=20)
   DailyEvents(86)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_AlphaKing"),CompletionAmount=5)
   DailyEvents(87)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Cyst"),CompletionAmount=30)
   DailyEvents(88)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedClot_Slasher"),CompletionAmount=25)
   DailyEvents(89)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedCrawler"),CompletionAmount=30)
   DailyEvents(90)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedCrawlerKing"),CompletionAmount=5)
   DailyEvents(91)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedStalker"),CompletionAmount=10)
   DailyEvents(92)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedBloat"),CompletionAmount=5)
   DailyEvents(93)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedSiren"),CompletionAmount=5)
   DailyEvents(94)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedHusk"),CompletionAmount=3)
   DailyEvents(95)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedGorefast"),CompletionAmount=20)
   DailyEvents(96)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedGorefastDualBlade"),CompletionAmount=8)
   DailyEvents(97)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedScrake"),CompletionAmount=1)
   DailyEvents(98)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedFleshpound"),CompletionAmount=1)
   DailyEvents(99)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedFleshpoundMini"),CompletionAmount=2)
   DailyEvents(100)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_EMP"),CompletionAmount=5)
   DailyEvents(101)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_Laser"),CompletionAmount=5)
   DailyEvents(102)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillZeds,ObjectiveClasses=("KFPawn_ZedDAR_Rocket"),CompletionAmount=5)
   DailyEvents(103)=(ObjectiveType=DOT_PerkXP,SecondaryType=DOST_KillBoss,CompletionAmount=1)
   DailyEvents(104)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Berserker"),CompletionAmount=1500)
   DailyEvents(105)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Commando"),CompletionAmount=1500)
   DailyEvents(106)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Demolitionist"),CompletionAmount=1500)
   DailyEvents(107)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_FieldMedic"),CompletionAmount=1500)
   DailyEvents(108)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Firebug"),CompletionAmount=1500)
   DailyEvents(109)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Gunslinger"),CompletionAmount=1500)
   DailyEvents(110)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Sharpshooter"),CompletionAmount=1500)
   DailyEvents(111)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Support"),CompletionAmount=1500)
   DailyEvents(112)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_Survivalist"),CompletionAmount=1500)
   DailyEvents(113)=(ObjectiveType=DOT_PerkXP,ObjectiveClasses=("KFPerk_SWAT"),CompletionAmount=1500)
   DailyEvents(114)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=1)
   DailyEvents(115)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=2)
   DailyEvents(116)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BURNINGPARIS"),CompletionAmount=3)
   DailyEvents(117)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=1)
   DailyEvents(118)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=2)
   DailyEvents(119)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-OUTPOST"),CompletionAmount=3)
   DailyEvents(120)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=1)
   DailyEvents(121)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=2)
   DailyEvents(122)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BIOTICSLAB"),CompletionAmount=3)
   DailyEvents(123)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=1)
   DailyEvents(124)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=2)
   DailyEvents(125)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-VOLTERMANOR"),CompletionAmount=3)
   DailyEvents(126)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=1)
   DailyEvents(127)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=2)
   DailyEvents(128)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-EVACUATIONPOINT"),CompletionAmount=3)
   DailyEvents(129)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=1)
   DailyEvents(130)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=2)
   DailyEvents(131)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CATACOMBS"),CompletionAmount=3)
   DailyEvents(132)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=1)
   DailyEvents(133)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=2)
   DailyEvents(134)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-BLACKFOREST"),CompletionAmount=3)
   DailyEvents(135)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=1)
   DailyEvents(136)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=2)
   DailyEvents(137)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-FARMHOUSE"),CompletionAmount=3)
   DailyEvents(138)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=1)
   DailyEvents(139)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=2)
   DailyEvents(140)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PRISON"),CompletionAmount=3)
   DailyEvents(141)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=1)
   DailyEvents(142)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=2)
   DailyEvents(143)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CONTAINMENTSTATION"),CompletionAmount=3)
   DailyEvents(144)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=1)
   DailyEvents(145)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=2)
   DailyEvents(146)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HOSTILEGROUNDS"),CompletionAmount=3)
   DailyEvents(147)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=1)
   DailyEvents(148)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=2)
   DailyEvents(149)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-INFERNALREALM"),CompletionAmount=3)
   DailyEvents(150)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=1)
   DailyEvents(151)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=2)
   DailyEvents(152)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ZEDLANDING"),CompletionAmount=3)
   DailyEvents(153)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TheDescent"),CompletionAmount=1)
   DailyEvents(154)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TheDescent"),CompletionAmount=2)
   DailyEvents(155)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TheDescent"),CompletionAmount=3)
   DailyEvents(156)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=1)
   DailyEvents(157)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=2)
   DailyEvents(158)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NUKED"),CompletionAmount=3)
   DailyEvents(159)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=1)
   DailyEvents(160)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=2)
   DailyEvents(161)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-TRAGICKINGDOM"),CompletionAmount=3)
   DailyEvents(162)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Nightmare"),CompletionAmount=1)
   DailyEvents(163)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Nightmare"),CompletionAmount=2)
   DailyEvents(164)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Nightmare"),CompletionAmount=3)
   DailyEvents(165)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KrampusLair"),CompletionAmount=1)
   DailyEvents(166)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KrampusLair"),CompletionAmount=2)
   DailyEvents(167)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-KrampusLair"),CompletionAmount=3)
   DailyEvents(168)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PowerCore_Holdout"),CompletionAmount=1)
   DailyEvents(169)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PowerCore_Holdout"),CompletionAmount=2)
   DailyEvents(170)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-PowerCore_Holdout"),CompletionAmount=3)
   DailyEvents(171)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=1)
   DailyEvents(172)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=2)
   DailyEvents(173)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-AIRSHIP"),CompletionAmount=3)
   DailyEvents(174)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=1)
   DailyEvents(175)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=2)
   DailyEvents(176)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-LOCKDOWN"),CompletionAmount=3)
   DailyEvents(177)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=1)
   DailyEvents(178)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=2)
   DailyEvents(179)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MONSTERBALL"),CompletionAmount=3)
   DailyEvents(180)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=1)
   DailyEvents(181)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=2)
   DailyEvents(182)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SHOPPINGSPREE"),CompletionAmount=3)
   DailyEvents(183)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=1)
   DailyEvents(184)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=2)
   DailyEvents(185)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANTASWORKSHOP"),CompletionAmount=3)
   DailyEvents(186)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=1)
   DailyEvents(187)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=2)
   DailyEvents(188)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SPILLWAY"),CompletionAmount=3)
   DailyEvents(189)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SteamFortress"),CompletionAmount=1)
   DailyEvents(190)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SteamFortress"),CompletionAmount=2)
   DailyEvents(191)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SteamFortress"),CompletionAmount=3)
   DailyEvents(192)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=1)
   DailyEvents(193)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=2)
   DailyEvents(194)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ASHWOODASYLUM"),CompletionAmount=3)
   DailyEvents(195)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=1)
   DailyEvents(196)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=2)
   DailyEvents(197)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-SANITARIUM"),CompletionAmount=3)
   DailyEvents(198)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Biolapse"),CompletionAmount=1)
   DailyEvents(199)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Biolapse"),CompletionAmount=2)
   DailyEvents(200)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-Biolapse"),CompletionAmount=3)
   DailyEvents(201)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=1)
   DailyEvents(202)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=2)
   DailyEvents(203)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DESOLATION"),CompletionAmount=3)
   DailyEvents(204)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=1)
   DailyEvents(205)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=2)
   DailyEvents(206)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-HELLMARKSTATION"),CompletionAmount=3)
   DailyEvents(207)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=1)
   DailyEvents(208)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=2)
   DailyEvents(209)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-ELYSIUM"),CompletionAmount=3)
   DailyEvents(210)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=1)
   DailyEvents(211)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=2)
   DailyEvents(212)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-DYSTOPIA2029"),CompletionAmount=3)
   DailyEvents(213)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MOONBASE"),CompletionAmount=1)
   DailyEvents(214)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MOONBASE"),CompletionAmount=2)
   DailyEvents(215)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-MOONBASE"),CompletionAmount=3)
   DailyEvents(216)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NETHERHOLD"),CompletionAmount=1)
   DailyEvents(217)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NETHERHOLD"),CompletionAmount=2)
   DailyEvents(218)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-NETHERHOLD"),CompletionAmount=3)
   DailyEvents(219)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CARILLONHAMLET"),CompletionAmount=1)
   DailyEvents(220)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CARILLONHAMLET"),CompletionAmount=2)
   DailyEvents(221)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-CARILLONHAMLET"),CompletionAmount=3)
   DailyEvents(222)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-RIG"),CompletionAmount=1)
   DailyEvents(223)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-RIG"),CompletionAmount=2)
   DailyEvents(224)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_MapCompletion,ObjectiveClasses=("KF-RIG"),CompletionAmount=3)
   DailyEvents(225)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("chr_briar_archetype"),CompletionAmount=1)
   DailyEvents(226)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_MrFoster_archetype"),CompletionAmount=1)
   DailyEvents(227)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Coleman_archetype"),CompletionAmount=1)
   DailyEvents(228)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Alberts_archetype"),CompletionAmount=1)
   DailyEvents(229)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Masterson_archetype"),CompletionAmount=1)
   DailyEvents(230)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Tanaka_Archetype"),CompletionAmount=1)
   DailyEvents(231)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_Ana_Archetype"),CompletionAmount=1)
   DailyEvents(232)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("chr_rockabilly_archetype"),CompletionAmount=1)
   DailyEvents(233)=(ObjectiveType=DOT_Maps,SecondaryType=DOST_CharacterCompletion,ObjectiveClasses=("CHR_DAR_archetype"),CompletionAmount=1)
