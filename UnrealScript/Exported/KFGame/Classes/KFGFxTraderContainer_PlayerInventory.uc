...
function float FillAmmo( out SItemInformation ItemInfo, optional bool bIsGrenade )
{
    ...
    {
		MyTraderMenu.BoughtAmmo(MissingAmmo, FillAmmoCost, IT_Weapon, ItemInfo.DefaultItem.ClassName, ItemInfo.DefaultItem.AssociatedPerkClass, ItemInfo.bIsSecondaryAmmo);
    }
...
function int BuyItemMagazine( out SItemInformation ItemInfo )
{
    ...
    if( MagSpaceAvailable > 0 )
    {
		...
		MyTraderMenu.BoughtAmmo(ItemInfo.DefaultItem.MagazineCapacity, MagAmmoCost, IT_Weapon, ItemInfo.DefaultItem.ClassName, ItemInfo.DefaultItem.AssociatedPerkClass, ItemInfo.bIsSecondaryAmmo);
    }
...
function int BuySecondaryAmmoMag( out SItemInformation ItemInfo  )
{
    ...
    if( MagSpaceAvailable > 0 )
    {
		...
		MyTraderMenu.BoughtAmmo(AddedAmmo, MagAmmoCost, IT_Weapon, ItemInfo.DefaultItem.ClassName, ItemInfo.DefaultItem.AssociatedPerkClass, ItemInfo.bIsSecondaryAmmo);
    }
...
defaultproperties
{
   ...
   Name="Default__KFGFxTraderContainer_PlayerInventory"
