...
defaultproperties
{
   ...
   PainInterval=1.000000
   FogBlendTime=3.000000
   Begin Object Class=FogVolumeConstantDensityComponent Name=FogVolumeComponent0 Archetype=FogVolumeConstantDensityComponent'Engine.Default__FogVolumeConstantDensityInfo:FogVolumeComponent0'
      Name="FogVolumeComponent0"
      ObjectArchetype=FogVolumeConstantDensityComponent'Engine.Default__FogVolumeConstantDensityInfo:FogVolumeComponent0'
   End Object
   DensityComponent=FogVolumeComponent0
   Begin Object Class=StaticMeshComponent Name=AutomaticMeshComponent0 Archetype=StaticMeshComponent'Engine.Default__FogVolumeConstantDensityInfo:AutomaticMeshComponent0'
      ...
      ObjectArchetype=StaticMeshComponent'Engine.Default__FogVolumeConstantDensityInfo:AutomaticMeshComponent0'
   End Object
   AutomaticMeshComponent=AutomaticMeshComponent0
   Begin Object Class=SpriteComponent Name=Sprite Archetype=SpriteComponent'Engine.Default__FogVolumeConstantDensityInfo:Sprite'
      ...
      Name="Sprite"
      ObjectArchetype=SpriteComponent'Engine.Default__FogVolumeConstantDensityInfo:Sprite'
   End Object
   Components(0)=Sprite
   Components(1)=AutomaticMeshComponent0
   Components(2)=FogVolumeComponent0
   bCollideActors=True
   Name="Default__KFDynamicFogAndDamageVolumeInfo"
   ObjectArchetype=FogVolumeConstantDensityInfo'Engine.Default__FogVolumeConstantDensityInfo'
}
