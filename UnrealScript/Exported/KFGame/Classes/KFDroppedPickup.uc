...
auto state Pickup
{
    ...
    function bool ValidTouch(Pawn Other)
    {
		...
		if ( Other == Instigator )
		{
			...
			if( (bUseLowHealthDelay && (Instigator.Health / Instigator.HealthMax) <= 0.2f && (WorldInfo.TimeSeconds - CreationTime) < 1.f)
...
defaultproperties
{
   ...
   EmptyPickupColor=(R=0.750000,G=0.000000,B=0.000000,A=1.000000)
