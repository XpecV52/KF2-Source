...
function OnFindOnlinePlayfabGamesComplete( bool bSuccess )
{
	...
	{
		LogInternal("Listing result with lobby ID"@SearchDataStore.GameSearchCfgList[0].Search.Results[i].GameSettings.LobbyId@"and num open connections"@SearchDataStore.GameSearchCfgList[0].Search.Results[i].GameSettings.NumOpenPublicConnections@"and max players"@SearchDataStore.GameSearchCfgList[0].Search.Results[i].GameSettings.NumPublicConnections);
	}
}
