...
function LogSurvivalInfo(int GameDifficulty, int GameLength)
{
	...
	PLE.AddInt('EventID', class'KFGameplayEventsWriter'.const.GAMEEVENT_SURVIVAL_INFO);
...
function LogPlayerWeaponReload(KFWeapon Weap, Controller Player)
{
	...
	PLE = GetGenericParamListEntry();
	PLE.AddInt('EventID', class'KFGameplayEventsWriter'.const.GAMEEVENT_PLAYER_RELOAD);
...
function LogPlayerHealEvent(int Amount, Controller Healer, class<DamageType> DamageType, Controller Recipient, int DoshEarned)
{
	...
	PLE = GetGenericParamListEntry();
	PLE.AddInt('EventID', class'KFGameplayEventsWriter'.const.GAMEEVENT_PLAYER_HEAL);
...
function LogDoorWeldEvent(int Amount, int MaxWeldIntegrity, int PostWeldIntegrity, Controller Welder, Controller Damager, Actor Door)
{
	...
	PLE = GetGenericParamListEntry();
	PLE.AddInt('EventID', class'KFGameplayEventsWriter'.const.GAMEEVENT_DOOR_WELD);
	PLE.AddInt('Amount', Amount);
...
function LogPlayerDoshDelta( Controller Player, int DoshDelta )
{
	...
	PLE = GetGenericParamListEntry();
	PLE.AddInt( 'EventID', class'KFGameplayEventsWriter'.const.GAMEEVENT_PLAYER_DOSH_DELTA );
	PLE.AddInt( 'PlayerIndex', ResolvePlayerIndex(Player) );
...
defaultproperties
{
   ...
   SupportedEvents(39)=(EventID=1010,EventName="Zed died",StatGroup=(Group=GSG_Game,Level=3),EventDataType=14)
   SupportedEvents(40)=(EventID=2002,EventName="SpawnVolume Rating",StatGroup=(Group=GSG_Game,Level=3),EventDataType=14)
   SupportedEvents(41)=(EventID=2003,EventName="Player positions at AISpawn",StatGroup=(Group=GSG_Game,Level=3),EventDataType=14)
   SupportedEvents(42)=(EventID=2004,EventName="The best rated spawn volume",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(43)=(EventID=2100,EventName="AI move failures",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(44)=(EventID=2101,EventName="AI Bumped",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(45)=(EventID=2102,EventName="AI using JumpSpot",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(46)=(EventID=2103,EventName="AI HitWall events",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(47)=(EventID=2104,EventName="AI high-jump locations",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(48)=(EventID=2105,EventName="AI waiting for door",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(49)=(EventID=2106,EventName="AI finished waiting for door",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(50)=(EventID=2107,EventName="AI Failed AdjustFromWall",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(51)=(EventID=2108,EventName="AI charge attack start/end locations",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(52)=(EventID=2109,EventName="AI changed enemy",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(53)=(EventID=2111,EventName="AI path redirected",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(54)=(EventID=2112,EventName="AI blocked its path",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(55)=(EventID=2113,EventName="AI Obstructed",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(56)=(EventID=2114,EventName="AI Obstructed Repath",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(57)=(EventID=2116,EventName="AI Invalidated Anchor",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(58)=(EventID=2115,EventName="AI Move Timed Out",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(59)=(EventID=2117,EventName="AI Failed Fallback Anchor",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(60)=(EventID=2118,EventName="AI Failed Anchor Find",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(61)=(EventID=2119,EventName="AI Landed On Pawn",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(62)=(EventID=2120,EventName="AI Headless Wander",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(63)=(EventID=2121,EventName="AI Destroyed Door",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(64)=(EventID=2122,EventName="GoalEval Initial Abort",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   SupportedEvents(65)=(EventID=2123,EventName="PathFind Failure",StatGroup=(Group=GSG_Game,Level=10),EventDataType=14)
   Name="Default__KFGameplayEventsWriter"
   ObjectArchetype=GameplayEventsWriter'Engine.Default__GameplayEventsWriter'
}
