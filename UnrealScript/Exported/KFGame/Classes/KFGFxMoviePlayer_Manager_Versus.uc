...
defaultproperties
{
   ...
   WidgetBindings(24)=(WidgetName="ButtonPromptWidgetContainer",WidgetClass=Class'KFGame.KFGFxWidget_ButtonPrompt')
   WidgetBindings(25)=(WidgetName="BackendStatusIndicatorWidget",WidgetClass=Class'KFGame.KFGFxWidget_BackendStatusIndicatorWidget')
   WidgetBindings(26)=(WidgetName="MenuBarWidget",WidgetClass=Class'KFGame.KFGFxWidget_MenuBarVersus')
