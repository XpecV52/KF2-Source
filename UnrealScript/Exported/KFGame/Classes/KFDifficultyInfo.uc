...
defaultproperties
{
   ...
   Normal=(TraderTime=60,GlobalHealthMod=1.000000,MovementSpeedMod=1.000000,WaveCountMod=1.000000,DoshKillMod=1.000000,StartingDosh=250,RespawnDosh=250,AmmoPickupsMod=0.500000,ItemPickupsMod=0.300000,WeakAttackChance=1.000000,SelfInflictedDamageMod=1.000000)
   Hard=(TraderTime=60,GlobalHealthMod=1.000000,MovementSpeedMod=1.000000,WaveCountMod=1.000000,DoshKillMod=1.000000,StartingDosh=250,RespawnDosh=250,AmmoPickupsMod=0.500000,ItemPickupsMod=0.300000,WeakAttackChance=1.000000,SelfInflictedDamageMod=1.000000)
   Suicidal=(TraderTime=60,GlobalHealthMod=1.000000,MovementSpeedMod=1.000000,WaveCountMod=1.000000,DoshKillMod=1.000000,StartingDosh=250,RespawnDosh=250,AmmoPickupsMod=0.500000,ItemPickupsMod=0.300000,WeakAttackChance=1.000000,SelfInflictedDamageMod=1.000000)
   HellOnEarth=(TraderTime=60,GlobalHealthMod=1.000000,MovementSpeedMod=1.000000,WaveCountMod=1.000000,DoshKillMod=1.000000,StartingDosh=250,RespawnDosh=250,AmmoPickupsMod=0.500000,ItemPickupsMod=0.300000,WeakAttackChance=1.000000,SelfInflictedDamageMod=1.000000)
   CurrentSettings=(TraderTime=60,GlobalHealthMod=1.000000,MovementSpeedMod=1.000000,WaveCountMod=1.000000,DoshKillMod=1.000000,StartingDosh=250,RespawnDosh=250,AmmoPickupsMod=0.500000,ItemPickupsMod=0.300000,WeakAttackChance=1.000000,SelfInflictedDamageMod=1.000000)
