...
defaultproperties
{
   MuzzleFlash=(Duration=0.330000,SocketName="MuzzleFlash",FirstPersonDepthPriorityGroup=SDPG_World,TimerName="MuzzleFlashTimer")
   bAutoActivateShellEject=True
   MuzzleFlashMid=(Duration=0.330000,SocketName="MuzzleFlash",FirstPersonDepthPriorityGroup=SDPG_Foreground,TimerName="MuzzleFlashTimer")
   MuzzleFlashAlt=(Duration=0.330000,SocketName="MuzzleFlash",FirstPersonDepthPriorityGroup=SDPG_World,TimerName="MuzzleFlashAltTimer")
