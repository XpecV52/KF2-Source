...
defaultproperties
{
   ...
   SupportedEvents(0)=Class'KFGame.KFSeqEvent_MinigameStateChanged'
   SupportedEvents(1)=Class'KFGame.KFSeqEvent_MinigameActivated'
   Name="Default__KFTrigger_MinigameButton"
