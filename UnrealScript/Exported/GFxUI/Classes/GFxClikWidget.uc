...
/**
 *  This function removes any pre-existing listeners and adds a new one to the CLIK widget
 */

function AddAS3EventListener(name type, delegate<EventListener> listener, bool useCapture=false, int listenerPriority=0, bool useWeakReference=false)
{
	local GFxObject o, funcobj;
	local string TypeString;
...
private function AS3RemoveEventListener(string type, GFxObject o, bool useCapture=false){	ActionScriptVoid("removeEventListener");}

defaultproperties
{
   Name="Default__GFxClikWidget"
