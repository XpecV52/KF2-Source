...
defaultproperties
{
   Begin Object Class=SpriteComponent Name=Sprite Archetype=SpriteComponent'IpDrv.Default__InternetLink:Sprite'
      ...
      Name="Sprite"
      ObjectArchetype=SpriteComponent'IpDrv.Default__InternetLink:Sprite'
   End Object
   Components(0)=Sprite
   bAlwaysTick=True
   Name="Default__TcpLink"
   ObjectArchetype=InternetLink'IpDrv.Default__InternetLink'
}
