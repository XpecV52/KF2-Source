...
function DumpInfo()
{
	...
	LogInternal("	NatType: "$ClientPendingRequest.NatType,'DevBeacon');
	LogInternal("	GoodHostRatio: "$ClientPendingRequest.GoodHostRatio,'DevBeacon');
	LogInternal("	bCanHostVs: "$ClientPendingRequest.bCanHostVs,'DevBeacon');
	LogInternal("	MinutesSinceLastTest: "$ClientPendingRequest.MinutesSinceLastTest,'DevBeacon');		
	LogInternal("	BandwidthTest.CurrentState: "$CurrentBandwidthTest.CurrentState,'DevBeacon');
	LogInternal("	BandwidthTest.TestType: "$CurrentBandwidthTest.TestType,'DevBeacon');
	LogInternal("	Bandwidth History: "$ClientPendingRequest.BandwidthHistory.Length,'DevBeacon');
