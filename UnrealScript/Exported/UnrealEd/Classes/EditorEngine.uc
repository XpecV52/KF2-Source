...
defaultproperties
{
   ...
   EditPackages(4)="AkAudio"
   EditPackages(5)="GameFramework"
   EditPackages(6)="UnrealEd"
   EditPackages(7)="GFxUIEditor"
   EditPackages(8)="WinDrv"
   EditPackages(9)="OnlineSubsystemSteamworks"
   EditPackages(10)="OnlineSubsystemDingo"
   EditPackages(11)="SubstanceAir"
   EditPackages(12)="SubstanceAirEd"
   EditPackages(13)="BaseAI"
   EditPackages(14)="OnlineSubsystemNP"
   EditPackages(15)="OnlineSubsystemPC"
   EditPackages(16)="KFGame"
   EditPackages(17)="KFGameContent"
   EditPackages(18)="WebAdmin"
   EditPackages(19)="RCam"
   ...
   CustomCameraAlignEmitterDistance=100.000000
