...
defaultproperties
{
   ...
   EditPackages(10)="SubstanceAir"
   EditPackages(11)="SubstanceAirEd"
   EditPackages(12)="BaseAI"
   EditPackages(13)="OnlineSubsystemNP"
   EditPackages(14)="OnlineSubsystemPC"
   EditPackages(15)="KFGame"
   EditPackages(16)="KFGameContent"
   EditPackages(17)="WebAdmin"
