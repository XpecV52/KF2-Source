...
defaultproperties
{
   ImageColor=(R=1.000000,G=1.000000,B=1.000000,A=1.000000)
   CaptionColor=(R=0.000000,G=0.000000,B=0.000000,A=1.000000)
   bIsActive=True
   Name="Default__MobileMenuButton"
   ObjectArchetype=MobileMenuObject'GameFramework.Default__MobileMenuObject'
}
