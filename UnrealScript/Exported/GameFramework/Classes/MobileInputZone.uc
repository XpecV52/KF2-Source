...
defaultproperties
{
   VertMultiplier=1.000000
   HorizMultiplier=1.000000
   bApplyGlobalScaleToActiveSizes=True
   bUseGentleTransitions=True
   SizeX=100.000000
   SizeY=100.000000
   AuthoredGlobalScale=2.000000
   ResetCenterAfterInactivityTime=3.000000
   TapDistanceConstraint=5.000000
   ActivateTime=0.600000
   DeactivateTime=0.200000
   RenderColor=(B=255,G=255,R=255,A=255)
   InactiveAlpha=0.500000
   OverrideUVs1=(UL=64.000000,VL=64.000000)
   OverrideUVs2=(UL=64.000000,VL=64.000000)
   Name="Default__MobileInputZone"
