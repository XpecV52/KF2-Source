...
{
   bShowMobileHud=True
   JoystickBackgroundUVs=(UL=64.000000,VL=64.000000)
   JoystickHatUVs=(UL=64.000000,VL=64.000000)
   ButtonUVs(0)=(UL=64.000000,VL=64.000000)
   ButtonUVs(1)=(UL=64.000000,VL=64.000000)
   TrackballBackgroundUVs=(UL=64.000000,VL=64.000000)
   TrackballTouchIndicatorUVs=(UL=64.000000,VL=64.000000)
   SliderUVs(0)=(UL=64.000000,VL=64.000000)
   SliderUVs(1)=(UL=64.000000,VL=64.000000)
   SliderUVs(2)=(UL=64.000000,VL=64.000000)
   SliderUVs(3)=(UL=64.000000,VL=64.000000)
   Name="Default__MobileHUD"
