...
defaultproperties
{
   ...
   MaxAgents=700
   SpawnRate=50.000000
   AgentLightingChannel=(bInitialized=True,Crowd=True)
   MaxSpawnDist=10000.000000
   MinBehindSpawnDist=5000.000000
   AgentWarmupTime=2.000000
   ...
   VariableLinks(0)=(ExpectedType=Class'Engine.SeqVar_ObjectList',LinkDesc="Spawned List",PropertyName="LastSpawnedList",bWriteable=True,MaxVars=1)
