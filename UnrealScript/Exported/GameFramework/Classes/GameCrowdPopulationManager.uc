...
defaultproperties
{
   CloudSpawnInfo=(AgentWarmupTime=3.000000,SpawnPrioritizationInterval=0.400000)
   SplitScreenNumReduction=0.500000
   PlayerPositionPredictionTime=5.000000
   HeadVisibilityOffset=40.000000
   NavigationHandleClass=Class'Engine.NavigationHandle'
   bHidden=True
   bSkipActorPropertyReplication=True
   bOnlyDirtyReplication=True
   NetUpdateFrequency=10.000000
   Name="Default__GameCrowdPopulationManager"
   ObjectArchetype=CrowdPopulationManagerBase'Engine.Default__CrowdPopulationManagerBase'
}
