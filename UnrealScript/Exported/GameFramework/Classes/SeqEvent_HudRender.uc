...
defaultproperties
{
   ...
   VariableLinks(0)=(ExpectedType=Class'Engine.SeqVar_Bool',LinkDesc="Active",PropertyName="bIsActive",bWriteable=False,MaxVars=1)
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Target",PropertyName="Targets")
   Name="Default__SeqEvent_HudRender"
