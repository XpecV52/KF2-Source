...
defaultproperties
{
   ...
   AggregateEvents(18)=(EventID=10206,EventName="Melee Hits",StatGroup=(Group=GSG_Aggregate,Level=1),EventDataType=23)
   AggregateEvents(19)=(EventID=10207,EventName="Was Melee Hit",StatGroup=(Group=GSG_Aggregate,Level=1),EventDataType=23)
   AggregateEvents(20)=(EventID=10300,EventName="Weapon Fired",StatGroup=(Group=GSG_Aggregate,Level=1),EventDataType=22)
   AggregateEvents(21)=(EventID=10400,EventName="Spawns",StatGroup=(Group=GSG_Aggregate,Level=1),EventDataType=25)
