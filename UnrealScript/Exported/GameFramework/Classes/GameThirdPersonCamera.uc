...
function UpdateCamera(Pawn P, GamePlayerCamera CameraActor, float DeltaTime, out TViewTarget OutVT)
{
	...
	else
	{
		...
		{
			WarnInternal(GetFuncName() @ "CameraMode == None!!!");	
		}
...
defaultproperties
{
   WorstLocPenetrationExtentScale=1.000000
   PenetrationBlendOutTime=0.150000
   PenetrationBlendInTime=0.100000
   PenetrationBlockedPct=1.000000
   PenetrationExtentScale=1.000000
   OriginOffsetInterpSpeed=8.000000
   ThirdPersonCamDefaultClass=Class'GameFramework.GameThirdPersonCameraMode_Default'
   Focus_BackOffStrength=0.330000
   Focus_StepHeightAdjustment=64.000000
   Focus_MaxTries=4
   Focus_FastAdjustKickInTime=0.500000
   DirectLookInterpSpeed=6.000000
   WorstLocInterpSpeed=8.000000
   PenetrationAvoidanceFeelers(0)=(WorldWeight=1.000000,PawnWeight=1.000000,Extent=(X=14.000000,Y=14.000000,Z=14.000000))
   PenetrationAvoidanceFeelers(1)=(AdjustmentRot=(Pitch=0,Yaw=3072,Roll=0),WorldWeight=0.750000,PawnWeight=0.750000,TraceInterval=3)
   PenetrationAvoidanceFeelers(2)=(AdjustmentRot=(Pitch=0,Yaw=-3072,Roll=0),WorldWeight=0.750000,PawnWeight=0.750000,TraceInterval=3)
   PenetrationAvoidanceFeelers(3)=(AdjustmentRot=(Pitch=0,Yaw=6144,Roll=0),WorldWeight=0.500000,PawnWeight=0.500000,TraceInterval=5)
   PenetrationAvoidanceFeelers(4)=(AdjustmentRot=(Pitch=0,Yaw=-6144,Roll=0),WorldWeight=0.500000,PawnWeight=0.500000,TraceInterval=5)
   PenetrationAvoidanceFeelers(5)=(AdjustmentRot=(Pitch=3640,Yaw=0,Roll=0),WorldWeight=1.000000,PawnWeight=1.000000,TraceInterval=4)
   PenetrationAvoidanceFeelers(6)=(AdjustmentRot=(Pitch=-3640,Yaw=0,Roll=0),WorldWeight=0.500000,PawnWeight=0.500000,TraceInterval=4)
   Name="Default__GameThirdPersonCamera"
