...
{
	//debug
	if( ! class'Engine'.static.GetEngine().bDisableAILogging) {AILog_Internal("COMMAND PUSHED:"@self,'GameAICommand',);};
}
...
{
	//debug
	if( ! class'Engine'.static.GetEngine().bDisableAILogging) {AILog_Internal("COMMAND POPPED:"@self@"with"@Status,'GameAICommand',);};
}

function Paused(GameAICommand NewCommand)
{
	//debug
	if( ! class'Engine'.static.GetEngine().bDisableAILogging) {AILog_Internal("COMMAND PAUSED:"@self@"by"@NewCommand,'GameAICommand',);};
}

function Resumed( Name OldCommandName )
{
	//debug
	if( ! class'Engine'.static.GetEngine().bDisableAILogging) {AILog_Internal("COMMAND RESUMED:"@self@"from"@OldCommandName@"with"@ChildStatus,'GameAICommand',);};
}
