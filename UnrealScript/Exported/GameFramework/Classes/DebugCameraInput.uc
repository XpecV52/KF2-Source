...
defaultproperties
{
   ...
   Bindings(21)=(Name="XboxTypeS_LeftThumbStick",Command="ToggleDebugCamera",Shift=False)
   Bindings(22)=(Name="XboxTypeS_LeftX",Command="Axis aStrafe Speed=1.0 DeadZone=0.3",bIgnoreShift=False)
   Bindings(23)=(Name="XboxTypeS_LeftY",Command="Axis aBaseY Speed=1.0 DeadZone=0.3")
   Bindings(24)=(Name="XboxTypeS_RightX",Command="Axis aTurn Speed=1.0 DeadZone=0.2",Alt=False)
   Bindings(25)=(Name="XboxTypeS_RightY",Command="Axis aLookup Speed=0.8 DeadZone=0.2")
   Bindings(26)=(Name="XboxTypeS_LeftTrigger",Command="MoveDown",Control=False,Shift=False)
