...
reliable client event TeamMessage( PlayerReplicationInfo PRI, coerce string S, name Type, optional float MsgLifeTime  )
{
	...
	{
		LogInternal("Received message that is not 'say' or 'teamsay'. Type="$type$" Message= "$s);
	}
...
{
   CameraClass=None
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'Engine.Default__Admin:CollisionCylinder'
      ReplacementPrimitive=None
      Name="CollisionCylinder"
      ObjectArchetype=CylinderComponent'Engine.Default__Admin:CollisionCylinder'
   End Object
   ...
   Name="Default__MessagingSpectator"
   ObjectArchetype=Admin'Engine.Default__Admin'
}
