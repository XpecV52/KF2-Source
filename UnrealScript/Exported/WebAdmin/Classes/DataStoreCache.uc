...
function loadGameTypes()
{
	...
	for (i = 0; i < ProviderList.length; i++)
	{
		...
		for (j = 0; j < gametypes.length; j++)
		{
			...
			{
				LogInternal("Found duplicate game mode with name: "$item.name,'WebAdmin');
				break;
			}
		}
...
function loadMaps()
{
	...
	for (i = 0; i < ProviderList.length; i++)
	{
		...
		for (j = 0; j < maps.length; j++)
		{
			...
			{
				LogInternal("Found duplicate map with name: "$item.name,'WebAdmin');
				break;
			}
		}
		if (j != maps.length)
...
function loadMutators()
{
	...
	for (i = 0; i < ProviderList.length; i++)
	{
		...
		for (j = 0; j < mutators.length; j++)
		{
			...
			{
				LogInternal("Found duplicate mutator with name: "$item.name,'WebAdmin');
				break;
			}
		}
