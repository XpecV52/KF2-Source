...
defaultproperties
{
   ...
   HardStretchLimitFactor=1.100000
   ClothMetalImpulseThreshold=10.000000
   ClothTearFactor=3.500000
   ClothTearReserve=128
   SoftBodyVolumeStiffness=1.000000
   SoftBodyStretchingStiffness=1.000000
   SoftBodyDensity=1.000000
   SoftBodyParticleRadius=0.100000
   SoftBodyDamping=0.500000
   SoftBodySolverIterations=5
   SoftBodyFriction=0.500000
   SoftBodyRelativeGridSpacing=1.000000
   SoftBodySleepLinearVelocity=-1.000000
   SoftBodyAttachmentResponse=0.200000
   SoftBodyCollisionResponse=0.200000
   SoftBodyDetailLevel=0.500000
   SoftBodySubdivisionLevel=4
   bSoftBodyIsoSurface=True
   SoftBodyAttachmentThreshold=0.500000
   bEnableSoftBodyTwoWayCollision=True
   SoftBodyAttachmentTearFactor=1.500000
