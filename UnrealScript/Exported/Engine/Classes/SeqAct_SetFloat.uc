...
defaultproperties
{
   VariableLinks(0)=(ExpectedType=Class'Engine.SeqVar_Float',LinkDesc="Value",PropertyName="Value")
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Float',LinkDesc="Target",PropertyName="Target",bWriteable=True)
   ObjName="Float"
