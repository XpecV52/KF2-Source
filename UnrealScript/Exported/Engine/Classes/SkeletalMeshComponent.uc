...
defaultproperties
{
   ...
   LineCheckBoundsScale=(X=1.000000,Y=1.000000,Z=1.000000)
   bAutoFreezeClothWhenNotRendered=True
   bCacheAnimSequenceNodes=True
   ClothWindBlendTime=5.000000
   ClothBlendWeight=1.000000
   ClothBlendMinDistanceFactor=-1.000000
   ClothRBChannel=RBCC_Cloth
   ClothImpulseScale=1.000000
   ClothAttachmentTearFactor=-1.000000
   MinDistanceForClothReset=256.000000
   ApexClothingRBChannel=RBCC_Clothing
   ApexClothingRBCollideWithChannels=(Default=True,GameplayPhysics=True,EffectPhysics=True,BlockingVolume=True,ClothingCollision=True)
   ApexClothingCollisionRBChannel=RBCC_ClothingCollision
   bAutoFreezeApexClothingWhenNotRendered=True
   SoftBodyImpulseScale=1.000000
