...
defaultproperties
{
   ...
   Bindings(64)=(Name="GBA_Fire",Command="StartFire | OnRelease StopFire")
   ...
   Bindings(68)=(Name="GBA_AltFire",Command="StartAltFire | OnRelease StopAltFire")
   Bindings(69)=(Name="GBA_TertiaryFire",Command="StartTertiaryFire | OnRelease StopTertiaryFire")
   ...
   Bindings(73)=(Name="GBA_Reload",Command="Reload | OnRelease ReloadRelease")
   Bindings(74)=(Name="GBA_Grenade",Command="Grenade | OnRelease GrenadeRelease")
   Bindings(75)=(Name="GBA_ToggleFlashlight",Command="ToggleFlashlight")
   ...
   Bindings(80)=(Name="GBA_SwitchWeapon1",Command="SwitchWeaponGroup 0")
   Bindings(81)=(Name="GBA_SwitchWeapon2",Command="SwitchWeaponGroup 1")
   Bindings(82)=(Name="GBA_SwitchWeapon3",Command="SwitchWeaponGroup 2")
   Bindings(83)=(Name="GBA_SwitchWeapon4",Command="SwitchWeaponGroup 3")
   Bindings(84)=(Name="GBA_DropWeapon",Command="ThrowWeapon")
   Bindings(85)=(Name="GBA_Talk",Command="talk")
   Bindings(86)=(Name="GBA_ShowMenu",Command="CloseEditorViewport | onrelease ShowMenu")
   Bindings(87)=(Name="GBA_ShowScores",Command="SetShowScores true | Onrelease SetShowScores false")
   Bindings(88)=(Name="GBA_TossMoney",Command="TossMoney")
   Bindings(89)=(Name="GBA_VoiceChat",Command="StartVoiceChat | OnRelease StopVoiceChat")
   Bindings(90)=(Name="GBA_ShowVoiceComms",Command="ShowVoiceComms | OnRelease HideVoiceComms")
   Bindings(91)=(Name="GBA_VoteYes",Command="OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(92)=(Name="GBA_VoteNo",Command="OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(93)=(Name="GBA_WeaponSelect_Gamepad",Command="GamepadWeaponSelect | OnRelease ReleaseGamepadWeaponSelect")
   Bindings(94)=(Name="GBA_DPad_Left_Gamepad",Command="GamepadDpadLeft")
   Bindings(95)=(Name="GBA_DPad_Right_Gamepad",Command="GamepadDpadRight | OnRelease GamepadDpadRightRelease")
   Bindings(96)=(Name="GBA_DPad_Down_Gamepad",Command="GamepadDpadDown")
   Bindings(97)=(Name="GBA_DPad_Up_Gamepad",Command="GamepadDpadUp | OnRelease GamepadDpadUpRelease")
   Bindings(98)=(Name="GBA_Crouch_Gamepad",Command="GamepadCrouch | OnRelease GamepadCrouchRelease")
   Bindings(99)=(Name="GBA_Jump_Gamepad",Command="SmartJump | Axis aUp Speed=1.0 AbsoluteAxis=100")
   Bindings(100)=(Name="GBA_StrafeLeft_Gamepad",Command="Axis aStrafe Speed=1.0 DeadZone=0.2")
   Bindings(101)=(Name="GBA_MoveForward_Gamepad",Command="Axis aBaseY Speed=1.0 DeadZone=0.2")
   Bindings(102)=(Name="GBA_TurnLeft_Gamepad",Command="Axis aTurn Speed=1.0 DeadZone=0.2")
   Bindings(103)=(Name="GBA_Look_Gamepad",Command="Axis aLookup Speed=1.0 DeadZone=0.2")
   Bindings(104)=(Name="GBA_SwitchToBestWeapon_Gamepad",Command="SwitchToBestWeapon | Axis aUp Speed=-1.0 AbsoluteAxis=100")
   Bindings(105)=(Name="XboxTypeS_A",Command="GBA_Jump | OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(106)=(Name="XboxTypeS_B",Command="GBA_TertiaryFire | OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(107)=(Name="XboxTypeS_Y",Command="GBA_WeaponSelect_Gamepad")
   Bindings(108)=(Name="XboxTypeS_X",Command="GBA_Reload")
   Bindings(109)=(Name="XboxTypeS_LeftX",Command="GBA_StrafeLeft_Gamepad")
   Bindings(110)=(Name="XboxTypeS_LeftY",Command="GBA_MoveForward_Gamepad")
   Bindings(111)=(Name="XboxTypeS_LeftThumbStick",Command="GBA_SprintAndCrouch")
   Bindings(112)=(Name="XboxTypeS_RightX",Command="GBA_TurnLeft_Gamepad")
   Bindings(113)=(Name="XboxTypeS_RightY",Command="GBA_Look_Gamepad")
   Bindings(114)=(Name="XboxTypeS_RightThumbStick",Command="GBA_Use | OnRelease GBA_InteractRelease")
   Bindings(115)=(Name="XboxTypeS_LeftShoulder",Command="GBA_Grenade")
   Bindings(116)=(Name="XboxTypeS_RightShoulder",Command="GBA_SwitchFireMode")
   Bindings(117)=(Name="XboxTypeS_LeftTrigger",Command="GBA_IronsightsHold")
   Bindings(118)=(Name="XboxTypeS_RightTrigger",Command="GBA_Fire")
   Bindings(119)=(Name="XboxTypeS_DPad_Left",Command="GBA_DPad_Left_Gamepad")
   Bindings(120)=(Name="XboxTypeS_DPad_Right",Command="GBA_DPad_Right_Gamepad")
   Bindings(121)=(Name="XboxTypeS_DPad_Down",Command="GBA_DPad_Down_Gamepad")
   Bindings(122)=(Name="XboxTypeS_DPad_Up",Command="GBA_DPad_Up_Gamepad")
   Bindings(123)=(Name="XboxTypeS_Back",Command="GBA_ShowScores")
   Bindings(124)=(Name="XboxTypeS_Start",Command="GBA_ShowMenu")
   Bindings(125)=(Name="SIXAXIS_AccelX",Command="GBA_TurnLeft_Gamepad")
   Bindings(126)=(Name="SIXAXIS_AccelZ",Command="GBA_Look_Gamepad")
   Bindings(127)=(Name="Up",Command="GBA_MoveForward")
   Bindings(128)=(Name="Down",Command="GBA_Backward")
   Bindings(129)=(Name="Left",Command="GBA_TurnLeft")
   Bindings(130)=(Name="Right",Command="GBA_TurnRight")
   Bindings(131)=(Name="Enter",Command="GBA_Use")
   Bindings(132)=(Name="SpaceBar",Command="GBA_Jump")
   Bindings(133)=(Name="W",Command="GBA_MoveForward")
   Bindings(134)=(Name="S",Command="GBA_Backward")
   Bindings(135)=(Name="A",Command="GBA_StrafeLeft")
   Bindings(136)=(Name="D",Command="GBA_StrafeRight")
   Bindings(137)=(Name="E",Command="GBA_Use")
   Bindings(138)=(Name="LeftMouseButton",Command="GBA_Fire | SpectatePrevPlayer")
   Bindings(139)=(Name="MiddleMouseButton",Command="GBA_SwitchFireMode | SpectateChangeCamMode")
   Bindings(140)=(Name="RightMouseButton",Command="GBA_IronsightsToggle | SpectateNextPlayer")
   Bindings(141)=(Name="F",Command="GBA_ToggleFlashlight")
   Bindings(142)=(Name="R",Command="GBA_Reload")
   Bindings(143)=(Name="G",Command="GBA_Grenade")
   Bindings(144)=(Name="C",Command="GBA_CrouchToggle")
   Bindings(145)=(Name="Q",Command="GBA_QuickHeal")
   Bindings(146)=(Name="V",Command="GBA_TertiaryFire")
   Bindings(147)=(Name="Escape",Command="GBA_ShowMenu")
   Bindings(148)=(Name="MouseScrollUp",Command="GBA_NextWeapon")
   Bindings(149)=(Name="MouseScrollDown",Command="GBA_PrevWeapon")
   Bindings(150)=(Name="one",Command="GBA_SwitchWeapon1")
   Bindings(151)=(Name="two",Command="GBA_SwitchWeapon2")
   Bindings(152)=(Name="three",Command="GBA_SwitchWeapon3")
   Bindings(153)=(Name="four",Command="GBA_SwitchWeapon4")
   Bindings(154)=(Name="BackSpace",Command="GBA_DropWeapon")
   Bindings(155)=(Name="T",Command="GBA_Talk")
   Bindings(156)=(Name="Tab",Command="GBA_ShowScores",bIgnoreShift=True)
   Bindings(157)=(Name="Z",Command="GBA_ShowVoiceComms")
   Bindings(158)=(Name="B",Command="GBA_TossMoney")
   Bindings(159)=(Name="LeftShift",Command="GBA_Sprint")
   Bindings(160)=(Name="CapsLock",Command="GBA_VoiceChat")
   Bindings(161)=(Name="F1",Command="GBA_VoteYes")
   Bindings(162)=(Name="F2",Command="GBA_VoteNo")
   Bindings(163)=(Name="F4",Command="Playersonly")
   Bindings(164)=(Name="F5",Command="set D3DRenderDevice UsePostProcessEffects False")
   Bindings(165)=(Name="F6",Command="set D3DRenderDevice UsePostProcessEffects True")
   Bindings(166)=(Name="F7",Command="NextViewMode",bIgnoreAlt=True)
   Bindings(167)=(Name="F8",Command="PrevViewMode")
   Bindings(168)=(Name="M",Command="BasePath 0")
   Bindings(169)=(Name="N",Command="BasePath 1")
   Bindings(170)=(Name="F9",Command="viewmode wireframe",Control=True)
   Bindings(171)=(Name="F10",Command="viewmode unlit",Control=True)
   Bindings(172)=(Name="F4",Command="viewmode detaillighting",Control=True)
   Bindings(173)=(Name="F5",Command="viewmode shadercomplexity",Control=True)
   Bindings(174)=(Name="F6",Command="viewmode lit",Control=True)
   Bindings(175)=(Name="PageDown",Command="Camera ThirdPerson")
   Bindings(176)=(Name="PageUp",Command="Camera Fixed")
   Bindings(177)=(Name="Home",Command="Camera FixedTracking")
   Bindings(178)=(Name="Insert",Command="Camera FreeCam")
   Bindings(179)=(Name="P",Command="Playersonly")
   Bindings(180)=(Name="LeftBracket",Command="Slomo .2")
   Bindings(181)=(Name="RightBracket",Command="Slomo 1")
   Bindings(182)=(Name="Backslash",Command="Slomo 4")
   Bindings(183)=(Name="Subtract",Command="PreviousTrackingRange")
   Bindings(184)=(Name="Add",Command="NextTrackingRange")
   Bindings(185)=(Name="NumPadZero",Command="ToggleTracker")
   Bindings(186)=(Name="NumPadOne",Command="NextTrackingMode")
   Bindings(187)=(Name="NumPadTwo",Command="ToggleMapView")
