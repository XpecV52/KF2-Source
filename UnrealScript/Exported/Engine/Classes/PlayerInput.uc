...
defaultproperties
{
   ...
   Bindings(104)=(Name="GBA_WeaponSelect_Gamepad",Command="GamepadWeaponSelect | OnRelease ReleaseGamepadWeaponSelect")
   Bindings(105)=(Name="GBA_DPad_Left_Gamepad",Command="GamepadDpadLeft | OnRelease HideVoiceComms")
   Bindings(106)=(Name="GBA_DPad_Right_Gamepad",Command="GamepadDpadRight | OnRelease HideVoiceComms")
   Bindings(107)=(Name="GBA_DPad_Down_Gamepad",Command="GamepadDpadDown")
   Bindings(108)=(Name="GBA_DPad_Up_Gamepad",Command="GamepadDpadUp")
   Bindings(109)=(Name="GBA_Crouch_Gamepad",Command="GamepadCrouch | OnRelease GamepadCrouchRelease")
   Bindings(110)=(Name="GBA_StrafeLeft_Gamepad",Command="Axis aStrafe Speed=1.0 DeadZone=0.2")
   Bindings(111)=(Name="GBA_MoveForward_Gamepad",Command="Axis aBaseY Speed=1.0 DeadZone=0.2")
   Bindings(112)=(Name="GBA_TurnLeft_Gamepad",Command="Axis aTurn Speed=1.0 DeadZone=0.2")
   Bindings(113)=(Name="GBA_Look_Gamepad",Command="Axis aLookup Speed=1.0 DeadZone=0.2")
   Bindings(114)=(Name="GBA_SwitchToBestWeapon_Gamepad",Command="SwitchToBestWeapon | Axis aUp Speed=-1.0 AbsoluteAxis=100")
   Bindings(115)=(Name="GBA_Reload_Gamepad",Command="GamepadReload | OnRelease GamepadReloadRelease")
   Bindings(116)=(Name="GBA_AltFire_Gamepad",Command="GamepadSwitchFire | OnRelease SwitchFireRelease")
   Bindings(117)=(Name="GBA_MoveForward_GamepadSouthpaw",Command="Axis aBaseY Speed=-1.0 DeadZone=0.2")
   Bindings(118)=(Name="GBA_Look_GamepadSouthpaw",Command="Axis aLookup Speed=-1.0 DeadZone=0.2")
   Bindings(119)=(Name="XboxTypeS_A",Command="GBA_Jump | OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(120)=(Name="XboxTypeS_B",Command="GBA_Use | OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(121)=(Name="XboxTypeS_Y",Command="GBA_WeaponSelect_Gamepad")
   Bindings(122)=(Name="XboxTypeS_X",Command="GBA_Reload_Gamepad")
   Bindings(123)=(Name="XboxTypeS_LeftX",Command="GBA_StrafeLeft_Gamepad")
   Bindings(124)=(Name="XboxTypeS_LeftY",Command="GBA_MoveForward_Gamepad")
   Bindings(125)=(Name="XboxTypeS_LeftThumbStick",Command="GBA_SprintAndCrouch")
   Bindings(126)=(Name="XboxTypeS_RightX",Command="GBA_TurnLeft_Gamepad")
   Bindings(127)=(Name="XboxTypeS_RightY",Command="GBA_Look_Gamepad")
   Bindings(128)=(Name="XboxTypeS_RightThumbStick",Command="GBA_TertiaryFire")
   Bindings(129)=(Name="XboxTypeS_LeftShoulder",Command="GBA_Grenade")
   Bindings(130)=(Name="XboxTypeS_RightShoulder",Command="GBA_AltFire_Gamepad")
   Bindings(131)=(Name="XboxTypeS_LeftTrigger",Command="GBA_IronsightsHold")
   Bindings(132)=(Name="XboxTypeS_RightTrigger",Command="GBA_Fire")
   Bindings(133)=(Name="XboxTypeS_DPad_Left",Command="GBA_DPad_Left_Gamepad")
   Bindings(134)=(Name="XboxTypeS_DPad_Right",Command="GBA_DPad_Right_Gamepad")
   Bindings(135)=(Name="XboxTypeS_DPad_Down",Command="GBA_DPad_Down_Gamepad | OnRelease FlashlightRelease")
   Bindings(136)=(Name="XboxTypeS_DPad_Up",Command="GBA_DPad_Up_Gamepad")
   Bindings(137)=(Name="XboxTypeS_Back",Command="GBA_ShowScores")
   Bindings(138)=(Name="XboxTypeS_Start",Command="GBA_ShowMenu")
   Bindings(139)=(Name="Orbis_SwipeUp",Command="GBA_TossMoney")
   Bindings(140)=(Name="Up",Command="GBA_MoveForward")
   Bindings(141)=(Name="Down",Command="GBA_Backward")
   Bindings(142)=(Name="Left",Command="GBA_TurnLeft")
   Bindings(143)=(Name="Right",Command="GBA_TurnRight")
   Bindings(144)=(Name="Enter",Command="GBA_Use")
   Bindings(145)=(Name="SpaceBar",Command="GBA_Jump")
   Bindings(146)=(Name="W",Command="GBA_MoveForward")
   Bindings(147)=(Name="S",Command="GBA_Backward")
   Bindings(148)=(Name="A",Command="GBA_StrafeLeft")
   Bindings(149)=(Name="D",Command="GBA_StrafeRight")
   Bindings(150)=(Name="E",Command="GBA_Use")
   Bindings(151)=(Name="LeftMouseButton",Command="GBA_Fire | SpectatePrevPlayer")
   Bindings(152)=(Name="MiddleMouseButton",Command="GBA_SwitchFireMode | SpectateChangeCamMode")
   Bindings(153)=(Name="RightMouseButton",Command="GBA_IronsightsToggle | SpectateNextPlayer")
   Bindings(154)=(Name="F",Command="GBA_ToggleFlashlight")
   Bindings(155)=(Name="R",Command="GBA_Reload")
   Bindings(156)=(Name="G",Command="GBA_Grenade")
   Bindings(157)=(Name="C",Command="GBA_CrouchToggle")
   Bindings(158)=(Name="Q",Command="GBA_QuickHeal")
   Bindings(159)=(Name="V",Command="GBA_TertiaryFire")
   Bindings(160)=(Name="Escape",Command="GBA_ShowMenu")
   Bindings(161)=(Name="MouseScrollUp",Command="GBA_NextWeapon")
   Bindings(162)=(Name="MouseScrollDown",Command="GBA_PrevWeapon")
   Bindings(163)=(Name="one",Command="GBA_SwitchWeapon1")
   Bindings(164)=(Name="two",Command="GBA_SwitchWeapon2")
   Bindings(165)=(Name="three",Command="GBA_SwitchWeapon3")
   Bindings(166)=(Name="four",Command="GBA_SwitchWeapon4")
   Bindings(167)=(Name="BackSpace",Command="GBA_DropWeapon")
   Bindings(168)=(Name="T",Command="GBA_Talk")
   Bindings(169)=(Name="Y",Command="GBA_TeamTalk")
   Bindings(170)=(Name="Tab",Command="GBA_ShowScores",bIgnoreShift=True)
   Bindings(171)=(Name="Z",Command="GBA_ShowVoiceComms")
   Bindings(172)=(Name="B",Command="GBA_TossMoney")
   Bindings(173)=(Name="LeftShift",Command="GBA_Sprint")
   Bindings(174)=(Name="CapsLock",Command="GBA_VoiceChat")
   Bindings(175)=(Name="F1",Command="GBA_VoteYes")
   Bindings(176)=(Name="F2",Command="GBA_VoteNo")
   Bindings(177)=(Name="F4",Command="Playersonly")
   Bindings(178)=(Name="F5",Command="set D3DRenderDevice UsePostProcessEffects False")
   Bindings(179)=(Name="F6",Command="set D3DRenderDevice UsePostProcessEffects True")
   Bindings(180)=(Name="F7",Command="NextViewMode",bIgnoreAlt=True)
   Bindings(181)=(Name="F8",Command="PrevViewMode")
   Bindings(182)=(Name="M",Command="BasePath 0")
   Bindings(183)=(Name="N",Command="BasePath 1")
   Bindings(184)=(Name="F9",Command="viewmode wireframe",Control=True)
   Bindings(185)=(Name="F10",Command="viewmode unlit",Control=True)
   Bindings(186)=(Name="F4",Command="viewmode detaillighting",Control=True)
   Bindings(187)=(Name="F5",Command="viewmode shadercomplexity",Control=True)
   Bindings(188)=(Name="F6",Command="viewmode lit",Control=True)
   Bindings(189)=(Name="PageDown",Command="Camera ThirdPerson")
   Bindings(190)=(Name="PageUp",Command="Camera Fixed")
   Bindings(191)=(Name="Home",Command="Camera FixedTracking")
   Bindings(192)=(Name="Insert",Command="Camera FreeCam")
   Bindings(193)=(Name="P",Command="Playersonly")
   Bindings(194)=(Name="LeftBracket",Command="Slomo .2")
   Bindings(195)=(Name="RightBracket",Command="Slomo 1")
   Bindings(196)=(Name="Backslash",Command="Slomo 4")
   Bindings(197)=(Name="Subtract",Command="PreviousTrackingRange")
   Bindings(198)=(Name="Add",Command="NextTrackingRange")
   Bindings(199)=(Name="NumPadZero",Command="ToggleTracker")
   Bindings(200)=(Name="NumPadOne",Command="NextTrackingMode")
   Bindings(201)=(Name="NumPadTwo",Command="ToggleMapView")
