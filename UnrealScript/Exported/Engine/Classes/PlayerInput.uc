...
defaultproperties
{
   ...
   Bindings(95)=(Name="GBA_WeaponSelect_Gamepad",Command="GamepadWeaponSelect | OnRelease ReleaseGamepadWeaponSelect")
   Bindings(96)=(Name="GBA_DPad_Left_Gamepad",Command="GamepadDpadLeft | OnRelease HideVoiceComms")
   Bindings(97)=(Name="GBA_DPad_Right_Gamepad",Command="GamepadDpadRight | OnRelease HideVoiceComms")
   Bindings(98)=(Name="GBA_DPad_Down_Gamepad",Command="GamepadDpadDown")
   Bindings(99)=(Name="GBA_DPad_Up_Gamepad",Command="GamepadDpadUp")
   Bindings(100)=(Name="GBA_Crouch_Gamepad",Command="GamepadCrouch | OnRelease GamepadCrouchRelease")
   ...
   Bindings(108)=(Name="GBA_MoveForward_GamepadSouthpaw",Command="Axis aBaseY Speed=-1.0 DeadZone=0.2")
   Bindings(109)=(Name="GBA_Look_GamepadSouthpaw",Command="Axis aLookup Speed=-1.0 DeadZone=0.2")
   Bindings(110)=(Name="XboxTypeS_A",Command="GBA_Jump | OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(111)=(Name="XboxTypeS_B",Command="GBA_Use | OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(112)=(Name="XboxTypeS_Y",Command="GBA_WeaponSelect_Gamepad")
   Bindings(113)=(Name="XboxTypeS_X",Command="GBA_Reload_Gamepad")
   Bindings(114)=(Name="XboxTypeS_LeftX",Command="GBA_StrafeLeft_Gamepad")
   Bindings(115)=(Name="XboxTypeS_LeftY",Command="GBA_MoveForward_Gamepad")
   Bindings(116)=(Name="XboxTypeS_LeftThumbStick",Command="GBA_SprintAndCrouch")
   Bindings(117)=(Name="XboxTypeS_RightX",Command="GBA_TurnLeft_Gamepad")
   ...
   Bindings(125)=(Name="XboxTypeS_DPad_Right",Command="GBA_DPad_Right_Gamepad")
   Bindings(126)=(Name="XboxTypeS_DPad_Down",Command="GBA_DPad_Down_Gamepad | OnRelease FlashlightRelease")
   Bindings(127)=(Name="XboxTypeS_DPad_Up",Command="GBA_DPad_Up_Gamepad")
   Bindings(128)=(Name="XboxTypeS_Back",Command="GBA_ShowScores")
   Bindings(129)=(Name="XboxTypeS_Start",Command="GBA_ShowMenu")
   Bindings(130)=(Name="Orbis_SwipeUp",Command="GBA_TossMoney")
   Bindings(131)=(Name="Up",Command="GBA_MoveForward")
   Bindings(132)=(Name="Down",Command="GBA_Backward")
   Bindings(133)=(Name="Left",Command="GBA_TurnLeft")
   Bindings(134)=(Name="Right",Command="GBA_TurnRight")
   Bindings(135)=(Name="Enter",Command="GBA_Use")
   Bindings(136)=(Name="SpaceBar",Command="GBA_Jump")
   Bindings(137)=(Name="W",Command="GBA_MoveForward")
   Bindings(138)=(Name="S",Command="GBA_Backward")
   Bindings(139)=(Name="A",Command="GBA_StrafeLeft")
   Bindings(140)=(Name="D",Command="GBA_StrafeRight")
   Bindings(141)=(Name="E",Command="GBA_Use")
   Bindings(142)=(Name="LeftMouseButton",Command="GBA_Fire | SpectatePrevPlayer")
   Bindings(143)=(Name="MiddleMouseButton",Command="GBA_SwitchFireMode | SpectateChangeCamMode")
   Bindings(144)=(Name="RightMouseButton",Command="GBA_IronsightsToggle | SpectateNextPlayer")
   Bindings(145)=(Name="F",Command="GBA_ToggleFlashlight")
   Bindings(146)=(Name="R",Command="GBA_Reload")
   Bindings(147)=(Name="G",Command="GBA_Grenade")
   Bindings(148)=(Name="C",Command="GBA_CrouchToggle")
   Bindings(149)=(Name="Q",Command="GBA_QuickHeal")
   Bindings(150)=(Name="V",Command="GBA_TertiaryFire")
   Bindings(151)=(Name="Escape",Command="GBA_ShowMenu")
   Bindings(152)=(Name="MouseScrollUp",Command="GBA_NextWeapon")
   Bindings(153)=(Name="MouseScrollDown",Command="GBA_PrevWeapon")
   Bindings(154)=(Name="one",Command="GBA_SwitchWeapon1")
   Bindings(155)=(Name="two",Command="GBA_SwitchWeapon2")
   Bindings(156)=(Name="three",Command="GBA_SwitchWeapon3")
   Bindings(157)=(Name="four",Command="GBA_SwitchWeapon4")
   Bindings(158)=(Name="BackSpace",Command="GBA_DropWeapon")
   Bindings(159)=(Name="T",Command="GBA_Talk")
   Bindings(160)=(Name="Y",Command="GBA_TeamTalk")
   Bindings(161)=(Name="Tab",Command="GBA_ShowScores",bIgnoreShift=True)
   Bindings(162)=(Name="Z",Command="GBA_ShowVoiceComms")
   Bindings(163)=(Name="B",Command="GBA_TossMoney")
   Bindings(164)=(Name="LeftShift",Command="GBA_Sprint")
   Bindings(165)=(Name="CapsLock",Command="GBA_VoiceChat")
   Bindings(166)=(Name="F1",Command="GBA_VoteYes")
   Bindings(167)=(Name="F2",Command="GBA_VoteNo")
   Bindings(168)=(Name="F4",Command="Playersonly")
   Bindings(169)=(Name="F5",Command="set D3DRenderDevice UsePostProcessEffects False")
   Bindings(170)=(Name="F6",Command="set D3DRenderDevice UsePostProcessEffects True")
   Bindings(171)=(Name="F7",Command="NextViewMode",bIgnoreAlt=True)
   Bindings(172)=(Name="F8",Command="PrevViewMode")
   Bindings(173)=(Name="M",Command="BasePath 0")
   Bindings(174)=(Name="N",Command="BasePath 1")
   Bindings(175)=(Name="F9",Command="viewmode wireframe",Control=True)
   Bindings(176)=(Name="F10",Command="viewmode unlit",Control=True)
   Bindings(177)=(Name="F4",Command="viewmode detaillighting",Control=True)
   Bindings(178)=(Name="F5",Command="viewmode shadercomplexity",Control=True)
   Bindings(179)=(Name="F6",Command="viewmode lit",Control=True)
   Bindings(180)=(Name="PageDown",Command="Camera ThirdPerson")
   Bindings(181)=(Name="PageUp",Command="Camera Fixed")
   Bindings(182)=(Name="Home",Command="Camera FixedTracking")
   Bindings(183)=(Name="Insert",Command="Camera FreeCam")
   Bindings(184)=(Name="P",Command="Playersonly")
   Bindings(185)=(Name="LeftBracket",Command="Slomo .2")
   Bindings(186)=(Name="RightBracket",Command="Slomo 1")
   Bindings(187)=(Name="Backslash",Command="Slomo 4")
   Bindings(188)=(Name="Subtract",Command="PreviousTrackingRange")
   Bindings(189)=(Name="Add",Command="NextTrackingRange")
   Bindings(190)=(Name="NumPadZero",Command="ToggleTracker")
   Bindings(191)=(Name="NumPadOne",Command="NextTrackingMode")
   Bindings(192)=(Name="NumPadTwo",Command="ToggleMapView")
