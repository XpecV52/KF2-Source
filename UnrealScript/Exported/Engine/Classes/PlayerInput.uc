...
defaultproperties
{
   ...
   Bindings(87)=(Name="GBA_ShowMenu",Command="CloseEditorViewport | onrelease ShowMenu")
   Bindings(88)=(Name="GBA_ShowScores",Command="SetShowScores true | Onrelease SetShowScores false")
   Bindings(89)=(Name="GBA_TossMoney",Command="TossMoney")
   Bindings(90)=(Name="GBA_VoiceChat",Command="StartVoiceChat | OnRelease StopVoiceChat")
   Bindings(91)=(Name="GBA_ShowVoiceComms",Command="ShowVoiceComms | OnRelease HideVoiceComms")
   Bindings(92)=(Name="GBA_VoteYes",Command="OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(93)=(Name="GBA_VoteNo",Command="OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(94)=(Name="GBA_WeaponSelect_Gamepad",Command="GamepadWeaponSelect | OnRelease ReleaseGamepadWeaponSelect")
   Bindings(95)=(Name="GBA_DPad_Left_Gamepad",Command="GamepadDpadLeft | OnRelease HideVoiceComms")
   Bindings(96)=(Name="GBA_DPad_Right_Gamepad",Command="GamepadDpadRight | OnRelease HideVoiceComms")
   Bindings(97)=(Name="GBA_DPad_Down_Gamepad",Command="GamepadDpadDown")
   Bindings(98)=(Name="GBA_DPad_Up_Gamepad",Command="GamepadDpadUp")
   Bindings(99)=(Name="GBA_Crouch_Gamepad",Command="GamepadCrouch | OnRelease GamepadCrouchRelease")
   Bindings(100)=(Name="GBA_Jump_Gamepad",Command="SmartJump | Axis aUp Speed=1.0 AbsoluteAxis=100")
   Bindings(101)=(Name="GBA_StrafeLeft_Gamepad",Command="Axis aStrafe Speed=1.0 DeadZone=0.2")
   Bindings(102)=(Name="GBA_MoveForward_Gamepad",Command="Axis aBaseY Speed=1.0 DeadZone=0.2")
   Bindings(103)=(Name="GBA_TurnLeft_Gamepad",Command="Axis aTurn Speed=1.0 DeadZone=0.2")
   Bindings(104)=(Name="GBA_Look_Gamepad",Command="Axis aLookup Speed=1.0 DeadZone=0.2")
   Bindings(105)=(Name="GBA_SwitchToBestWeapon_Gamepad",Command="SwitchToBestWeapon | Axis aUp Speed=-1.0 AbsoluteAxis=100")
   Bindings(106)=(Name="GBA_Reload_Gamepad",Command="GamepadReload | OnRelease GamepadReloadRelease")
   Bindings(107)=(Name="GBA_Grenade_Gamepad",Command="GamepadGrenade | OnRelease GrenadeRelease")
   Bindings(108)=(Name="XboxTypeS_A",Command="GBA_Jump | OnVoteYesPressed | OnRelease OnVoteYesRelease")
   Bindings(109)=(Name="XboxTypeS_B",Command="GBA_TertiaryFire | OnVoteNoPressed | OnRelease OnVoteNoRelease")
   Bindings(110)=(Name="XboxTypeS_Y",Command="GBA_WeaponSelect_Gamepad")
   Bindings(111)=(Name="XboxTypeS_X",Command="GBA_Reload_Gamepad")
   Bindings(112)=(Name="XboxTypeS_LeftX",Command="GBA_StrafeLeft_Gamepad")
   Bindings(113)=(Name="XboxTypeS_LeftY",Command="GBA_MoveForward_Gamepad")
   Bindings(114)=(Name="XboxTypeS_LeftThumbStick",Command="GBA_SprintAndCrouch")
   Bindings(115)=(Name="XboxTypeS_RightX",Command="GBA_TurnLeft_Gamepad")
   Bindings(116)=(Name="XboxTypeS_RightY",Command="GBA_Look_Gamepad")
   Bindings(117)=(Name="XboxTypeS_RightThumbStick",Command="GBA_Use | OnRelease GBA_InteractRelease")
   Bindings(118)=(Name="XboxTypeS_LeftShoulder",Command="GBA_Grenade_Gamepad")
   Bindings(119)=(Name="XboxTypeS_RightShoulder",Command="GBA_SwitchFireMode")
   Bindings(120)=(Name="XboxTypeS_LeftTrigger",Command="GBA_IronsightsHold")
   Bindings(121)=(Name="XboxTypeS_RightTrigger",Command="GBA_Fire")
   Bindings(122)=(Name="XboxTypeS_DPad_Left",Command="GBA_DPad_Left_Gamepad")
   Bindings(123)=(Name="XboxTypeS_DPad_Right",Command="GBA_DPad_Right_Gamepad")
   Bindings(124)=(Name="XboxTypeS_DPad_Down",Command="GBA_DPad_Down_Gamepad")
   Bindings(125)=(Name="XboxTypeS_DPad_Up",Command="GBA_DPad_Up_Gamepad")
   Bindings(126)=(Name="XboxTypeS_Back",Command="GBA_ShowScores")
   Bindings(127)=(Name="XboxTypeS_Start",Command="GBA_ShowMenu")
   Bindings(128)=(Name="Orbis_SwipeUp",Command="GBA_TossMoney")
   Bindings(129)=(Name="Up",Command="GBA_MoveForward")
   Bindings(130)=(Name="Down",Command="GBA_Backward")
   Bindings(131)=(Name="Left",Command="GBA_TurnLeft")
   Bindings(132)=(Name="Right",Command="GBA_TurnRight")
   Bindings(133)=(Name="Enter",Command="GBA_Use")
   Bindings(134)=(Name="SpaceBar",Command="GBA_Jump")
   Bindings(135)=(Name="W",Command="GBA_MoveForward")
   Bindings(136)=(Name="S",Command="GBA_Backward")
   Bindings(137)=(Name="A",Command="GBA_StrafeLeft")
   Bindings(138)=(Name="D",Command="GBA_StrafeRight")
   Bindings(139)=(Name="E",Command="GBA_Use")
   Bindings(140)=(Name="LeftMouseButton",Command="GBA_Fire | SpectatePrevPlayer")
   Bindings(141)=(Name="MiddleMouseButton",Command="GBA_SwitchFireMode | SpectateChangeCamMode")
   Bindings(142)=(Name="RightMouseButton",Command="GBA_IronsightsToggle | SpectateNextPlayer")
   Bindings(143)=(Name="F",Command="GBA_ToggleFlashlight")
   Bindings(144)=(Name="R",Command="GBA_Reload")
   Bindings(145)=(Name="G",Command="GBA_Grenade")
   Bindings(146)=(Name="C",Command="GBA_CrouchToggle")
   Bindings(147)=(Name="Q",Command="GBA_QuickHeal")
   Bindings(148)=(Name="V",Command="GBA_TertiaryFire")
   Bindings(149)=(Name="Escape",Command="GBA_ShowMenu")
   Bindings(150)=(Name="MouseScrollUp",Command="GBA_NextWeapon")
   Bindings(151)=(Name="MouseScrollDown",Command="GBA_PrevWeapon")
   Bindings(152)=(Name="one",Command="GBA_SwitchWeapon1")
   Bindings(153)=(Name="two",Command="GBA_SwitchWeapon2")
   Bindings(154)=(Name="three",Command="GBA_SwitchWeapon3")
   Bindings(155)=(Name="four",Command="GBA_SwitchWeapon4")
   Bindings(156)=(Name="BackSpace",Command="GBA_DropWeapon")
   Bindings(157)=(Name="T",Command="GBA_Talk")
   Bindings(158)=(Name="Tab",Command="GBA_ShowScores",bIgnoreShift=True)
   Bindings(159)=(Name="Z",Command="GBA_ShowVoiceComms")
   Bindings(160)=(Name="B",Command="GBA_TossMoney")
   Bindings(161)=(Name="LeftShift",Command="GBA_Sprint")
   Bindings(162)=(Name="CapsLock",Command="GBA_VoiceChat")
   Bindings(163)=(Name="F1",Command="GBA_VoteYes")
   Bindings(164)=(Name="F2",Command="GBA_VoteNo")
   Bindings(165)=(Name="F4",Command="Playersonly")
   Bindings(166)=(Name="F5",Command="set D3DRenderDevice UsePostProcessEffects False")
   Bindings(167)=(Name="F6",Command="set D3DRenderDevice UsePostProcessEffects True")
   Bindings(168)=(Name="F7",Command="NextViewMode",bIgnoreAlt=True)
   Bindings(169)=(Name="F8",Command="PrevViewMode")
   Bindings(170)=(Name="M",Command="BasePath 0")
   Bindings(171)=(Name="N",Command="BasePath 1")
   Bindings(172)=(Name="F9",Command="viewmode wireframe",Control=True)
   Bindings(173)=(Name="F10",Command="viewmode unlit",Control=True)
   Bindings(174)=(Name="F4",Command="viewmode detaillighting",Control=True)
   Bindings(175)=(Name="F5",Command="viewmode shadercomplexity",Control=True)
   Bindings(176)=(Name="F6",Command="viewmode lit",Control=True)
   Bindings(177)=(Name="PageDown",Command="Camera ThirdPerson")
   Bindings(178)=(Name="PageUp",Command="Camera Fixed")
   Bindings(179)=(Name="Home",Command="Camera FixedTracking")
   Bindings(180)=(Name="Insert",Command="Camera FreeCam")
   Bindings(181)=(Name="P",Command="Playersonly")
   Bindings(182)=(Name="LeftBracket",Command="Slomo .2")
   Bindings(183)=(Name="RightBracket",Command="Slomo 1")
   Bindings(184)=(Name="Backslash",Command="Slomo 4")
   Bindings(185)=(Name="Subtract",Command="PreviousTrackingRange")
   Bindings(186)=(Name="Add",Command="NextTrackingRange")
   Bindings(187)=(Name="NumPadZero",Command="ToggleTracker")
   Bindings(188)=(Name="NumPadOne",Command="NextTrackingMode")
   Bindings(189)=(Name="NumPadTwo",Command="ToggleMapView")
