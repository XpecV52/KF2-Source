...
defaultproperties
{
   ...
   Bindings(115)=(Name="GBA_AltFire_Gamepad",Command="GamepadSwitchFire | OnRelease SwitchFireRelease")
   ...
   Bindings(128)=(Name="XboxTypeS_LeftShoulder",Command="GBA_Grenade")
   Bindings(129)=(Name="XboxTypeS_RightShoulder",Command="GBA_AltFire_Gamepad")
