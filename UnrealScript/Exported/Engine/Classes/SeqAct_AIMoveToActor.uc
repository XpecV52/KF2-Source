...
defaultproperties
{
   ...
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Destination",PropertyName="Destination")
   VariableLinks(2)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Look At",PropertyName="LookAt")
