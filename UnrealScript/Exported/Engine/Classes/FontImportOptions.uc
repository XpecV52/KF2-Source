...
defaultproperties
{
   Data=(FontName="Arial",Height=16.000000,bEnableAntialiasing=True,bIncludeASCIIRange=True,ForegroundColor=(R=1.000000,G=1.000000,B=1.000000,A=1.000000),TexturePageWidth=256,TexturePageMaxHeight=256,XPadding=1,YPadding=1,DistanceFieldScaleFactor=16,DistanceFieldScanRadiusScale=1.000000)
