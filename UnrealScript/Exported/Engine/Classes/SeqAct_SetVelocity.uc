...
defaultproperties
{
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Vector',LinkDesc="Velocity Dir",PropertyName="VelocityDir")
   VariableLinks(2)=(ExpectedType=Class'Engine.SeqVar_Float',LinkDesc="Velocity Mag",PropertyName="VelocityMag")
   ObjName="Set Velocity"
   ObjCategory="Actor"
   Name="Default__SeqAct_SetVelocity"
