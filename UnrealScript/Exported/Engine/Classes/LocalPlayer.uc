...
final function SetControllerId( int NewControllerId )
{
	...
	{
		LogInternal(Name @ "changing ControllerId from" @ ControllerId @ "to" @ NewControllerId,'PlayerManagement');
...
{
	LogInternal("Server authentication failed after"@MaxServerAuthRetryCount@"tries");
