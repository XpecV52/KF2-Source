...
//@zombie_ps4_begin - TODO - Orbis has a different depth bias. We need a cleaner solution for this.
						optional float InOrbisDepthBias = OrbisDecalDepthBias,
//@zombie_ps4_end
...
defaultproperties
{
   ...
   DecalLifeSpan=10.000000
   DecalDepthBias=-0.000060
   OrbisDecalDepthBias=-1.600000
   DecalBlendRange=(X=89.500000,Y=180.000000)
   CollisionType=COLLIDE_CustomDefault
   TickGroup=TG_DuringAsyncWork
   Name="Default__DecalManager"
