...
{
	LogInternal(WorldInfo.TimeSeconds @ "Self:" @ Self @ "Instigator:" @ Instigator @ GetStateName() $ "::" $ GetFuncName() @ thisPawn @ "Weapon:" @ Self,'Inventory');
	Instigator = ThisPawn;
...
reliable client function ClientGivenTo(Pawn NewOwner, bool bDoNotActivate)
{
	...
	LogInternal(WorldInfo.TimeSeconds @ "Self:" @ Self @ "Instigator:" @ Instigator @ GetStateName() $ "::" $ GetFuncName() @ NewOwner @ "Weapon:" @ Self,'Inventory');
