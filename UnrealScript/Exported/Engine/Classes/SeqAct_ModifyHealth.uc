...
{
   Momentum=500.000000
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Float',LinkDesc="Amount",PropertyName="Amount")
   VariableLinks(2)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Instigator",PropertyName="Instigator")
   ObjName="Modify Health"
   ObjCategory="Actor"
   Name="Default__SeqAct_ModifyHealth"
