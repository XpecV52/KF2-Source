...
//@zombie_ps4_begin
/** Cached cooked Orbis data to speed up iteration times. */
var		native const	UntypedBulkData_Mirror			CompressedOrbisData{FByteBulkData};
//@zombie_ps4_end
...
/** Set to true if this is VoIP data for special processing */
