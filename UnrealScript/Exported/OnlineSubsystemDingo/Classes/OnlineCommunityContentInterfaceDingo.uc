...
{
	if (ReadContentListCompleteDelegates.Find(ReadContentListCompleteDelegate) == INDEX_NONE) { ReadContentListCompleteDelegates.AddItem(ReadContentListCompleteDelegate);	};
}
...
{
	if (UploadContentCompleteDelegates.Find(UploadContentCompleteDelegate) == INDEX_NONE) { UploadContentCompleteDelegates.AddItem(UploadContentCompleteDelegate);	};
}
...
{
	if (DownloadContentCompleteDelegates.Find(DownloadContentCompleteDelegate) == INDEX_NONE) { DownloadContentCompleteDelegates.AddItem(DownloadContentCompleteDelegate);	};
}
...
{
	if (DeleteContentCompleteDelegates.Find(DeleteContentCompleteDelegate) == INDEX_NONE) { DeleteContentCompleteDelegates.AddItem(DeleteContentCompleteDelegate);	};
}
...
defaultproperties
{
   Name="Default__OnlineCommunityContentInterfaceDingo"
