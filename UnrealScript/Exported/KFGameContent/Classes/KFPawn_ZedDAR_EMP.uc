...
defaultproperties
{
   ...
   End Object
   MeleeAttackHelper=KFMeleeHelperAI'kfgamecontent.Default__KFPawn_ZedDAR_EMP:MeleeHelper_0'
   DifficultySettings=Class'kfgamecontent.KFDifficulty_DAR_EMP'
   ...
   Begin Object Class=KFAfflictionManager Name=Afflictions_0 Archetype=KFAfflictionManager'kfgamecontent.Default__KFPawn_ZedDAR:Afflictions_0'
      AfflictionClasses(0)=Class'KFGame.KFAffliction_EvilDAR_EMP'
      AfflictionClasses(1)=()
      AfflictionClasses(2)=()
      AfflictionClasses(3)=()
      AfflictionClasses(4)=()
   ...
   End Object
   AfflictionHandler=KFAfflictionManager'kfgamecontent.Default__KFPawn_ZedDAR_EMP:Afflictions_0'
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedDAR:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(22)=Class'kfgamecontent.KFSM_DAR_EMPAttack'
   ...
   End Object
   SpecialMoveHandler=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedDAR_EMP:SpecialMoveHandler_0'
   ...
   End Object
   WeaponAmbientEchoHandler=KFWeaponAmbientEchoHandler'kfgamecontent.Default__KFPawn_ZedDAR_EMP:WeaponAmbientEchoHandler_0'
   ...
   ControllerClass=Class'kfgamecontent.KFAIController_ZedDAR_EMP'
   ...
   Name="Default__KFPawn_ZedDAR_EMP"
