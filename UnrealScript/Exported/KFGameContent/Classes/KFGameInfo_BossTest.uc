...
function ReduceDamage(out int Damage, Pawn Injured, Controller InstigatedBy, vector HitLocation, out vector Momentum, class<DamageType> DamageType, Actor DamageCauser)
{
	...
	LogInternal("QA - "$Damage$"("$InDamage$")"@DamageType$" to "$VictimName$"("$Injured.Controller$","$Injured.GetTeamNum()$") by "$InstigatorName$"("$InstigatedBy$","$InstigatedBy.GetTeamNum()$"); DamageCauser: "$DamageCauser$"; FFScale: "$FriendlyFireScale);
...
defaultproperties
{
   Name="Default__KFGameInfo_BossTest"
