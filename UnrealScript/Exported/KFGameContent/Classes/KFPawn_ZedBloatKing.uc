...
defaultproperties
{
   ...
   DifficultyFartAttackTimers(0)=(X=4.000000,Y=7.000000)
   DifficultyFartAttackTimers(1)=(X=3.500000,Y=6.000000)
   DifficultyFartAttackTimers(2)=(X=3.000000,Y=5.500000)
   DifficultyFartAttackTimers(3)=(X=3.000000,Y=5.000000)
   DifficultyVarianceFartTimers(0)=(X=2.500000,Y=3.500000)
   DifficultyVarianceFartTimers(1)=(X=2.000000,Y=3.000000)
   DifficultyVarianceFartTimers(2)=(X=1.500000,Y=2.500000)
   DifficultyVarianceFartTimers(3)=(X=1.500000,Y=2.500000)
   DifficultyRageFartTimers(0)=(X=1.500000,Y=2.250000)
   DifficultyRageFartTimers(1)=(X=1.000000,Y=1.750000)
   DifficultyRageFartTimers(2)=(X=0.500000,Y=1.250000)
   DifficultyRageFartTimers(3)=(X=0.500000,Y=1.250000)
   ...
   PoopMonsterSpawnDelay=1.500000
   RageSprintSpeedMultiplier=1.500000
   ...
   DamageTypeModifiers(15)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Submachinegun',DamageScale=(0.500000))
   DamageTypeModifiers(16)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AssaultRifle',DamageScale=(0.500000))
   DamageTypeModifiers(17)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Shotgun',DamageScale=(0.400000))
   DamageTypeModifiers(18)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Handgun',DamageScale=(0.500000))
   DamageTypeModifiers(19)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Rifle',DamageScale=(0.500000))
   DamageTypeModifiers(20)=(DamageType=Class'KFGame.KFDT_Slashing')
   DamageTypeModifiers(21)=(DamageType=Class'KFGame.KFDT_Bludgeon')
   DamageTypeModifiers(22)=(DamageType=Class'KFGame.KFDT_Fire',DamageScale=(0.500000))
   DamageTypeModifiers(23)=(DamageType=Class'KFGame.KFDT_Microwave',DamageScale=(0.900000))
   DamageTypeModifiers(24)=(DamageType=Class'KFGame.KFDT_Explosive',DamageScale=(0.400000))
   DamageTypeModifiers(25)=(DamageType=Class'KFGame.KFDT_Piercing',DamageScale=(0.500000))
   DamageTypeModifiers(26)=(DamageType=Class'KFGame.KFDT_Toxic',DamageScale=(0.050000))
   DamageTypeModifiers(27)=(DamageType=Class'kfgamecontent.KFDT_Toxic_BloatKingFart',DamageScale=(0.000000))
   DamageTypeModifiers(28)=(DamageType=Class'kfgamecontent.KFDT_Toxic_BloatKingPukeMine',DamageScale=(0.000000))
   DamageTypeModifiers(29)=(DamageType=Class'kfgamecontent.KFDT_Toxic_BloatKingSubspawnExplosion',DamageScale=(0.750000))
   DamageTypeModifiers(30)=(DamageType=Class'KFGame.KFDT_Toxic_HRGHealthrower')
   DamageTypeModifiers(31)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_MicrowaveRifle',DamageScale=(0.700000))
   DamageTypeModifiers(32)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_HRGTeslauncher',DamageScale=(0.600000))
   DamageTypeModifiers(33)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Minigun',DamageScale=(0.600000))
   DamageTypeModifiers(34)=(DamageType=Class'kfgamecontent.KFDT_Toxic_MineReconstructorExplosion',DamageScale=(1.200000))
   DamageTypeModifiers(35)=(DamageType=Class'kfgamecontent.KFDT_EMP_ArcGenerator_Beam',DamageScale=(1.500000))
