...
defaultproperties
{
   ExplosionTemplate=KFGameExplosion'kfgamecontent.Default__KFSM_PlayerSiren_NormalScream:ExploTemplate0'
   Name="Default__KFSM_PlayerSiren_NormalScream"
   ObjectArchetype=KFSM_Siren_Scream'kfgamecontent.Default__KFSM_Siren_Scream'
}
