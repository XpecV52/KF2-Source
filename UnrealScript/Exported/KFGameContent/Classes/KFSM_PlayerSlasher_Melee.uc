...
defaultproperties
{
   Attacks(0)=(Anims=("Player_Light_Atk_V1","Player_Light_Atk_V1","Player_Light_Atk_V2","Player_Light_Atk_V3"),Stance=EAS_UpperBody)
   Attacks(1)=(Anims=("Player_Lunge_Combo"),Type=PZA_Sprinting)
   ...
   Name="Default__KFSM_PlayerSlasher_Melee"
