...
defaultproperties
{
   ...
   WeaponUpgrades(3)=(Stats=((Stat=EWUS_Damage0,Scale=2.100000),(Stat=EWUS_Damage1,Scale=2.100000),(Add=3)))
   WeaponUpgrades(4)=(Stats=((Stat=EWUS_Damage0,Scale=2.300000),(Stat=EWUS_Damage1,Scale=2.300000),(Add=4)))
