...
defaultproperties
{
   ...
   DamageTypeModifiers(15)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Submachinegun',DamageScale=(0.620000))
   DamageTypeModifiers(16)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AssaultRifle',DamageScale=(0.620000))
   ...
   DamageTypeModifiers(20)=(DamageType=Class'KFGame.KFDT_Slashing',DamageScale=(0.620000))
   DamageTypeModifiers(21)=(DamageType=Class'KFGame.KFDT_Bludgeon',DamageScale=(0.620000))
   DamageTypeModifiers(22)=(DamageType=Class'KFGame.KFDT_Fire',DamageScale=(0.370000))
   DamageTypeModifiers(23)=(DamageType=Class'KFGame.KFDT_Microwave')
   ...
   DamageTypeModifiers(26)=(DamageType=Class'KFGame.KFDT_Toxic',DamageScale=(0.310000))
   DamageTypeModifiers(27)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_MicrowaveRifle',DamageScale=(0.800000))
   DamageTypeModifiers(28)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_HRGTeslauncher',DamageScale=(0.500000))
   DamageTypeModifiers(29)=(DamageType=Class'kfgamecontent.KFDT_Fire_HRGTeslauncherDoT',DamageScale=(0.500000))
