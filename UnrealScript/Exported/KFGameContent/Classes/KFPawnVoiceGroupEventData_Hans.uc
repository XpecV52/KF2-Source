...
defaultproperties
{
   ...
   Events(8)=(EventID=8,Priority=1,Chance=0.900000,CoolDownTime=0.000000,Delay=1.000000,bCanBeMinimized=0,bCanInterruptEqualPriority=True)
   Events(9)=(EventID=9,Priority=2,Chance=1.000000,CoolDownTime=1.000000,bCanBeMinimized=0)
   ...
   Events(20)=(EventID=20,Priority=1,Chance=1.000000,CoolDownTime=0.000000,bCanBeMinimized=0)
   ...
   Events(23)=(EventID=23,Priority=1,Chance=1.000000,bCanBeMinimized=0)
   ...
   Events(26)=(EventID=26,Priority=2,Chance=1.000000,bCanBeMinimized=0)
   Events(27)=(EventID=27,Priority=1,Chance=0.900000,CoolDownTime=0.000000,bCanBeMinimized=0,bCanInterruptEqualPriority=True)
   Events(28)=(EventID=28,Priority=2,Chance=1.000000,CoolDownTime=4.000000,bCanBeMinimized=0,bCanInterruptEqualPriority=True)
   Events(29)=(EventID=29,Priority=1,Chance=1.000000,bCanBeMinimized=0)
   Events(30)=(EventID=30,Priority=1,Chance=1.000000,CoolDownTime=0.000000,bCanBeMinimized=0)
