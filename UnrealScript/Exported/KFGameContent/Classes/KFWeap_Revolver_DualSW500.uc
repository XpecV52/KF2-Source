...
defaultproperties
{
   ...
   WeaponUpgrades(1)=(Stats=((Stat=EWUS_Damage0,Scale=1.150000),(Stat=EWUS_Damage1,Scale=1.150000),(Add=2)))
   ...
   InstantHitDamageTypes(1)=Class'kfgamecontent.KFDT_Ballistic_SW500_Dual'
