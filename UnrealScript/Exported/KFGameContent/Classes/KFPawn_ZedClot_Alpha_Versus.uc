...
defaultproperties
{
   ...
   SpecialMoveCooldowns(3)=(CoolDownTime=1.500000,SMHandle=SM_PlayerZedSpecial1,SpecialMoveIcon=Texture2D'ZED_Clot_UI.ZED-VS_Icons_AlphaClot-Enrage',NameLocalizationKey="Rally",GBA_Name="GBA_TertiaryFire")
   SpecialMoveCooldowns(4)=(CoolDownTime=1.000000,SMHandle=SM_Jump,SpecialMoveIcon=Texture2D'ZED_Clot_UI.ZED-VS_Icons_AlphaClot-Jump',GBA_Name="GBA_Jump",bShowOnHud=False)
   ...
   HitZones(16)=()
   HitZones(17)=()
   Begin Object Class=KFPawnAfflictions Name=Afflictions_0 Archetype=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedClot_Alpha:Afflictions_0'
      FireFullyCharredDuration=2.500000
      FireCharPercentThreshhold=0.250000
      Name="Afflictions_0"
      ObjectArchetype=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedClot_Alpha:Afflictions_0'
   End Object
   AfflictionHandler=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedClot_Alpha_Versus:Afflictions_0'
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedClot_Alpha:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(22)=Class'kfgamecontent.KFSM_PlayerAlpha_Melee'
      SpecialMoveClasses(23)=Class'kfgamecontent.KFSM_PlayerAlpha_Grab'
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerAlpha_Rally'
