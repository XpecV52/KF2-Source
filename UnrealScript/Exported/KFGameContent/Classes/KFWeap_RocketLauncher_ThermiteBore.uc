...
defaultproperties
{
   ...
   IronSightPosition=(X=10.000000,Y=-0.150000,Z=0.700000)
   ...
   BonesToLockOnEmpty(0)="RW_Exhaust"
   BonesToLockOnEmpty(1)="RW_BoltAssembly1"
   BonesToLockOnEmpty(2)="RW_BoltAssembly2"
   BonesToLockOnEmpty(3)="RW_BoltAssembly3"
   WeaponFireSnd(0)=(DefaultCue=AkEvent'WW_WEP_Thermite.Play_WEP_Thermite_Thermite_Shoot_3P',FirstPersonCue=AkEvent'WW_WEP_Thermite.Play_WEP_Thermite_Thermite_Shoot_1P')
   WeaponDryFireSnd(0)=AkEvent'WW_WEP_Thermite.Play_WEP_Thermite_Dry_Fire'
   ...
   End Object
   MeleeAttackHelper=KFMeleeHelperWeapon'kfgamecontent.Default__KFWeap_RocketLauncher_ThermiteBore:MeleeHelper_0'
   ...
   WeaponFireTypes(3)=()
   WeaponFireTypes(4)=()
   WeaponProjectiles(0)=Class'kfgamecontent.KFProj_Rocket_ThermiteBore'
   FireInterval(0)=0.800000
   FireInterval(1)=()
   FireInterval(2)=()
   FireInterval(3)=()
   FireInterval(4)=()
   ...
   InstantHitDamageTypes(0)=Class'kfgamecontent.KFDT_Ballistic_ThermiteBoreImpact'
   InstantHitDamageTypes(1)=()
   InstantHitDamageTypes(2)=None
   InstantHitDamageTypes(3)=Class'kfgamecontent.KFDT_Bludgeon_ThermiteBore'
   ...
   Name="Default__KFWeap_RocketLauncher_ThermiteBore"
