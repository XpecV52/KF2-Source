...
defaultproperties
{
   ...
   WeaponUpgrades(1)=(Stats=((Stat=EWUS_Damage0,Scale=1.600000),(Add=1)))
   WeaponUpgrades(2)=(Stats=((Stat=EWUS_Damage0,Scale=1.900000),(Add=2)))
   WeaponUpgrades(3)=(Stats=((Stat=EWUS_Damage0,Scale=2.300000),(Add=3)))
   WeaponUpgrades(4)=(Stats=((Stat=EWUS_Damage0,Scale=2.500000),(Add=4)))
