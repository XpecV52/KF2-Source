...
defaultproperties
{
   ...
   Events(25)=(EventID=25,Priority=1,CoolDownTime=0.000000,bCanBeMinimized=0)
   Events(26)=(EventID=26,Priority=1,Chance=1.000000,CoolDownTime=0.000000,bCanBeMinimized=0,bCanInterruptEqualPriority=True)
   Events(27)=(EventID=27,Priority=1,Chance=1.000000,CoolDownTime=0.000000,bCanBeMinimized=0)
   Events(28)=(EventID=28,Priority=1,Chance=1.000000,CoolDownTime=0.000000,bCanBeMinimized=0)
