...
defaultproperties
{
   ...
   End Object
   MeleeAttackHelper=KFMeleeHelperAI'kfgamecontent.Default__KFPawn_ZedClot_Alpha:MeleeHelper_0'
   XPValues(0)=8.000000
   ...
   End Object
   AfflictionHandler=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedClot_Alpha:Afflictions_0'
   InstantIncaps(0)=(head=40,Torso=50,Leg=50,Arm=50,LowHealthBonus=10)
   InstantIncaps(1)=(head=43,Torso=45,Leg=50,Arm=50,LowHealthBonus=10)
   InstantIncaps(2)=(head=43,Torso=43,Arm=43,LowHealthBonus=10,Cooldown=0.500000)
   InstantIncaps(3)=(Leg=43,LowHealthBonus=10,Cooldown=0.500000)
   InstantIncaps(4)=(head=20,Torso=20,Leg=20,Arm=20,LowHealthBonus=10,Cooldown=0.000000)
   InstantIncaps(5)=(head=98,Torso=98,Leg=98,Arm=98,LowHealthBonus=10,Cooldown=0.000000)
   StackingIncaps(1)=(Threshhold=0.900000,Cooldown=7.000000,DissipationRate=0.070000)
   StackingIncaps(2)=(Threshhold=1.000000,Duration=2.000000,Cooldown=10.000000)
   StackingIncaps(3)=(Threshhold=1.000000,Duration=2.000000,Cooldown=10.000000)
   StackingIncaps(4)=()
   StackingIncaps(5)=()
   ...
   End Object
   SpecialMoveHandler=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedClot_Alpha:SpecialMoveHandler_0'
   ...
   End Object
   WeaponAmbientEchoHandler=KFWeaponAmbientEchoHandler'kfgamecontent.Default__KFPawn_ZedClot_Alpha:WeaponAmbientEchoHandler_0'
   ...
   ControllerClass=Class'kfgamecontent.KFAIController_ZedClot_Alpha'
