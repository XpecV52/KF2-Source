...
defaultproperties
{
   ...
   Suicidal=(HealthMod=1.100000,HeadHealthMod=1.050000,DamageMod=1.125000,SoloDamageMod=0.500000,BlockSettings=(Chance=0.200000,Duration=1.250000,MaxBlocks=4.000000,Cooldown=4.500000,DamagedHealthPctToTrigger=0.050000,MeleeDamageModifier=0.900000,DamageModifier=0.900000,AfflictionModifier=0.200000,SoloChanceMultiplier=0.100000),RallySettings=(TakenDamageModifier=0.900000,DealtDamageModifier=1.200000))
   HellOnEarth=(HealthMod=1.200000,HeadHealthMod=1.100000,DamageMod=1.250000,SoloDamageMod=0.650000,BlockSettings=(Chance=0.300000,Duration=1.250000,MaxBlocks=5.000000,Cooldown=4.500000,DamagedHealthPctToTrigger=0.050000,MeleeDamageModifier=0.900000,DamageModifier=0.900000,AfflictionModifier=0.200000,SoloChanceMultiplier=0.200000),RallySettings=(TakenDamageModifier=0.900000,DealtDamageModifier=1.200000))
