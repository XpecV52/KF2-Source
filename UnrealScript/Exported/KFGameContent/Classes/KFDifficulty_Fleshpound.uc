...
defaultproperties
{
   Normal=(HealthMod=0.750000,HeadHealthMod=0.750000,DamageMod=0.310000,SoloDamageMod=0.310000,BlockSettings=(Duration=1.250000,MaxBlocks=2.000000,Cooldown=4.500000,DamagedHealthPctToTrigger=0.050000,MeleeDamageModifier=0.900000,DamageModifier=0.900000,AfflictionModifier=0.200000,SoloChanceMultiplier=0.100000),RallySettings=(bCanRally=False))
