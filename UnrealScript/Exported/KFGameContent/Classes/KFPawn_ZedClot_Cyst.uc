...
defaultproperties
{
   ...
   DamageTypeModifiers(2)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AssaultRifle',DamageScale=(2.500000))
   ...
   DamageTypeModifiers(12)=(DamageType=Class'KFGame.KFDT_Toxic',DamageScale=(0.900000))
   ...
   IncapSettings(5)=(Vulnerability=(2.000000,2.000000,1.000000,1.000000,1.000000))
   ...
   IncapSettings(9)=(Duration=4.500000,Cooldown=8.000000,Vulnerability=(0.000000))
