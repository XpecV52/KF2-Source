...
defaultproperties
{
   ...
   End Object
   AfflictionHandler=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedClot_Cyst:Afflictions_0'
   ...
   InstantIncaps(3)=(Leg=26,LowHealthBonus=10,Cooldown=0.500000)
   ...
   StackingIncaps(2)=(Threshhold=1.000000,Duration=4.500000,Cooldown=8.000000)
   StackingIncaps(3)=(Threshhold=1.000000,Duration=4.500000,Cooldown=8.000000)
   StackingIncaps(4)=()
   StackingIncaps(5)=()
