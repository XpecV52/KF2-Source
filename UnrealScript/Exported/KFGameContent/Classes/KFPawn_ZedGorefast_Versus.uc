...
defaultproperties
{
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedGorefast:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee'
      SpecialMoveClasses(25)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee2'
      SpecialMoveClasses(26)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee3'
      SpecialMoveClasses(27)=Class'kfgamecontent.KFSM_PlayerGorefast_Block'
