...
defaultproperties
{
   ...
   VulnerableDamageTypes(16)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AR15',DamageScale=1.250000)
   VulnerableDamageTypes(17)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Rem1858',DamageScale=1.250000)
   ...
   SpecialMoveCooldowns(4)=(CoolDownTime=1.000000,SMHandle=SM_Jump,SpecialMoveIcon=Texture2D'ZED_Gorefast_UI.ZED-VS_Icons_Gorefast-Jump',GBA_Name="GBA_Jump",bShowOnHud=False)
   ...
   HitZones(16)=()
   HitZones(17)=()
   Begin Object Class=KFPawnAfflictions Name=Afflictions_0 Archetype=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedGorefast:Afflictions_0'
      FireFullyCharredDuration=2.500000
      FireCharPercentThreshhold=0.250000
      Name="Afflictions_0"
      ObjectArchetype=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedGorefast:Afflictions_0'
   End Object
   AfflictionHandler=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedGorefast_Versus:Afflictions_0'
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedGorefast:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(22)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee'
      SpecialMoveClasses(23)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee2'
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee3'
