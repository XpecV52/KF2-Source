...
defaultproperties
{
   ...
   DamageTypeModifiers(14)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Shotgun',DamageScale=(0.600000))
   DamageTypeModifiers(15)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Handgun',DamageScale=(0.550000))
   DamageTypeModifiers(16)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Rifle',DamageScale=(0.700000))
   DamageTypeModifiers(17)=(DamageType=Class'KFGame.KFDT_Slashing',DamageScale=(0.400000))
   DamageTypeModifiers(18)=(DamageType=Class'KFGame.KFDT_Bludgeon',DamageScale=(0.400000))
   DamageTypeModifiers(19)=(DamageType=Class'KFGame.KFDT_Fire',DamageScale=(0.300000))
   DamageTypeModifiers(20)=(DamageType=Class'kfgamecontent.KFDT_Microwave',DamageScale=(0.750000))
   ...
   DamageTypeModifiers(23)=(DamageType=Class'KFGame.KFDT_Toxic')
   DamageTypeModifiers(24)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AR15')
   DamageTypeModifiers(25)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_MB500',DamageScale=(1.200000))
   DamageTypeModifiers(26)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Rem1858',DamageScale=(0.900000))
   DamageTypeModifiers(27)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Colt1911',DamageScale=(0.800000))
   ...
   DamageTypeModifiers(30)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Winchester',DamageScale=(0.900000))
   DamageTypeModifiers(31)=(DamageType=Class'kfgamecontent.KFDT_Fire_CaulkBurn',DamageScale=(0.700000))
   ...
   DamageTypeModifiers(35)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_DragonsBreath',DamageScale=(1.300000))
   MinBlockFOV=1.000000
   BlockingDamageModifier=0.050000
   ...
   SpecialMoveCooldowns(3)=(CoolDownTime=1.700000,SMHandle=SM_PlayerZedSpecial1,SpecialMoveIcon=Texture2D'ZED_Gorefast_UI.ZED-VS_Icons_Gorefast-BladeSwing',NameLocalizationKey="Spin",GBA_Name="GBA_TertiaryFire")
   ...
   SpecialMoveCooldowns(5)=(CoolDownTime=1.000000,SMHandle=SM_Jump,SpecialMoveIcon=Texture2D'ZED_Gorefast_UI.ZED-VS_Icons_Gorefast-Jump',GBA_Name="GBA_Jump",bShowOnHud=False)
   ...
   IncapSettings(9)=(Duration=2.000000,Cooldown=5.000000,Vulnerability=(0.000000))
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedGorefast:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(21)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee'
      SpecialMoveClasses(22)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee2'
      SpecialMoveClasses(23)=Class'kfgamecontent.KFSM_PlayerGorefast_Melee3'
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerGorefast_Block'
