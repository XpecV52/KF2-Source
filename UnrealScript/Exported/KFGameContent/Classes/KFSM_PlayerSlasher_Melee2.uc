...
//=============================================================================
class KFSM_PlayerSlasher_Melee2 extends KFSM_PlayerMeleeBase;

defaultproperties
{
   Attacks(0)=(Anims=("Player_Heavy_Atk"))
   Attacks(1)=(Anims=("Player_Lunge_Atk"),Type=PZA_Sprinting)
   Attacks(2)=(Anims=("Player_Jump_Atk"),Type=PZA_Jumping,bForceDisableRootMotion=True)
   Name="Default__KFSM_PlayerSlasher_Melee2"
