...
function Pushed()
{
	...
	if( ! class'Engine'.static.GetEngine().bDisableAILogging) {AILog_Internal("Beginning Tesla Blast " $ Enemy,'Command_Matriarch_TeslaBlast',);};
...
defaultproperties
{
   SpecialMoveClass=Class'kfgamecontent.KFSM_Matriarch_TeslaBlast'
   Name="Default__AICommand_Matriarch_TeslaBlast"
