...
defaultproperties
{
   ...
   SetEvents(3)=(EventDifficulty=2,GameLength=1,SpawnReplacementList=((SpawnEntry=AT_AlphaClot,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.050000),(SpawnEntry=AT_SlasherClot,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.100000),(SpawnEntry=AT_GoreFast,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.100000),(SpawnEntry=AT_Crawler,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.050000),(SpawnEntry=AT_Stalker,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.050000),(SpawnEntry=AT_Scrake,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpound'),PercentChance=0.900000),(SpawnEntry=AT_Bloat,NewClass=(Class'kfgamecontent.KFPawn_ZedFleshpoundMini'),PercentChance=0.650000)),BossSpawnReplacementList=((NewClass=Class'kfgamecontent.KFPawn_ZedFleshpoundKing'),(SpawnEntry=BAT_Patriarch,NewClass=Class'kfgamecontent.KFPawn_ZedFleshpoundKing'),(SpawnEntry=BAT_KingBloat,NewClass=Class'kfgamecontent.KFPawn_ZedFleshpoundKing')),WaveAICountScale=(0.550000,0.550000,0.550000,0.550000,0.550000,0.550000),WeeklyOutbreakId=4)
