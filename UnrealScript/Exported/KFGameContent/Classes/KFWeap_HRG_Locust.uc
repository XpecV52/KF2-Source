...
defaultproperties
{
   ...
   End Object
   MeleeAttackHelper=KFMeleeHelperWeapon'kfgamecontent.Default__KFWeap_HRG_Locust:MeleeHelper_0'
   maxRecoilPitch=400
   minRecoilPitch=275
   maxRecoilYaw=200
   minRecoilYaw=-200
   ...
   WeaponFireTypes(3)=()
   WeaponFireTypes(4)=()
   WeaponProjectiles(0)=Class'kfgamecontent.KFProj_HRG_Locust'
   WeaponProjectiles(1)=Class'kfgamecontent.KFProj_HRG_Locust'
   ...
   InstantHitDamageTypes(0)=Class'kfgamecontent.KFDT_Ballistic_HRG_Locust'
   InstantHitDamageTypes(1)=Class'kfgamecontent.KFDT_Ballistic_HRG_Locust'
   InstantHitDamageTypes(2)=None
   InstantHitDamageTypes(3)=Class'kfgamecontent.KFDT_Bludgeon_HRG_Locust'
   ...
   Name="Default__KFWeap_HRG_Locust"
