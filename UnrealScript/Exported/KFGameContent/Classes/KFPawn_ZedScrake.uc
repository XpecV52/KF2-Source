...
defaultproperties
{
   ...
   DamageTypeModifiers(8)=(DamageType=Class'KFGame.KFDT_Microwave',DamageScale=(1.100000))
   ...
   DamageTypeModifiers(14)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_HRGTeslauncher',DamageScale=(0.600000))
   DamageTypeModifiers(15)=(DamageType=Class'kfgamecontent.KFDT_Fire_HRGTeslauncherDoT',DamageScale=(0.600000))
   ...
   IncapSettings(5)=(Duration=1.550000,Cooldown=5.000000,Vulnerability=(0.500000,1.000000,0.500000,0.500000,0.500000))
