...
defaultproperties
{
   PlayerZedWaitingCameraClass=Class'kfgamecontent.KFPlayerZedWaitingCamera'
   PlayerZedSuicideCameraClass=Class'kfgamecontent.KFPlayerZedSuicideCamera'
   ThirdPersonCameraClass=Class'kfgamecontent.KFThirdPersonCamera_Versus'
   Name="Default__KFPlayerCamera_Versus"
   ObjectArchetype=KFPlayerCamera'KFGame.Default__KFPlayerCamera'
}
