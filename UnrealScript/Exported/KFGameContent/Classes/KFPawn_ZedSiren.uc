...
defaultproperties
{
   ...
   Begin Object Class=KFPawnAfflictions Name=Afflictions_0 Archetype=KFPawnAfflictions'KFGame.Default__KFPawn_Monster:Afflictions_0'
      InstantAffl(0)=(head=50,Torso=80,Leg=80,Arm=80,Special=50,LowHealthBonus=10,Cooldown=9.000000)
      InstantAffl(1)=(head=44,Torso=50,Leg=44,Arm=50,Special=43,LowHealthBonus=10,Cooldown=3.000000)
      InstantAffl(2)=(head=44,Torso=50,Arm=50,LowHealthBonus=10)
      InstantAffl(3)=(Leg=44,LowHealthBonus=10)
      InstantAffl(4)=(head=23,Torso=29,Leg=29,Arm=29,LowHealthBonus=10,Cooldown=0.350000)
      InstantAffl(5)=(head=105,Torso=105,Leg=105,Arm=105,LowHealthBonus=10,Cooldown=0.500000)
   ...
   End Object
   AfflictionHandler=KFPawnAfflictions'kfgamecontent.Default__KFPawn_ZedSiren:Afflictions_0'
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'KFGame.Default__KFPawn_Monster:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(16)=Class'kfgamecontent.KFSM_Siren_Scream'
