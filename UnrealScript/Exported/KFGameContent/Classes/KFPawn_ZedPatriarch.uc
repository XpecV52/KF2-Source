...
defaultproperties
{
   ...
   Begin Object Class=KFPawnAfflictions_Patriarch Name=Afflictions_0
      ...
      InstantAffl(2)=(head=79,Torso=130,Arm=130,Special=20,LowHealthBonus=10,Cooldown=8.000000)
      ...
      StackingAffl(0)=(Threshhold=1.150000,Duration=2.250000,Cooldown=12.000000,DissipationRate=0.500000)
      ...
      StackingAffl(4)=(Duration=2.000000,Cooldown=12.000000,DissipationRate=0.500000)
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'KFGame.Default__KFPawn_MonsterBoss:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(11)=Class'kfgamecontent.KFSM_Patriarch_Taunt'
      SpecialMoveClasses(12)=Class'KFGame.KFSM_Zed_WalkingTaunt'
      SpecialMoveClasses(13)=None
      SpecialMoveClasses(14)=None
      SpecialMoveClasses(15)=Class'kfgamecontent.KFSM_Patriarch_Heal'
      SpecialMoveClasses(16)=Class'kfgamecontent.KFSM_Patriarch_MortarAttack'
      SpecialMoveClasses(17)=Class'kfgamecontent.KFSM_Patriarch_MissileAttack'
      SpecialMoveClasses(18)=Class'kfgamecontent.KFSM_Patriarch_MinigunBarrage'
