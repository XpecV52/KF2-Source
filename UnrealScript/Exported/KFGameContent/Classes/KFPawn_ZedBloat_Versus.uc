...
defaultproperties
{
   ...
   DamageTypeModifiers(15)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AssaultRifle',DamageScale=(0.750000))
   ...
   DamageTypeModifiers(19)=(DamageType=Class'KFGame.KFDT_Slashing',DamageScale=(0.900000))
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedBloat:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerBloat_Melee2'
      SpecialMoveClasses(25)=Class'kfgamecontent.KFSM_PlayerBloat_PukeMineAttack'
      SpecialMoveClasses(26)=Class'kfgamecontent.KFSM_PlayerBloat_Melee'
      SpecialMoveClasses(27)=Class'kfgamecontent.KFSM_PlayerBloat_Block'
