...
defaultproperties
{
   ...
   IronSightPosition=(X=9.500000,Y=-0.290000,Z=0.000000)
   ...
   WeaponUpgrades(2)=(Stats=((Stat=EWUS_Damage0,Scale=1.500000),(Add=2)))
   WeaponUpgrades(3)=(Stats=((Stat=EWUS_Damage0,Scale=1.750000),(Add=3)))
   WeaponUpgrades(4)=(Stats=((Stat=EWUS_Damage0,Scale=2.000000),(Add=4)))
