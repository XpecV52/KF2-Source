...
defaultproperties
{
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedFleshpound:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(24)=Class'kfgamecontent.KFSM_PlayerFleshpound_Melee'
      SpecialMoveClasses(25)=Class'kfgamecontent.KFSM_PlayerFleshpound_Melee2'
      SpecialMoveClasses(26)=Class'kfgamecontent.KFSM_PlayerFleshpound_Rage'
      SpecialMoveClasses(27)=Class'kfgamecontent.KFSM_PlayerFleshpound_Block'
