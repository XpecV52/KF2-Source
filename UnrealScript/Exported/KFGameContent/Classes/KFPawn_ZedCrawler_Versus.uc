...
defaultproperties
{
   ...
   DamageTypeModifiers(20)=(DamageType=Class'KFGame.KFDT_Microwave',DamageScale=(0.350000))
   ...
   DamageTypeModifiers(24)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_AR15',DamageScale=(1.200000))
   DamageTypeModifiers(25)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_MB500',DamageScale=(0.500000))
   DamageTypeModifiers(26)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Rem1858',DamageScale=(0.750000))
   DamageTypeModifiers(27)=(DamageType=Class'kfgamecontent.KFDT_Ballistic_Colt1911',DamageScale=(0.650000))
   ...
   SpecialMoveCooldowns(0)=(CoolDownTime=0.650000,SMHandle=SM_PlayerZedMove_LMB,SpecialMoveIcon=Texture2D'ZED_Crawler_UI.ZED-VS_Icons_Crawler-LightLeap',NameLocalizationKey="Light")
   SpecialMoveCooldowns(1)=(CoolDownTime=1.000000,SMHandle=SM_PlayerZedMove_RMB,SpecialMoveIcon=Texture2D'ZED_Crawler_UI.ZED-VS_Icons_Crawler-HeavyLeap',NameLocalizationKey="Heavy")
   ...
   Begin Object Class=AkComponent Name=SprintAkComponent0 Archetype=AkComponent'kfgamecontent.Default__KFPawn_ZedCrawler:SprintAkComponent0'
      BoneName="Dummy"
      bStopWhenOwnerDestroyed=True
      bForceOcclusionUpdateInterval=True
      OcclusionUpdateInterval=0.200000
      Name="SprintAkComponent0"
      ObjectArchetype=AkComponent'kfgamecontent.Default__KFPawn_ZedCrawler:SprintAkComponent0'
   End Object
   SprintAkComponent=SprintAkComponent0
   Begin Object Class=AkComponent Name=HeadshotAkComponent0 Archetype=AkComponent'kfgamecontent.Default__KFPawn_ZedCrawler:HeadshotAkComponent0'
      Name="HeadshotAkComponent0"
      ObjectArchetype=AkComponent'kfgamecontent.Default__KFPawn_ZedCrawler:HeadshotAkComponent0'
   End Object
   ...
   Begin Object Class=KFSpecialMoveHandler Name=SpecialMoveHandler_0 Archetype=KFSpecialMoveHandler'kfgamecontent.Default__KFPawn_ZedCrawler:SpecialMoveHandler_0'
      ...
      SpecialMoveClasses(25)=Class'kfgamecontent.KFSM_PlayerCrawler_Melee'
      SpecialMoveClasses(26)=Class'kfgamecontent.KFSM_PlayerCrawler_Melee2'
      SpecialMoveClasses(27)=None
      SpecialMoveClasses(28)=None
      SpecialMoveClasses(29)=None
      SpecialMoveClasses(30)=Class'kfgamecontent.KFSM_PlayerCrawler_Suicide'
