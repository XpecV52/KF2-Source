package tripwire.widgets
{
    ...
    import tripwire.controls.ScoreboardLineRenderer;
    import tripwire.controls.ScoreboardScrollingList;
    ...
    public class ScoreboardWidget extends TripContainer
    {
        ...
        {
            this.playerText.text = param1.playerText;
            this.doshText.text = param1.doshText;
            this.killsText.text = param1.killsText;
            this.assistsText.text = param1.assistsText;
            this.pingText.text = param1.pingText;
        }
