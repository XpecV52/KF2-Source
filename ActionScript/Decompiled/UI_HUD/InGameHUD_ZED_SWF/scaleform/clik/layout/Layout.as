    ...
    public class Layout extends Sprite
    {
        ...
        public function reflow() : void
        {
            ...
            while(_loc1_ < this._managedSprites.length)
            {
                ...
                _loc9_ = (_loc8_ = _loc3_.relativeToH) != null ? this._parent.getChildByName(_loc8_) as Sprite : null;
                _loc11_ = (_loc10_ = _loc3_.relativeToV) != null ? this._parent.getChildByName(_loc10_) as Sprite : null;
        ...
        protected function calculateOffsets(param1:Sprite) : void
        {
            ...
            var _loc5_:String;
            var _loc6_:Sprite = (_loc5_ = _loc2_.relativeToH) != null ? this._parent.getChildByName(_loc5_) as Sprite : null;
            var _loc7_:String;
            var _loc8_:Sprite = (_loc7_ = _loc2_.relativeToV) != null ? this._parent.getChildByName(_loc7_) as Sprite : null;
            if(_loc2_.offsetH == -1)
            {
