    ...
    public class TripLayout extends Layout
    {
        ...
        override public function reflow() : void
        {
            ...
            while(_loc1_ < _managedSprites.length)
            {
                ...
                _loc9_ = (_loc8_ = _loc3_.relativeToH) != null ? _parent.getChildByName(_loc8_) as Sprite : null;
                if((_loc11_ = (_loc10_ = _loc3_.relativeToV) != null ? _parent.getChildByName(_loc10_) as Sprite : null) == null)
                {
