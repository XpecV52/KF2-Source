package tripwire.controls
{
    ...
    public class PlayerChatScrollingList extends ScrollingList
    {
        ...
        public var renderer:PlayerChatLineRenderer;
        ...
        override protected function drawLayout() : void
        {
            ...
            while(_loc7_ < _loc1_)
            {
                (_loc8_ = getRendererAt(_loc1_ - 1 - _loc7_)).x = _loc4_;
        ...
        override protected function handleMouseWheel(param1:MouseEvent) : void
        {
            ...
            {
                scrollBar.position += (param1.delta > 0 ? 1 : -1) * 1;
            }
        }
        
        public function setShowHistory(param1:Boolean) : *
        {
            var _loc2_:PlayerChatLineRenderer = null;
            if(scrollBar)
            {
