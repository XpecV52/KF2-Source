package
{
    ...
    public dynamic class GameSettomgsContainerMC extends OptionsGameSettingsMenu
    {
        ...
        {
            super();
            this.__setProp_crosshairCheckBox_GameSettomgsContainerMC_crosshairCheckBox_0();
            this.__setProp_hideBossHealthBarCheckBox_GameSettomgsContainerMC_crosshairCheckBox_0();
            ...
            this.__setProp_enableClassicPlayerInfoCheckbox_GameSettomgsContainerMC_classicWeaponSelectCheckBox_0();
        ...
        function __setProp_crosshairCheckBox_GameSettomgsContainerMC_crosshairCheckBox_0() : *
        {
            try
            {
        ...
        function __setProp_hideBossHealthBarCheckBox_GameSettomgsContainerMC_crosshairCheckBox_0() : *
        {
            try
            {
                hideBossHealthBarCheckBox["componentInspectorSetting"] = true;
            }
            catch(e:Error)
            {
            }
            hideBossHealthBarCheckBox.autoSize = "none";
            hideBossHealthBarCheckBox.data = "";
            hideBossHealthBarCheckBox.enabled = true;
            hideBossHealthBarCheckBox.enableInitCallback = false;
            hideBossHealthBarCheckBox.focusable = true;
            hideBossHealthBarCheckBox.label = "Music Vocals";
            hideBossHealthBarCheckBox.selected = false;
            hideBossHealthBarCheckBox.visible = true;
            try
            {
                hideBossHealthBarCheckBox["componentInspectorSetting"] = false;
            }
            catch(e:Error)
            {
            }
        ...
        function __setProp_autoTurnOffCheckBox_GameSettomgsContainerMC_crosshairCheckBox_0() : *
        {
            try
            {
                autoTurnOffCheckBox["componentInspectorSetting"] = true;
            }
            catch(e:Error)
            {
            }
            autoTurnOffCheckBox.autoSize = "none";
            autoTurnOffCheckBox.data = "";
            autoTurnOffCheckBox.enabled = true;
            autoTurnOffCheckBox.enableInitCallback = false;
            autoTurnOffCheckBox.focusable = true;
            autoTurnOffCheckBox.label = "Music Vocals";
            autoTurnOffCheckBox.selected = false;
            autoTurnOffCheckBox.visible = true;
            try
            {
                autoTurnOffCheckBox["componentInspectorSetting"] = false;
            }
            catch(e:Error)
            {
            }
        ...
        function __setProp_classicWeaponSelectCheckBox_GameSettomgsContainerMC_classicWeaponSelectCheckBox_0() : *
        {
            try
            {
        ...
        function __setProp_showWelderInInvCheckBox_GameSettomgsContainerMC_classicWeaponSelectCheckBox_0() : *
        {
            try
            {
                showWelderInInvCheckBox["componentInspectorSetting"] = true;
            }
            catch(e:Error)
            {
            }
            showWelderInInvCheckBox.autoSize = "none";
            showWelderInInvCheckBox.data = "";
            showWelderInInvCheckBox.enabled = true;
            showWelderInInvCheckBox.enableInitCallback = false;
            showWelderInInvCheckBox.focusable = true;
            showWelderInInvCheckBox.label = "Music Vocals";
            showWelderInInvCheckBox.selected = false;
            showWelderInInvCheckBox.visible = true;
            try
            {
                showWelderInInvCheckBox["componentInspectorSetting"] = false;
            }
            catch(e:Error)
            {
            }
        ...
        function __setProp_disableRemoteHeadshotEffectsCheckBox_GameSettomgsContainerMC_classicWeaponSelectCheckBox_0() : *
        {
            try
            {
        ...
        function __setProp_enableClassicPlayerInfoCheckbox_GameSettomgsContainerMC_classicWeaponSelectCheckBox_0() : *
        {
            try
            {
                enableClassicPlayerInfoCheckbox["componentInspectorSetting"] = true;
            }
            catch(e:Error)
            {
            }
            enableClassicPlayerInfoCheckbox.autoSize = "none";
            enableClassicPlayerInfoCheckbox.data = "";
            enableClassicPlayerInfoCheckbox.enabled = true;
            enableClassicPlayerInfoCheckbox.enableInitCallback = false;
            enableClassicPlayerInfoCheckbox.focusable = true;
            enableClassicPlayerInfoCheckbox.label = "Music Vocals";
            enableClassicPlayerInfoCheckbox.selected = false;
            enableClassicPlayerInfoCheckbox.visible = true;
            try
            {
        ...
        function __setProp_killTickerCheckBox_GameSettomgsContainerMC_killTickerCheckBox_0() : *
        {
            try
            {
        ...
        function __setProp_useAltAimOnDualCheckBox_GameSettomgsContainerMC_killTickerCheckBox_0() : *
        {
            try
            {
                useAltAimOnDualCheckBox["componentInspectorSetting"] = true;
            }
            catch(e:Error)
            {
            }
            useAltAimOnDualCheckBox.autoSize = "none";
            useAltAimOnDualCheckBox.data = "";
            useAltAimOnDualCheckBox.enabled = true;
            useAltAimOnDualCheckBox.enableInitCallback = false;
            useAltAimOnDualCheckBox.focusable = true;
            useAltAimOnDualCheckBox.label = "Music Vocals";
            useAltAimOnDualCheckBox.selected = false;
            useAltAimOnDualCheckBox.visible = true;
            try
            {
