package
{
    ...
    import flash.utils.*;
    import flash.xml.*;
    import tripwire.menus.UpgradeV2TraderMenu;
    
    public dynamic class TraderMenuMC extends UpgradeV2TraderMenu
    {
        ...
        public var __animFactory_cancelPromptaf1:AnimatorFactory3D;
        
        public var __animArray_cancelPromptaf1:Array;
        
        public var ____motion_cancelPromptaf1_mat3DVec__:Vector.<Number>;
        
        public var ____motion_cancelPromptaf1_matArray__:Array;
        
        public var __motion_cancelPromptaf1:MotionBase;
        ...
        public function TraderMenuMC()
        {
            ...
            if(this.__animFactory_itemDetailsContaineraf1 == null)
            {
                ...
                this.____motion_itemDetailsContaineraf1_mat3DVec__[12] = 800;
                this.____motion_itemDetailsContaineraf1_mat3DVec__[13] = 244;
                this.____motion_itemDetailsContaineraf1_mat3DVec__[14] = 256;
            ...
            if(this.__animFactory_exitButtonaf1 == null)
            {
                ...
                this.____motion_exitButtonaf1_mat3DVec__[12] = 847.950012;
                this.____motion_exitButtonaf1_mat3DVec__[13] = 1036;
                this.____motion_exitButtonaf1_mat3DVec__[14] = 256;
            ...
            if(this.__animFactory_cancelPromptaf1 == null)
            {
                this.__animArray_cancelPromptaf1 = new Array();
                this.__motion_cancelPromptaf1 = new MotionBase();
                this.__motion_cancelPromptaf1.duration = 1;
                this.__motion_cancelPromptaf1.overrideTargetTransform();
                this.__motion_cancelPromptaf1.addPropertyArray("blendMode",["normal"]);
                this.__motion_cancelPromptaf1.addPropertyArray("cacheAsBitmap",[false]);
                this.__motion_cancelPromptaf1.addPropertyArray("opaqueBackground",[null]);
                this.__motion_cancelPromptaf1.addPropertyArray("visible",[false]);
                this.__motion_cancelPromptaf1.is3D = true;
                this.__motion_cancelPromptaf1.motion_internal::spanStart = 0;
                this.____motion_cancelPromptaf1_matArray__ = new Array();
                this.____motion_cancelPromptaf1_mat3DVec__ = new Vector.<Number>(16);
                this.____motion_cancelPromptaf1_mat3DVec__[0] = 1;
                this.____motion_cancelPromptaf1_mat3DVec__[1] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[2] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[3] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[4] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[5] = 1;
                this.____motion_cancelPromptaf1_mat3DVec__[6] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[7] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[8] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[9] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[10] = 1;
                this.____motion_cancelPromptaf1_mat3DVec__[11] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[12] = 851.950012;
                this.____motion_cancelPromptaf1_mat3DVec__[13] = 1000.25;
                this.____motion_cancelPromptaf1_mat3DVec__[14] = 0;
                this.____motion_cancelPromptaf1_mat3DVec__[15] = 1;
                this.____motion_cancelPromptaf1_matArray__.push(new Matrix3D(this.____motion_cancelPromptaf1_mat3DVec__));
                this.__motion_cancelPromptaf1.addPropertyArray("matrix3D",this.____motion_cancelPromptaf1_matArray__);
                this.__animArray_cancelPromptaf1.push(this.__motion_cancelPromptaf1);
                this.__animFactory_cancelPromptaf1 = new AnimatorFactory3D(null,this.__animArray_cancelPromptaf1);
                this.__animFactory_cancelPromptaf1.addTargetInfo(this,"cancelPrompt",0,true,0,true,null,-1);
            }
            if(this.__animFactory_gameInfoContaineraf1 == null)
            {
                ...
                this.____motion_gameInfoContaineraf1_mat3DVec__[12] = 768.299988;
                this.____motion_gameInfoContaineraf1_mat3DVec__[13] = -4;
                this.____motion_gameInfoContaineraf1_mat3DVec__[14] = 256;
            ...
            if(this.__animFactory_shopContaineraf1 == null)
            {
                ...
                this.____motion_shopContaineraf1_mat3DVec__[12] = 1888.030884;
                this.____motion_shopContaineraf1_mat3DVec__[13] = 16;
                this.____motion_shopContaineraf1_mat3DVec__[14] = -0.022931;
            ...
            if(this.__animFactory_playerInventoryContaineraf1 == null)
            {
                ...
                this.____motion_playerInventoryContaineraf1_mat3DVec__[12] = 32.040966;
                this.____motion_playerInventoryContaineraf1_mat3DVec__[13] = 16;
                this.____motion_playerInventoryContaineraf1_mat3DVec__[14] = -0.010547;
