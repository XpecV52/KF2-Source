package
{
    import tripwire.controls.inventory.InventoryListItemRenderer;
    
    public dynamic class InventoryItem_MC extends InventoryListItemRenderer
    {
         
        
        public function InventoryItem_MC()
        {
            super();
