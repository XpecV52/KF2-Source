package scaleform.clik.controls
{
    ...
    public class CoreList extends UIComponent
    {
        ...
        public function set itemRendererInstanceName(param1:String) : void
        {
            ...
            while(++_loc2_)
            {
                if((_loc4_ = parent.getChildByName(param1 + _loc2_) as IListItemRenderer) == null)
                {
                    if(_loc2_ != 0)
                    {
                        break;
        ...
        override public function set enabled(param1:Boolean) : void
        {
            ...
            if(this._renderers != null)
            {
                ...
                while(_loc3_ < _loc2_)
                {
                    (_loc4_ = this.getRendererAt(_loc3_)).enabled = this.enabled;
                    _loc3_++;
                }
            }
        }
        ...
        protected function drawRenderers(param1:Number) : void
        {
            ...
            {
                if((_loc4_ = this.createRenderer(_loc2_)) == null)
                {
                    break;
                }
            ...
            while(_loc2_ >= this._totalRenderers)
            {
                if((_loc4_ = this.getRendererAt(_loc2_)) != null)
                {
